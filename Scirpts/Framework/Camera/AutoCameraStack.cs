...
namespace Framework
{
    ...
    {
        private static Dictionary<int, List<AutoCameraStack>> activeCamera = new Dictionary<int, List<AutoCameraStack>>(2);

        public static bool TryGetActiveCamera(int mutexID, out Camera camera)
        {
            camera = null;
        ...
        private static void SetStackCamera(UniversalAdditionalCameraData cameraData, Camera camera, bool active)
        {
        ...
        public static void RefreshNewCamera(AutoCameraOverlay newCamera)
        {

...
namespace NWFramework.Editor
{
    ...
    public static class OpenFolderHelper
    {
        ...
        /// 打开 Data Path 文件夹
        /// </summary>
        [MenuItem("NWFramework/Open Folder/Data Path", false, 10)]
        ...
        /// </summary>
        [MenuItem("NWFramework/Open Folder/Persistent Data Path", false, 11)]
        ...
        /// </summary>
        [MenuItem("NWFramework/Open Folder/Streaming Assets Path", false, 12)]
        ...
        /// </summary>
        [MenuItem("NWFramework/Open Folder/Temporary Cache Path", false, 13)]
        ...
        /// </summary>
        [MenuItem("NWFramework/Open Folder/Console Log Path", false, 14)]

...
{
    public static partial class BuildDLLCommand
    {
        public static void HYBridCLR_BuildAndCopyDlls(BuildTarget target)
        {
            CompileDllCommand.CompileDll(target);
            HYBridCLR_CopyAOTHotUpdateDlls(target);
        }

        private static void HYBridCLR_CopyAOTHotUpdateDlls(BuildTarget target)
        {
            HYBridCLR_CopyAOTAssembliesToAssetPath();
            HYBridCLR_CopyHotUpdateAssembliesToAssetPath();
            AssetDatabase.Refresh();
        }

        private static void HYBridCLR_CopyAOTAssembliesToAssetPath()
        {
        ...
        private static void HYBridCLR_CopyHotUpdateAssembliesToAssetPath()
        {
            var target = EditorUserBuildSettings.activeBuildTarget;

...
namespace NWFramework.Editor
{
    ...
    internal sealed class RootModuleInspector : NWFrameworkInspector
    {
        ...
        private void RefreshTypeNames()
        {
            ...
            logHelperTypeNames.AddRange(Type.GetRuntimeTypeNames(typeof(NWFrameworkLog.ILogHelper)));

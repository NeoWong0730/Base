...
using UnityEditor;
using System;
using BindData = NWFramework.ComponentAutoBindTool.BindData;
...
public class ComponentAutoBindToolInspector : Editor
{
    ...
    private string[] s_AssemblyNames = { "Assembly-CSharp", "NWFramework.Runtime" };
    ...
    private void GenAutoBindCode()
    {
        ...
        using (StreamWriter sw = new StreamWriter($"{codePath}/{className}.BindComponents.cs"))
        {
            ...
            sw.WriteLine("using NWFramework;");
            sw.WriteLine("");

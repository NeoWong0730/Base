...
namespace NWFramework
{
    ...
    public abstract class LocalizationHelperBase : MonoBehaviour, ILocalizationHelper
    {
        ...
        /// <param name="lentth">字典二进制流的长度</param>
        /// <param name="userData">用户自定义数据</param>
        /// <returns>是否解析字典成功</returns>
        public abstract bool ParseData(ILocalizationManager localizationManager, byte[] dictionaryBytes, int startIndex, int lentth, object userData);

...
namespace NWFramework
{
    ...
    public sealed class RootModule : Module
    {
        ...
        [SerializeField]
        private string m_TextHelperTypeName = "NWFramework.DefaultTextHelper";

        [SerializeField]
        private string m_VersionHelperTypeName = "NWFramework.DefaultVersionHelper";

        [SerializeField]
        private string m_LogHelperTypeName = "NWFramework.DefaultLogHelper";

        [SerializeField]
        private string m_JsonHelperTypeName = "NWFramework.DefaultJsonHelper";

        [SerializeField]
        private string m_MsgHelperTypeName = "NWFramework.MsgProtobufHelper";
        ...
        protected override void Awake()
        {
            ...
            Log.Info("NWFramework Version: {0}", Version.NWFrameworkVersion);
        ...
        private void InitVersionHelper()
        {
            ...
            {
                throw new NWFrameworkException(Utility.Text.Format("Can not find version helper type '{0}'.", m_VersionHelperTypeName));
            }

            Version.IVersionHelper versionHelper = (Version.IVersionHelper)Activator.CreateInstance(versionHelperType);
            if (versionHelper == null)
            {
                throw new NWFrameworkException(Utility.Text.Format("Can not create version helper instance '{0}'.", m_VersionHelperTypeName));
            }
        ...
        private void InitLogHelper()
        {
            ...
            {
                throw new NWFrameworkException(Utility.Text.Format("Can not find log helper type '{0}'.", m_LogHelperTypeName));
            }

            NWFrameworkLog.ILogHelper logHelper = (NWFrameworkLog.ILogHelper)Activator.CreateInstance(logHelperType);
            if (logHelper == null)
            {
                throw new NWFrameworkException(Utility.Text.Format("Can not create log helper instance '{0}'.", m_LogHelperTypeName));
            }

            NWFrameworkLog.SetLogHelper(logHelper);
        }

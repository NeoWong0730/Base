...
namespace NWFramework
{
    ...
    /// 游戏配置管理器
    /// </summary>
    internal sealed class SettingManager : ModuleImp, ISettingManager
    {
        ...
        public int Count
        {
            get
            {
                ...
                {
                    throw new NWFrameworkException("Setting helper is invalid.");
                }
        ...
        public bool HasSetting(string settingName)
        {
            ...
            {
                throw new NWFrameworkException("Setting name is invalid.");
            }

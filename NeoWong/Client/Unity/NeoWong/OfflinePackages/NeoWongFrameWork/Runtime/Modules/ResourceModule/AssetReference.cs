...
namespace NWFramework
{
    ...
    public sealed class AssetReference : MonoBehaviour
    {
        ...
        /// 父级资源引用
        /// </summary>
        public AssetReference Parent { get; private set; }
            ...
            string location = "", AssetReference parent = null, string packageName = "")
        {
            if (go == null)
            {
                throw new NWFrameworkException($"BindAssetReference Failed => GameObject is null!");
            }

            if (handle == null)
            {
                throw new NWFrameworkException($"BindAssetReference Failed => AssetOperationHandle is null!");
            }

            var ret = go.GetOrAddComponent<AssetReference>();

            ret.Bind(handle, location, parent, packageName);
            ...
            AssetReference parent = null, string packageName = "")
        {
            ...
            ret.Bind(null, location, parent, packageName);

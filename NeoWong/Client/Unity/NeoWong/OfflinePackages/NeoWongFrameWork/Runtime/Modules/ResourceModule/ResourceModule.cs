...
namespace NWFramework
{
    ...
    public class ResourceModule : Module
    {
        ...
        /// 获取当前资源适用的游戏版本号
        /// </summary>
        public string ApplicableGameVersion => m_ResourceManager?.ApplicableGameVersion ?? "Unkown";
        ...
        /// 全局取消操作Token
        /// </summary>
        public CancellationToken DefaultToken { get; private set; }
        ...
        private void Start()
        {
            ...
            {
                Log.Fatal("ResourceManager component is invalid.");
                return;
            }
            ...
            if (playMode == EPlayMode.EditorSimulateMode)
            {
                Log.Info("During this run, NWFramework will use editor resource files, which you should validate first.");
#if !UNITY_EDITOR
                playMode = EPlayMode.OfflinePlayMode;
#endif
            }
        ...
        /// <returns>InitializationOperation</returns>
        ...
        public UpdatePackageVersionOperation UpdatePackageVersionAsync(bool appendTimeTicks = false, 
        ...
        /// <param name="customPackageName">指定资源包的名称。不传使用默认资源包</param>
        /// <returns>求远端包裹的更新清单操作句柄</returns>
        ...
        /// <param name="customPackageName">指定资源包的名称。不传使用默认资源包</param>
        /// <returns>资源下载器</returns>
        public ResourceDownloaderOperation CreateResourceDownloader(string location, string customPackageName = "")
        {
            var package = string.IsNullOrEmpty(customPackageName)
                ? YooAssets.GetPackage(packageName)
                : YooAssets.GetPackage(customPackageName);
        ...
        {
            return m_ResourceManager.IsNeedDownloadFromRemote(location, customPackageName);
        }
        ...
        {
            return m_ResourceManager.IsNeedDownloadFromRemote(assetInfo, customPackageName);
        }
        ...
        {
            return m_ResourceManager.GetAssetInfo(location, customPackageName);
        }
        ...
        /// <param name="needCahe">是否需要缓存</param>
        ...
        {
            return m_ResourceManager.LoadAsset<T>(location, needInstance, needCache, customPackageName);
        }
        ...
        public T LoadAsset<T>(string location, Transform parent, bool needInstance = true, bool needCache = false,
            string customPackageName = "") where T : UnityEngine.Object
        {
            return m_ResourceManager.LoadAsset<T>(location, parent, needInstance, needCache, customPackageName);
        }
        ...
        public T LoadAsset<T>(string location, out AssetOperationHandle handle, bool needCache = false,
            string customPackageName = "") where T : UnityEngine.Object
        {
            return m_ResourceManager.LoadAsset<T>(location, out handle, needCache, customPackageName);
        }
        ...
        /// <param name="parent">父节点位置</param>
        /// <param name="handle">资源操作句柄</param>
        /// <param name="needCahche">是否需要缓存</param>
        /// <param name="packageName">指定资源包的名称。不传使用默认资源包</param>
        /// <returns>资源实例</returns>
        ...
        {
            return m_ResourceManager.LoadAsset<T>(location, parent, out handle, needCache, customPackageName);
        }
            ...
            bool needCache = false, string customPackageName = "") where T : UnityEngine.Object
        {
            AssetOperationHandle handle =
                m_ResourceManager.LoadAssetAsyncHandle<T>(location, needCache, customPackageName);
        ...
        public AssetOperationHandle LoadAssetGetOperation<T>(string location, bool needCache = false,
            string customPackageName = "") where T : UnityEngine.Object
        {
            return m_ResourceManager.LoadAssetGetOperation<T>(location, needCache, customPackageName);
        }
        ...
        public AssetOperationHandle LoadAssetAsyncHandle<T>(string location, bool needCache = false,
            string customPackageName = "") where T : UnityEngine.Object
        {
            return m_ResourceManager.LoadAssetAsyncHandle<T>(location, needCache, customPackageName);
        }
        ...
        public SubAssetsOperationHandle LoadSubAssetsSync<T>(string location, string customPackageName = "")
            where T : UnityEngine.Object
        {
            return m_ResourceManager.LoadSubAssetsSync<T>(location: location, customPackageName);
        }
        ...
        public SubAssetsOperationHandle LoadSubAssetsAsync<T>(string location, string customPackageName = "")
            where T : UnityEngine.Object
        {
            return m_ResourceManager.LoadSubAssetsAsync<T>(location: location, customPackageName);
        }
        ...
        {
            var assetInfo = GetAssetInfo(location, customPackageName);
            if (assetInfo == null)
            {
            ...
            return m_ResourceManager.LoadSubAssetsSync(assetInfo, customPackageName);
        }
        ...
        public async UniTask<LoadAssetsByTagOperation<T>> LoadAssetsByTagAsync<T>(string assetTag, string customPackageName = "")
            where T : UnityEngine.Object
        {
            return await m_ResourceManager.LoadAssetsByTagAsync<T>(assetTag, customPackageName);
        }
            ...
            where T : UnityEngine.Object
        {
            return await m_ResourceManager.LoadAssetAsync<T>(location, cancellationToken, needInstance, 
                needCache, customPackageName, parent);
        }
        ...
        {
            return await m_ResourceManager.LoadRawAssetAsync(location, cancellationToken, customPackageName);
        }
        ...
        {
            return await m_ResourceManager.LoadSubAssetAsync<T>(location, assetName, cancellationToken, customPackageName);
        }
        ...
        /// <param name="cancellationToken">取消操作Token</param>
        /// <param name="packageName">指定资源包的名称。不传使用默认资源包</param>
        /// <returns>所有子文件资源实例</returns>
        public async UniTask<T[]> LoadAllSubAssetAsync<T>(string location,
            CancellationToken cancellationToken = default, string customPackageName = "") where T : UnityEngine.Object
        {
            return await m_ResourceManager.LoadAllSubAssetAsync<T>(location, cancellationToken, customPackageName);
        }
        ...
        {
            m_ResourceManager.PushPreLoadAsset(location, assetObject, customPackageName);
        }
        ...
        {
            return m_ResourceManager.GetPreLoadAsset<T>(location, customPackageName);
        }
    }
}
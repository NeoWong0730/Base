...
namespace NWFramework
{
    internal sealed partial class ObjectPoolManager : ModuleImp, IObjectPoolManager
    {
        ...
        {
            private readonly NWFrameworkMultiDictionary<string, Object<T>> _objects;
            ...
            public ObjectPool(string name, bool allowMultiSpawn, float autoReleaseInterval, int capacity, float expireTime, int priority)
                : base(name)
            {
                _objects = new NWFrameworkMultiDictionary<string, Object<T>>();
            ...
            public override int Capacity
            {
                ...
                set
                {
                    if (value < 0)
                    {
                        throw new NWFrameworkException("Capacity is invalid.");
                    }
            ...
            public override float ExpireTime
            {
                ...
                set
                {
                    if (value < 0f)
                    {
                        throw new NWFrameworkException("ExpireTime is invalid.");
                    }
            ...
            public void Register(T obj, bool spawned)
            {
                if (obj == null)
                {
                    throw new NWFrameworkException("Object is invalid.");
                }
            ...
            public bool CanSpawn(string name)
            {
                if (name == null)
                {
                    throw new NWFrameworkException("Name is invalid.");
                }

                NWFrameworkLinkedListRange<Object<T>> objectRange = default(NWFrameworkLinkedListRange<Object<T>>);
            ...
            public void Unspawn(object target)
            {
                if (target == null)
                {
                    throw new NWFrameworkException("Target is invalid.");
                }
                ...
                {
                    throw new NWFrameworkException(Utility.Text.Format(
            ...
            public void Release(int toReleaseCount, ReleaseObjectFilterCallback<T> releaseObjectFilterCallback)
            {
                ...
                {
                    throw new NWFrameworkException("Release object filter callback is invalid.");
                }
            ...
            public override ObjectInfo[] GetAllObjectInfos()
            {
                ...
                foreach (KeyValuePair<string, NWFrameworkLinkedListRange<Object<T>>> objectRanges in _objects)
                {

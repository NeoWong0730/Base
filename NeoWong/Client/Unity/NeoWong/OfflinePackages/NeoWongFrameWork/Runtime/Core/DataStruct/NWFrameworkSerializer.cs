...
namespace NWFramework
{
    ...
    public abstract class NWFrameworkSerializer<T>
    {
        ...
        public void RegisterSerializeCallback(byte version, SerializeCallback callback)
        {
            if (callback == null)
            {
                throw new NWFrameworkException("Serialize callback is invalid.");
            }
        ...
        public void RegisterDeserializeCallback(byte version, DeserializeCallback callback)
        {
            if (callback == null)
            {
                throw new NWFrameworkException("Deserialize callback is invalid.");
            }
        ...
        public void RegisterTryGetValueCallback(byte version, TryGetValueCallback callback)
        {
            if (callback == null)
            {
                throw new NWFrameworkException("Try get value callback is invalid.");
            }
        ...
        public bool Serialize(Stream stream, T data)
        {
            ...
            {
                throw new NWFrameworkException("No serialize callback registered.");
            }
        ...
        public bool Serialize(Stream stream, T data, byte version)
        {
            ...
            {
                throw new NWFrameworkException(Utility.Text.Format("Serialize callback '{0}' is not exist.", version));
            }
        ...
        public T Deserialize(Stream stream)
        {
            ...
            {
                throw new NWFrameworkException(Utility.Text.Format("Header is invalid, need '{0}{1}{2}', current '{3}{4}{5}'.", (char)header[0], (char)header[1], (char)header[2], (char)header0, (char)header1, (char)header2));
            }
            ...
            {
                throw new NWFrameworkException(Utility.Text.Format("Deserialize callback '{0}' is not exist.", version));
            }

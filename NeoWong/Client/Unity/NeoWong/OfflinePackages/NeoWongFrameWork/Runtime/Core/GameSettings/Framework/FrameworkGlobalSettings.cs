...
namespace NWFramework
{
    ...
    public class ResourcesArea
    {
        ...
        /// <summary>
        /// 是否在构建资源的时候清理上传到服务端目录的老资源
        /// </summary>
        public bool CleanCommitPathRes => m_CleanCommitPathRes;

        [Tooltip("内网地址")]
        [SerializeField]
        private string m_InnerResourceSourceUrl = "http://127.0.0.1:8088";
        ...
        [Tooltip("外网地址")]
        [SerializeField]
        private string m_ExtraResourceSourceUrl = "http://127.0.0.1:8088";

        /// <summary>
        /// 外网地址
        /// </summary>
        public string ExtreResourceSourceUrl => m_ExtraResourceSourceUrl;

        [Tooltip("正式地址")]
        [SerializeField]
        private string m_FormalResourceSourceUrl = "http://127.0.0.1:8088";
    ...
    public class FrameworkGlobalSettings
    {
        [Tooltip("脚本作者名")]
        [SerializeField]
        private string m_ScriptAuthor = "NeoWong";
        ...
        [FormerlySerializedAs("mEAppStage")]
        [FormerlySerializedAs("m_AppStage")]
        [SerializeField]
        ...
        [Header("Font")]
        [SerializeField]
        private string m_DefaultFont = "Arial";
        ...
        [SerializeField]
        private string @namespace = "HotFix";

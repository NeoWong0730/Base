...
namespace NWFramework
{
    ...
    public sealed class NWFrameworkLinkedList<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        /// 获取链表结点缓存数量
        /// </summary>
        public int CachedNodeCount => _cacheNodes.Count;
        ...
        public void RemoveFirst()
        {
            ...
            if (first == null)
            {
                throw new NWFrameworkException("First is invalid.");
            }
        ...
        /// 移除位于链表结尾处的结点
        /// </summary>
        /// <exception cref="NWFrameworkException"></exception>
        public void RemoveLast()
        {
            LinkedListNode<T> last = _linkedList.Last;
            if (last == null)
            {
                throw new NWFrameworkException("Last is invalid.");
            }
        ...
        public struct Enumerator : IEnumerator<T>, IEnumerator
        {
            ...
            internal Enumerator(LinkedList<T> linkedList)
            {
                if (linkedList == null)
                {
                    throw new NWFrameworkException("Linked list is invalid.");
                }

...
namespace NWFramework
{
    ...
    {
        private static readonly string GlobalSettingsPath = $"NWFrameworkGlobalSettings";
        private static NWFrameworkSettings _globalSettings;

        public static NWFrameworkSettings GlobalSettings
        {
            get
            {
                if (_globalSettings == null)
                {
                    _globalSettings = GetSingletonAssetsByResources<NWFrameworkSettings>(GlobalSettingsPath);
                }
        ...
        public static HybridCLRCustomGlobalSettings HybridCLRCustomGlobalSettings => GlobalSettings.HybridCLRCustomGlobalSettings;
        ...
        public static string CompleteDownLoadPath
        {
            get
            {
                ...
                {
                    url = ResourcesArea.ExtreResourceSourceUrl;
                }

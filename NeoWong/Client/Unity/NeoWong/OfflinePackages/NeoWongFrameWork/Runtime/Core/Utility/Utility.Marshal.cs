    ...
    public static partial class Utility
    {
        ...
        public static class Marshal
        {
            ...
            public static void EnsureCachedHGlobalSize(int ensureSize)
            {
                if (ensureSize < 0)
                {
                    throw new NWFrameworkException("Ensure size is invalid.");
                }
            ...
            internal static byte[] StructureToBytes<T>(T structure, int structureSize)
            {
                if (structureSize < 0)
                {
                    throw new NWFrameworkException("Structure size is invalid.");
                }
            ...
            internal static void StructureToBytes<T>(T structure, int structureSize, byte[] result, int startIndex)
            {
                ...
                if (result == null)
                {
                    throw new NWFrameworkException("Result is invalid.");
                }

                if (startIndex < 0)
                {
                    throw new NWFrameworkException("Start index is invalid.");
                }

                if (startIndex + structureSize > result.Length)
                {
                    throw new NWFrameworkException("Result length is not enough.");
                }
            ...
            internal static T BytesToStructure<T>(int structureSize, byte[] buffer, int startIndex)
            {
                ...
                if (buffer == null)
                {
                    throw new NWFrameworkException("Buffer is invalid.");
                }
                ...
                {
                    throw new NWFrameworkException("Buffer length is not enough.");
                }

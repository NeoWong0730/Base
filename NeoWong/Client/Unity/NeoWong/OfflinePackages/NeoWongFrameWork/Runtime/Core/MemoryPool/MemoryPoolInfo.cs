...
namespace NWFramework
{
    ...
    public struct MemoryPoolInfo
    {
        ...
        /// 获取未使用内存对象数量
        /// </summary>
        public int UnusedMemoryCount { get { return _unusedMemoryCount;} }

        /// <summary>
        /// 获取正在使用内存对象数量
        /// </summary>
        public int UsingMemoryCount { get { return _usingMemoryCount;} }

        /// <summary>
        /// 获取获取内存对象数量
        /// </summary>
        public int AcquireMemoryCount { get { return _acquireMemoryCount;} }

        /// <summary>
        /// 获取归还内存对象数量
        /// </summary>
        public int ReleaseMemoryCount { get { return _releaseMemoryCount;} }

        /// <summary>
        /// 获取增加内存对象数量
        /// </summary>
        public int AddMemoryCount { get { return _addMemoryCount;} }

        /// <summary>
        /// 获取移除内存对象数量
        /// </summary>
        public int RemoveMemoryCount { get { return _removeMemoryCount;} }
    }

    ...
    public static partial class Utility
    {
        ...
        public static class Converter
        {
            ...
            public static float GetCentimetersFromPixels(float pixels)
            {
                if (ScreenDpi <= 0)
                {
                    throw new NWFrameworkException("You must set screen DPI first.");
                }
            ...
            public static byte[] GetBytes(string value, Encoding encoding)
            {
                if (value == null)
                {
                    throw new NWFrameworkException("Value is invalid.");
                }

                if (encoding == null)
                {
                    throw new NWFrameworkException("Encoding is invalid.");
                }

...
namespace NWFramework
{
    ...
    public static class RuntimeId
    {
        ...
        /// </summary>
        private static readonly Dictionary<int, string> _eventRuntime2StringMap = new Dictionary<int, string>();
        ...
        public static int ToRuntimeId(string value)
        {
            ...
            _eventRuntime2StringMap[runtimeId] = value;
        ...
        {
            return _eventRuntime2StringMap.TryGetValue(runtimeId, out var value) ? value : string.Empty;
        }
    }

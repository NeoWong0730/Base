...
namespace NWFramework
{
    ...
    public static class GameEvent
    {
        ...
        /// <typeparam name="TArg5">事件参数5类型</typeparam>
        /// <typeparam name="TArg6">事件参数6类型</typeparam>
        public static void RemoveEventListener<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>(int eventType, Action<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6> handler)
        {
            _eventMgr.Dispatcher.RemoveEventListener(eventType, handler);
        }
        ...
        /// <typeparam name="TArg6">事件参数6类型</typeparam>
        /// <returns>是否监听成功</returns>
        public static bool AddEventListener<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>(string eventType, Action<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6> handler)
        {
            return _eventMgr.Dispatcher.AddEventListener(RuntimeId.ToRuntimeId(eventType), handler);
        }
        ...
        /// <typeparam name="TArg5">事件参数5类型</typeparam>
        /// <typeparam name="TArg6">事件参数6类型</typeparam>
        public static void RemoveEventListener<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>(string eventType, Action<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6> handler)
        {
            _eventMgr.Dispatcher.RemoveEventListener(RuntimeId.ToRuntimeId(eventType), handler);
        }
        ...
        /// <typeparam name="TArg5">事件参数5类型</typeparam>
        /// <typeparam name="TArg6">事件参数6类型</typeparam>
        public static void Send<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>(string eventType, TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, TArg6 arg6)
        {
            _eventMgr.Dispatcher.Send(RuntimeId.ToRuntimeId(eventType), arg1, arg2, arg3, arg4, arg5, arg6);
        }

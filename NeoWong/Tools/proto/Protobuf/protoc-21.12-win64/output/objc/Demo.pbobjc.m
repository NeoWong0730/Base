...
#pragma mark - DemoRoot_FileDescriptor

static GPBFileDescriptor *DemoRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[Person class]
                                     rootClass:[DemoRoot class]
                                          file:DemoRoot_FileDescriptor()
                                        fields:fields

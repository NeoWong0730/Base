...
inline int32_t Book::_internal_id() const {
  return _impl_.id_;
}
inline int32_t Book::id() const {
  // @@protoc_insertion_point(field_get:Book.id)
  return _internal_id();
}
inline void Book::_internal_set_id(int32_t value) {
  
  _impl_.id_ = value;
}
inline void Book::set_id(int32_t value) {

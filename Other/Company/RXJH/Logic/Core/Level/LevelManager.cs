...
namespace Logic.Core
{
    ...
    public static class LevelManager
    {
        ...
        private static void State_StartSwitch()
        {
            ...
            if (_mMainLevel != null)
            {
                DebugUtil.Log(ELogType.eNone, $"Begine Exit Level {_mMainLevel.ToString()}");

                _mMainLevel.OnExit(mSwitchLevelType);
                _mMainLevel = null;

                // DebugUtil.Log(ELogType.eNone, $"End Exit Level {_mMainLevel.ToString()}");
            }                        
            ...
            if(_mSwitchLevel != null)
            {
                DebugUtil.Log(ELogType.eNone, $"Begine Enter Level {_mSwitchLevel.ToString()}");

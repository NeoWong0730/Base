...
{    
    public static class GameMain
    {
        ...
        //public static DebugHeader gDebugHeader = new DebugHeader { name = "GameMain", option = ELogOption.AttachDetail };
        ...
        private static void InitBaseManager()
        {
            ...
            AudioManager.Instance.usePHASEInIOS = true;
#if DEBUG_MODE
                ...
                case EState.InitSystem:
                    {
                        if (SystemModuleManager.InitProgress())
                        {
                            ...
                            // LevelManager.EnterLevel(typeof(LvPlay), new LevelParams() { eLoadingType = ELoadingType.eUnuseLoading, arg = null, bCanSwitchToEqualLevelType = false });

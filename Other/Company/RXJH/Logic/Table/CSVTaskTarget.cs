...
namespace Table
{
	...
	sealed public partial class CSVTaskTarget : Framework.Table.TableBase<CSVTaskTarget.Data>
	{
		...
		{
			return "Config/Table/CSVTaskTarget.bytes";
		}

		private static CSVTaskTarget instance = null;			
		public static CSVTaskTarget Instance
		{
			get
			{
#if DEBUG_MODE
				if (instance == null)
				{
					DebugUtil.LogError("配置表CSVTaskTarget 尚未构建实例, 请添加配置表加载到 CSVRegister");
				}
#endif
				return instance;
			}
        ...
        {
			DebugUtil.LogFormat(ELogType.eTable, "加载CSVTaskTarget forceReload = {0}", forceReload);

            if (instance == null)
            {
                instance = new CSVTaskTarget();
        ...
        {
            DebugUtil.Log(ELogType.eTable, "卸载CSVTaskTarget");
    ...
    sealed public partial class CSVTaskTarget : FCSVTaskTarget
    {
        public static string ConfigPath()
		{
			return "Config/Table/CSVTaskTarget.bytes";

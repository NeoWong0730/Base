...
public class ImageLoader : MonoBehaviour
{
    ...
    public void LoadSprite() {
        LoadSprite(_sAtlasName, _sSpriteName, bAutoSetNativeSize);
    }
    ...
    private void _Load()
    {
        ...
        if (EAssetType.SpriteAtlas == eCurrentAssetType)
        {
            ...
            AddressablesUtil.LoadAssetAsync<SpriteAtlas>(ref handle, _sAtlasName, ImageSpriteAtlasLoader_Completed);
            _handle = handle;
        }

...
namespace Table
{
	...
	sealed public partial class CSVBiographySeries : Framework.Table.TableBase<CSVBiographySeries.Data>
	{
		...
		{
			return "Config/Table/CSVBiographySeries.bytes";
		}

		private static CSVBiographySeries instance = null;			
		public static CSVBiographySeries Instance
		{
			get
			{
#if DEBUG_MODE
				if (instance == null)
				{
					DebugUtil.LogError("配置表CSVBiographySeries 尚未构建实例, 请添加配置表加载到 CSVRegister");
				}
#endif
				return instance;
			}
        ...
        {
			DebugUtil.LogFormat(ELogType.eTable, "加载CSVBiographySeries forceReload = {0}", forceReload);

            if (instance == null)
            {
                instance = new CSVBiographySeries();
        ...
        {
            DebugUtil.Log(ELogType.eTable, "卸载CSVBiographySeries");
    ...
    sealed public partial class CSVBiographySeries : FCSVBiographySeries
    {
        public static string ConfigPath()
		{
			return "Config/Table/CSVBiographySeries.bytes";

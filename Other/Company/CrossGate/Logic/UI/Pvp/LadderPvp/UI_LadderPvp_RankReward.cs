...
namespace Logic
{ 
    public partial class UI_LadderPvp_RankReward : UIBase, UI_LadderPvp_RankReward_Layout.IListener
    {
        private UI_LadderPvp_RankReward_Layout m_Layout = new UI_LadderPvp_RankReward_Layout();

        private int m_Stage = -1;
        List<CSVTianTiRankingAward.Data>  m_RankData = new List<CSVTianTiRankingAward.Data>(15);
        ...
        private void RefreshRankData()
        {
            ...
            var datas = CSVTianTiRankingAward.Instance.GetAll(); 

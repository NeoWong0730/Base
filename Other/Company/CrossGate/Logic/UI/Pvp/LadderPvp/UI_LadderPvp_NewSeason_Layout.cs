...
namespace Logic
{
    ...
    ///pvp 新赛季
    /// </summary>
    public partial class UI_LadderPvp_NewSeason_Layout
    {
        public ClickItemGroup<RectPropItem> m_Group = new ClickItemGroup<RectPropItem>() { AutoClone = false };
        ...
        public void Load(Transform root)
        {
            ...
            if (rankStarGrid != null)
                rankStarGrid.gameObject.SetActive(false);
        }
    ...
    public partial class UI_LadderPvp_NewSeason_Layout
    {
        public class RectPropItem : IntClickItem
        {
            PropItem m_Item;

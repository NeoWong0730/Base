...
namespace Logic
{
    public partial class UI_RideLottoRewardGet_Layout
    {
    ...
    public partial class UI_RideLottoRewardGet_Layout
    {
        private class RectRewardItem : IntClickItem
        {
            ...
            public UI_RideLottoRewardGet_Layout ParentLayout { get; set; }
            ...
            public void SetReward(uint id, uint count)
            {
                ...
                m_Item.SetData(new MessageBoxEvt(EUIID.UI_RideLotto_RewardGet, m_ItemData));
            }

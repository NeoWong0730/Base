...
namespace Logic
{
    public partial class UI_RideLotto_Layout
    {
        ...
        public void LoadRideLottoResult(Transform root)
        {
        ...
        //{
        //    //m_TexLeftNum.text = Sys_pub.Instance.CurrentRideLottoTimes.ToString() + "/" + Sys_pub.Instance.TotalRideLottoTimes.ToString();
        //    //m_TexTips.text = LanguageHelper.GetTextContent(2021130, Sys_pub.Instance.TotalRideLottoTimes.ToString()); 
        //}
    ...
    public partial class UI_RideLotto_Layout
    {
        ...
        private GameObject[] fxQualityGo = new GameObject[6];
        ...
        private GameObject fxLottoNormalGo;
        private GameObject fxLottoGoldGo;

        //private GameObject[] mouseCard = new GameObject[2];
        private GameObject mouseCard;

        private SpriteRenderer oneSprite;
        private SpriteRenderer oneSkillSprite;
        private SpriteRenderer[] fiveSprite = new SpriteRenderer[5];
        private SpriteRenderer[] fiveSkillSprite = new SpriteRenderer[5];
        ...
        public void LoadScene(GameObject SceneGo)
        {
            ...
            fxQualityGo[0] = SceneGo.transform.Find("Fx/Fx_UI_RideLottoGet_blue").gameObject;
            fxQualityGo[1] = SceneGo.transform.Find("Fx/Fx_UI_RideLottoGet_green").gameObject;
            fxQualityGo[2] = SceneGo.transform.Find("Fx/Fx_UI_RideLottoGet_orange").gameObject;
            fxQualityGo[3] = SceneGo.transform.Find("Fx/Fx_UI_RideLottoGet_purple").gameObject;
            fxQualityGo[4] = SceneGo.transform.Find("Fx/Fx_UI_RideLottoGet_white").gameObject;
            fxQualityGo[5] = SceneGo.transform.Find("Fx/Fx_UI_RideLottoGet_orange_Icon").gameObject;
            ...
            mouseGo = SceneGo.transform.Find("Pos/10003_show").gameObject;
            ...
            fxLottoNormalGo = SceneGo.transform.Find("Card/Fx_ka_chuxian/Fx_RideLottoGetShow_ka_chuxian_lan_01").gameObject;
            ...
            fxLottoGoldGo = SceneGo.transform.Find("Card/Fx_ka_chuxian/Fx_RideLottoGetShow_ka_chuxian_jin_01").gameObject;
            ...
            mouseCard = SceneGo.transform.Find("Card/Mouse_Card/97102").gameObject;

            oneSprite = SceneGo.transform.Find("Fx1/Item").GetComponent<SpriteRenderer>();
            oneSkillSprite = SceneGo.transform.Find("Fx1/Item/Item_Skill").GetComponent<SpriteRenderer>();

            for (int i = 0; i < 5; ++i)
            {
                fiveSprite[i] = SceneGo.transform.Find("Fx5/Fx5_" + (i + 1).ToString() + "/Item").GetComponent<SpriteRenderer>();
                fiveSkillSprite[i] = SceneGo.transform.Find("Fx5/Fx5_" + (i + 1).ToString() + "/Item/Item_Skill").GetComponent<SpriteRenderer>();
            }
        ...
        public void SetCardFx(CardFxState state)
        {
            switch (state)
            {
                case CardFxState.NormalLight:
                    fxLottoNormalGo.SetActive(true);
                    fxLottoGoldGo.SetActive(false);
                    break;
                case CardFxState.GoldLight:
                    fxLottoNormalGo.SetActive(false);
                    fxLottoGoldGo.SetActive(true);
                    break;
            }
        }
        ...
        public void SetOneCardFx(uint awardId)
        {
            ...
            switch (quality)
            {
                case 5:
                    GameObject go5;
                    if (item.type_id == 1103)
                        go5 = GameObject.Instantiate(fxQualityGo[2]);
                    else
                        go5 = GameObject.Instantiate(fxQualityGo[5]);
            ...
            if (data != null)
            {
                if (data.quality == 5)
                {
                    if(item.type_id == 1103)
                    {
                        oneSkillSprite.gameObject.SetActive(false);
                    ...
                    {
                        if (item.type_id == 3014 || item.type_id == 3030)
                        {
                            oneSkillSprite.gameObject.SetActive(true);
                            var skillInfoId = item.fun_value[1];
                            CSVPassiveSkillInfo.Data skillInfo = CSVPassiveSkillInfo.Instance.GetConfData(skillInfoId);
                            ImageHelper.SetSprite(oneSprite,  skillInfo.icon);
                        }
                        else
                            oneSkillSprite.gameObject.SetActive(false);
            ...
            for (int i = 0; i < 5; ++i)
            {
...
#if UNITY_EDITOR
                if (data == null)
                    DebugUtil.LogError("awardId = " + awardIds[i].ToString());
#endif
                uint quality = data.quality;
                var tran = fx5Trans[i];
                switch (quality)
                ...
                if (data != null)
                {
                    if (data.quality == 5)
                    {
                        if (item.type_id == 1103)
                        {
                            fiveSkillSprite[i].gameObject.SetActive(false);
                            var pet = CSVPetNew.Instance.GetConfData(data.itemId);
                            if (pet != null)
                            {
                        ...
                        else
                        {
                            if (item.type_id == 3014 || item.type_id == 3030)
                            {
                                fiveSkillSprite[i].gameObject.SetActive(true);
                                var skillInfoId = item.fun_value[1];
                                CSVPassiveSkillInfo.Data skillInfo = CSVPassiveSkillInfo.Instance.GetConfData(skillInfoId);
                                ImageHelper.SetSprite(fiveSkillSprite[i], skillInfo.icon);
                            }
                            else
                                fiveSkillSprite[i].gameObject.SetActive(false);

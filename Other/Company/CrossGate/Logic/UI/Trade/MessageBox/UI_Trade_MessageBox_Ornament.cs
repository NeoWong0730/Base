...
namespace Logic
{
    public class UI_Trade_MessageBox_Ornament : UIBase
    {
        //private UI_Trade_Message_ComItem _comItem;
        private UI_Trade_Message_OrnamentItem _selfOrnament;
        private UI_Trade_Message_OrnamentItem _rightOrnament;
        ...
        protected override void OnLoaded()
        {
            ...
            _selfOrnament = new UI_Trade_Message_OrnamentItem();
            _selfOrnament.Init(transform.Find("View_Tips/Tips01"));
            _selfOrnament._tipOrnament.backgroundFirst.BtnMsg.gameObject.SetActive(false);

            _rightOrnament = new UI_Trade_Message_OrnamentItem();
            _rightOrnament.Init(transform.Find("View_Tips/Tips02"));
            _rightOrnament._tipOrnament.backgroundFirst.BtnMsg.gameObject.SetActive(false);
        ...
        private void UpdateInfo()
        {
            ...
            if (Sys_Ornament.Instance.IsShowCompare(msgParam.tradeItem.InfoId, ref selfItem))
            {
                _selfOrnament.Show();

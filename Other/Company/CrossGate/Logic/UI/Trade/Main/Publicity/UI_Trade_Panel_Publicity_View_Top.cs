...
namespace Logic
{
    public class UI_Trade_Panel_Publicity_View_Top
    {
        ...
        private class Bargin 
        {
            ...
            public void SetData(CSVCommodityCategory.Data category, bool bargin)
            {
                m_DropDown.ClearOptions();
                if (category.bargain)
                {
                ...
                m_lastIndex = m_Index = bargin ? 1 : 0;
                m_DropDown.value = m_Index;
            }
        }
        ...
        private void OnClickBack()
        {
            ...
            Sys_Trade.Instance.eventEmitter.Trigger(Sys_Trade.EEvents.OnViewPublicityBackToSubCategory);
        }
        ...
        public void UpdateInfo()
        {
            ...
            if (Sys_Trade.Instance.SearchParam.isSearch && Sys_Trade.Instance.SearchParam.showType == Packet.TradeShowType.Publicity)
            {
                ...
                bargin = Sys_Trade.Instance.SearchParam.showType == Packet.TradeShowType.Discuss;
            }
            else
            {
                //需要设置subclass

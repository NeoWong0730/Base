...
namespace Logic
{
    public class UI_Trade_Panel_Publicity_WatchItems : UI_Trade_Panel_Publicity_WatchItems.View_Bottom.IListner
    {
        ...
        private class Item_Cell
        {
            ...
            private void OnClickWatch()
            {
                ...
                Sys_Trade.Instance.OnWatchItemReq(m_Brief, !m_IsWatch, bCross);
            }
        ...
        //    {
        //        Item_Cell cell = dicCells[trans.gameObject];
        //        cell.UpdateInfo(_CurBriefs[index]);
        //    }
        //}
        ...
        private void GenItems()
        {
            ...
            //visualGridCount = _CurBriefs.Count;
        ...
        {
            _TotalBriefs = Sys_Trade.Instance.GetWatchItems(Sys_Trade.Instance.CurPublicityServerType == Sys_Trade.ServerType.Cross, Sys_Trade.PageType.Publicity);
            _CurPage = 1;
            ...
            if (_TotalBriefs.Count > 1)
            {
                ...
                {
                    return d1.OnsaleTime.CompareTo(d2.OnsaleTime);
                });
            }

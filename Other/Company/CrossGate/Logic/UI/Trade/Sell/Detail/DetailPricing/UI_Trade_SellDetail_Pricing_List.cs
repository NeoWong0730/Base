...
namespace Logic
{
    public class UI_Trade_SellDetail_Pricing_List
    {
        private class Cell 
        {
            ...
            public void UpdateInfo(TradeBrief brief)
            {
                ...
                m_TradeItem.propItem.SetData(new PropSpeicalLoader.MessageBoxEvt(EUIID.UI_Trade_SellDetail_Pricing, showItem));
                ...
                //m_BtnAssign.gameObject.SetActive(m_IsAssign);

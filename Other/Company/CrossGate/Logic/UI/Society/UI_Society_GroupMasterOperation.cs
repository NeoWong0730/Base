...
namespace Logic
{
    public class UI_Society_GroupMasterOperation_Layout
    {
        ...
        public void Init(GameObject obj)
        {
            ...
            dissmissButton = root.FindChildByName("DissmissButton").GetComponent<Button>();
    ...
    public class UI_Society_GroupMasterOperation : UIBase, UI_Society_GroupMasterOperation_Layout.IListener
    {
        private UI_Society_GroupMasterOperation_Layout layout = new UI_Society_GroupMasterOperation_Layout();
        ...
        public void OnClickDismissButton()
        {
            ...
            //TODO
            PromptBoxParameter.Instance.content = "确定要解散群组么";

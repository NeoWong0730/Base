...
namespace Logic
{
    public class UI_SinglePayHeFu : UI_OperationalActivityBase
    {
        ...
        protected override void Loaded()
        {
            ...
            {
                Sys_SinglePay.Instance.ReqSinglePayHeFuData();
            }
        }
        ...
        private void UpdateView()
        {
            ...
            listIds = Sys_SinglePay.Instance.listHeFuTaskId;
        ...
        private void StartTimer()
        {
            ...
            var targetTime = Sys_SinglePay.Instance.curHeFuEndTime;
        ...
        private void OnTimerComplete()
        {
            timer?.Cancel();
            //关闭页签
            Sys_SinglePay.Instance.eventEmitter.Trigger(Sys_SinglePay.EEvents.OnSinglePayHeFEnd);
        }
        ...
        public class UI_SinglePayCell
        {
            ...
            public void UpdateCellView(uint id)
            {
                ...
                if (data != null)
                {
                    ...
                    uint curCost = Sys_SinglePay.Instance.GetHeFuResidueCount(id);
                    if (maxCost > 0)
                    {
                    ...
                    if (!isGet)
                    {
                        bool canGet = Sys_SinglePay.Instance.CheckHeFuCanGet(id);
            ...
            {
                bool canGet = Sys_SinglePay.Instance.CheckHeFuCanGet(curId);
                if (canGet)
                {
                    Sys_SinglePay.Instance.ReqSinglePayHeFuReward(curId);
                }
            }

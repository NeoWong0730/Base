...
namespace Logic
{
    public partial class UI_Cooking_Collect : UIBase
    {
        ...
        private void ParseCookingMain()
        {
            m_InfinityGrid = transform.Find("Animator/Content/BG2/FoodAttribute/Scroll View").GetComponent<InfinityGrid>();
            m_InfinityGrid.onCreateCell += OnCreateCell;
            m_InfinityGrid.onCellChange += OnCellChange;
        }

        private void RefreshCookingMain()
        {

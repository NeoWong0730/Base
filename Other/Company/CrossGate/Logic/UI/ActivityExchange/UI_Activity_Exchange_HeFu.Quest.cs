...
namespace Logic
{
    public partial class UI_Activity_Exchange_HeFu : UIBase
    {
        ...
        private void OnCellChange_Qt(InfinityGridCell cell, int index)
        {
            ...
            entry.SetData(Sys_ActivityQuest.Instance.questHeFuDatas[index]);
        }
        ...
        public class QuestEntry
        {
            ...
            public void SetData(Sys_ActivityQuest.QuestData questData)
            {
                ...
                m_QuestData = Sys_ActivityQuest.Instance.TryGetHeFuQuestByMissionId(m_Id);
                RefreshEntry();
            }
            ...
            private void OnGetButtonClicked()
            {
                ...
                Sys_ActivityQuest.Instance.ActivityHeFuMissonAwardTakeReq(m_Data.id);
            }

...
namespace Logic {
    public class UI_TaskHint : UIBase {
        ...
        protected override void OnShow() {
            ...
            if (csvTask != null) {
                ...
                if (csvTaskCategory != null) {
                    TextHelper.SetTaskText(this.catlogy, csvTaskCategory.taskTypeTips);
                    ...
                    if (csvTaskCategory.taskTypeTipsColour != null && csvTaskCategory.taskTypeTipsColour.Count >= 4) {
                        ...
                        this.taskBg.color = new UnityEngine.Color(ls[0] / 255f, ls[1] / 255f, ls[2] / 255f, ls[3] / 255f);
                    }
                }
            }
        }

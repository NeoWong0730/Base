...
namespace Logic
{
    public partial class UI_Underground_Vote_Layout
    {
        #region class member
        public class Member
        {
            ...
            private void SetStateIcon(uint uvalue)
            {
                ...
                //Debug.LogError("SetStateIcon ---- state  " + uvalue.ToString());
                ...
                //Debug.LogError("SetStateIcon ---- trans index  " + index.ToString());
            ...
            public void Load(Transform transform)
            {
                ...
                m_TexDesc = transform.Find("Text_High").GetComponent<Text>();
    ...
    public partial class UI_Underground_Vote_Layout
    {
        ...
        private Transform m_TransSecTitle;
        private Text m_TexTitle2;
        ...
        public void Load(Transform root)
        {
            ...
            m_TransSecTitle = root.Find("Animator/View_Right/Image_Title/Image_Go");
            m_TexTitle2 = m_TransSecTitle.Find("Text05").GetComponent<Text>();
            ...
            m_TexTitleName = root.Find("Animator/TtileAndBg/Text_Title").GetComponent<Text>();
        ...
        public void SetTimeProcess(float value)
        {
            m_ImTimePorcess.fillAmount = value;
        }
        ...
        {
            m_TexTitle0.text = string.Empty;
            m_TexTitle10.text = string.Empty;
            m_TexTitle11.text = string.Empty;

            if (m_TexTitle11.gameObject.activeSelf == false)
                m_TexTitle11.gameObject.SetActive(true);

            m_TexTitle11.color = new Color32(139, 90, 107,255);
            m_TexTitle11.text = instanceStr;

            if (m_TransSecTitle.gameObject.activeSelf == false)
                m_TransSecTitle.gameObject.SetActive(true);

            m_TexTitle2.text = chapterStr;
        }
        ...
        public void SetBtnState(bool value0, uint strValue0, bool value1, uint starValue1, bool value2, uint strValue2)
        {
            ...
            mBtn02.gameObject.SetActive(false);
        ...
        public void SetBtnEnable(bool value0, bool value1, bool value2)
        {
            mBtn01.enabled = value0;

            mBtn02.enabled = false;

            mBtn03.enabled = value2;
        }

...
namespace Logic.Core
{
    ...
    public class OptionManager : Singleton<OptionManager>
    {
        ...
        {
            List<int> datas = ReadHelper.ReadArray_ReadInt(CSVParam.Instance.GetConfData(976).str_value, '|');

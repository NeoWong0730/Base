...
public class TriggerCondition_AdventureLevel : TriggerSlot
{
    public int downLimit;
    public int upLimit;

    public TriggerCondition_AdventureLevel() { }
    public TriggerCondition_AdventureLevel(int down, int up) : base()
    {
        SetArg(down, up);
    }
    ...
    {
        Sys_ClueTask.Instance.eventEmitter.Handle<uint, uint>(Sys_ClueTask.EEvents.OnAdventureLevelChanged, OnLevelChanged, toListen);
    }

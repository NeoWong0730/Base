...
namespace Logic
{
    [HUDAnim(AnimType.e_AddHp)]
    public class AddHpCharacterShow : Anim_BaseShow
    {
        ...
        {
            mText.font = FontManager.GetFont(GlobalAssets.sFont_AddHp);// "Font/AddHp_font.fontsettings"
        ...
        public override void Update()
        {
            ...
            //if (bStartShow)
            //{
            //    mPlayTimer -= Sys_HUD.Instance.DeltaTime;
            //    mRootGameObject.transform.Translate(Vector3.up * upSpeed * Sys_HUD.Instance.DeltaTime, Space.World);
            //    if (mPlayTimer - mHideTimer <= 0)
            //    {
            //        bStartShow = false;
            //        DOTween.To(() => mCanvasGroup.alpha, x => mCanvasGroup.alpha = x, 0, mHideTimer).onComplete += OnPlayOver;
            //    }
            //}
        }

...
namespace Logic
{
    [HUDAnim(AnimType.e_Drunk)]
    public class DrunkCharacterShow : Anim_BaseShow
    {
        ...
        {
            mText.font = FontManager.GetFont(GlobalAssets.sFont_Drunk);// "Font/Drunk_font.fontsettings"
            bStartShow = true;
            mText.text = "醉酒" + finnaldamage.ToString();
            SetCrystal();

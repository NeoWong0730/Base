...
namespace Logic
{
    ...
    /// 武器
    /// </summary>
    public class FashionWeapon
    {
        public CSVFashionWeapon.Data cSVFashionWeaponData
        {
            get;
            private set;
        }
        ...
        public bool UnLock
        {
            ...
            set
            {
                ...
                Sys_Fashion.Instance.eventEmitter.Trigger<uint>(Sys_Fashion.EEvents.OnUpdateWeaponLockState, Id);
            }
        }
        private bool dress;
        public bool Dress
        {
            ...
            set
            {
                ...
                {
                    dress = value;
                    Sys_Fashion.Instance.eventEmitter.Trigger<uint>(Sys_Fashion.EEvents.OnUpdateWeaponDressState, Id);
                }
            }
        }
        ...
        public FashionWeapon(uint id, bool _unlock, bool dress)
        {
            Id = id;
            UnLock = _unlock;
            Dress = dress;
            cSVFashionWeaponData = CSVFashionWeapon.Instance.GetConfData(id);
        ...
        public bool CanLock()
        {
            if (cSVFashionWeaponData.LimitedTime == 0)
                return true;
            List<uint> items = cSVFashionWeaponData.FashionItem;
        ...
        {
            if (cSVFashionWeaponData.LimitedTime == 0 || ExpireTime == 0)
            {
            ...
            else
            {
                ...
                Sys_Fashion.Instance.AddActiveFashionWeapon(this);
            }
            Sys_Fashion.Instance.eventEmitter.Trigger<uint>(Sys_Fashion.EEvents.OnUpdateWeaponLimitTime, Id);
        }
        ...
        {
            return Sys_Fashion.Instance.GetWeaponFirstColor(cSVFashionWeaponData.id, tintIndex);
        }

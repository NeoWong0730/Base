...
namespace Logic
{
    public class PlayerControlSystem : LevelSystemBase
    {
        ...
        {         
            ...
            MoveToFx = GameObject.Instantiate<GameObject>(GlobalAssets.GetAsset<GameObject>(GlobalAssets.sPrefab_Fx_yindao));
        ...
        private void OnTouchLongMoveByMouse(Vector3 pos)
        {
            ...
            hero.movementComponent.MoveTo(CameraManager.mCamera.ScreenToWorldPoint(mouseInput));
#endif
        }
        ...
        private void OnInput(EInputType obj)
        {
            if (obj == EInputType.Jump)
            {
                ...
                {
                    GameCenter.mainHero.stateComponent.ChangeState(EStateType.NormalAttack);
                }                
            }
        }
        ...
        private void OnLeftJoystick(Vector2 dir, float dis)
        {
            ...
            MovementComponent movement = hero.movementComponent;
            ...
            else
            {
                ...
                movement.MoveBy(tempVector2, dis);
            }
        }
        ...
        private void OnChangeEquipment()
        {
            ...
            hero.weaponComponent.UpdateWeapon(Sys_Equip.Instance.GetCurWeapon(), false);
            hero?.ChangeModel();
        }
        ...
        public void RaycastHitAll(Vector2 pos)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                if (LayerMaskUtil.ContainLayerInt(ELayerMask.Terrain, hit.collider.gameObject.layer) && currentLayerMask == ELayerMask.None)
                {
                    ...
                    if(GameCenter.mainHero != null)
                    {
                        GameCenter.mainHero.movementComponent.MoveTo(hit.point, StartMoveTo, EndMoveTo, null, MovementComponent.defaultAllowDistance);
                    }                    
                    break;
                }
            ...
            for (int i = 0; i < sceneActors.Count; ++i)
            {
                ...
                IClick click = sceneActors[i] as IClick;
                if (click != null)
                {
                    click.OnClick();
                }                
            ...
            if (Physics.Raycast(ray, out hit, 500f, layerMask))
            {
                if (GameMain.Procedure.CurrentProcedure.ProcedureType == ProcedureManager.EProcedureType.Normal)
                {
                    ...
                    else if (LayerMaskUtil.ContainLayerInt(ELayerMask.NPC, hit.collider.gameObject.layer))
                    {
                        ...
                        if (sceneActorWrap != null)
                        {
                            ...
                            //    clickCom.OnClick();
                            //}
                            IClick click = sceneActorWrap.sceneActor as IClick;
                            if (click != null)
                            {
                                click.OnClick();
                            }
                ...
                else
                {
                    ...
                    if (sceneActorWrap != null)
                    {
                        ...
                        {
                            IDoubleClick doubleClick = sceneActorWrap.sceneActor as IDoubleClick;
                            if (doubleClick != null)
                            {
        ...
        public void RaycastHitLongPress(Vector2 pos)
        {
            ...
            if (Physics.Raycast(ray, out hit, 500f, layerMask))
            {
                ...
                if (sceneActorWrap != null)
                {
                    ...
                    //    clickCom.OnClick();
                    //}
                    ILongPress longPress = sceneActorWrap.sceneActor as ILongPress;
                    if (longPress != null)
                    {

...
namespace Logic
{
    public class HangUpSystem : LevelSystemBase
    {
        ...
        {         
            ...
            if (GameCenter.mainHero != null && GameCenter.mainHero.stateComponent.CurrentState == EStateType.Idle)
            {
        ...
        private void OnTiming(float time)
        {
            ...
            else if (GameCenter.mainHero != null && GameCenter.mainHero.stateComponent.CurrentState != EStateType.Idle)
            {
                Cancel(true);
            }

...
namespace Logic
{
    ...
    public class Constants
    {
        ...
        public static readonly List<uint> IdleAnimationClip = new List<uint>()
        { (uint)EStateType.Idle };

        public static readonly HashSet<uint> IdleAnimationClipHashSet = new HashSet<uint>(IdleAnimationClip);

        public static readonly List<uint> IdleAndRunAnimationClip = new List<uint>()
        { (uint)EStateType.Idle, (uint)EStateType.Run, (uint)EStateType.Walk, (uint)EStateType.Logging, (uint)EStateType.Mining, (uint)EStateType.fishing, (uint)EStateType.hunting, (uint)EStateType.Inquiry, (uint)EStateType.InquiryEnd, (uint)EStateType.NormalAttack, (uint)EStateType.Defense};

        public static readonly HashSet<uint> IdleAndRunAnimationClipHashSet = new HashSet<uint>(IdleAndRunAnimationClip);

        public static readonly List<uint> PetShowAnimationClip = new List<uint>()
        { (uint)EStateType.Idle, (uint)EStateType.Walk, (uint)EStateType.NormalAttack, (uint)EStateType.Cast};

        public static readonly HashSet<uint> PetShowAnimationClipHashSet = new HashSet<uint>(PetShowAnimationClip);

        public static readonly List<uint> CollectionAnimationClip = new List<uint>()
        { (uint)EStateType.Idle, (uint)EStateType.Logging , (uint)EStateType.Mining, (uint)EStateType.fishing, (uint)EStateType.hunting, (uint)EStateType.LossLife, (uint)EStateType.EndLife, (uint)EStateType.Inquiry, (uint)EStateType.InquiryEnd};

        public static readonly HashSet<uint> CollectionAnimationClipHashSet = new HashSet<uint>(CollectionAnimationClip);

        public static readonly List<uint> UIModelShowAnimationClip = new List<uint>(4)
        { (uint)EStateType.UI_Show_Idle, (uint)EStateType.UI_Show_Entrance, (uint)EStateType.UI_Show_Idleshow01, (uint)EStateType.UI_Show_Idleshow02 };

        public static readonly HashSet<uint> UIModelShowAnimationClipHashSet = new HashSet<uint>(UIModelShowAnimationClip);

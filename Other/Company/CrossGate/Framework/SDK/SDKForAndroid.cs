...
public class SDKForAndroid : SDKBase
{
    ...
    {
        if (!CheckIsInitSDK()) return false;

        return Call<bool>("SDK_QQIsInstalled");
    }
    ...
    public override void SDKLeBianPrivacyChecked()
    {
        Call("SDK_LeBianPrivacyChecked");
    }
    ...
    {
        return Call<string>("SDK_GetAppVersion");
    }


    public override string SDKGetDeviceType()
    {
        return Call<string>("SDK_GetDeviceType");
    }
}
#endif
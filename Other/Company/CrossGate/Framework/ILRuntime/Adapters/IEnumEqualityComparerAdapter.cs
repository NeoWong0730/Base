...
public class IEnumEqualityComparerAdapter : CrossBindingAdaptor
{
    ...
    {
        get { return typeof(IEqualityComparer<int>); }
    }
    ...
    internal class Adaptor : IEqualityComparer<int>, CrossBindingAdaptorType
    {
        ...
        public new bool Equals(int x, int y)
        {
            if (!mEqualsMethodGot)
            {

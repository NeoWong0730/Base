...
public class KeyValuePair_2_GameObject_ILTypeInstance_Binder : ValueTypeBinder<KeyValuePair<GameObject, ILTypeInstance>>
{
    public override unsafe void AssignFromStack(ref KeyValuePair<GameObject, ILTypeInstance> ins, StackObject* ptr, IList<object> mStack)
    {
        ...
        //UnityEngine.Debug.LogError("-----KeyValuePair_2_GameObject_ILTypeInstance_Binder");
    }

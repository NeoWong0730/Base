...
unsafe class Framework_Core_UI_UIConfigData_Binder
{
    ...
    static StackObject* CopyToStack_script_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
    {
    ...
    static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
    {
        ...
        Framework.Core.UI.EUIOption @options = (Framework.Core.UI.EUIOption)ptr_of_this_method->Value;
        __intp.Free(ptr_of_this_method);

        ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
        System.String @prefabPath = (System.String)typeof(System.String).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        __intp.Free(ptr_of_this_method);

        ptr_of_this_method = ILIntepreter.Minus(__esp, 4);
        System.Type @script = (System.Type)typeof(System.Type).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        __intp.Free(ptr_of_this_method);

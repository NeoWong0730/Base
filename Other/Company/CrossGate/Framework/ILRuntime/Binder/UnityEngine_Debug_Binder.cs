...
{
    unsafe class UnityEngine_Debug_Binder
    {
        ...
        static StackObject* LogError_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Debug.LogError(@message + "  (用DebugUtil打日志啊,少年!!!)\n" + stackTrace);
        ...
        static StackObject* Log_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Debug.Log(@message + "  (用DebugUtil打日志啊,少年!!!)\n" + stackTrace);
        ...
        static StackObject* LogFormat_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            string stackTrace = __domain.DebugService.GetStackTrace(__intp);
            string log = string.Format(@format, @args) + "  (用DebugUtil打日志啊,少年!!!)\n" + stackTrace;
        ...
        static StackObject* LogErrorFormat_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            string stackTrace = __domain.DebugService.GetStackTrace(__intp);
            string error = string.Format(@format, @args) + "  (用DebugUtil打日志啊,少年!!!)\n" + stackTrace ;

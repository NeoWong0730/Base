...
{
    unsafe class UnityEngine_Events_UnityEvent_1_BaseEventData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData>);
            args = new Type[]{typeof(UnityEngine.Events.UnityAction<UnityEngine.EventSystems.BaseEventData>)};
        ...
        static StackObject* AddListener_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData> instance_of_this_method = (UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData>)typeof(UnityEngine.Events.UnityEvent<UnityEngine.EventSystems.BaseEventData>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);

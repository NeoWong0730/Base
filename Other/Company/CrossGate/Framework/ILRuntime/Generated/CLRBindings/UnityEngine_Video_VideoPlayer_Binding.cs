...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Video_VideoPlayer_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, remove_errorReceived_1);
            args = new Type[]{typeof(UnityEngine.Video.VideoPlayer.ErrorEventHandler)};
            method = type.GetMethod("add_errorReceived", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, add_errorReceived_2);
        ...
        static StackObject* remove_errorReceived_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.Video.VideoPlayer.ErrorEventHandler @value = (UnityEngine.Video.VideoPlayer.ErrorEventHandler)typeof(UnityEngine.Video.VideoPlayer.ErrorEventHandler).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* add_errorReceived_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* set_url_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);

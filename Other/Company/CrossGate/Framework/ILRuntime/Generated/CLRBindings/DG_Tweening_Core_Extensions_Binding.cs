...
{
    unsafe class DG_Tweening_Core_Extensions_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            MethodBase method;
            Type[] args;
            Type type = typeof(DG.Tweening.Core.Extensions);
            ...
            args = new Type[]{typeof(UnityEngine.Color), typeof(UnityEngine.Color), typeof(DG.Tweening.Plugins.Options.ColorOptions)};
            if (genericMethods.TryGetValue("Blendable", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>), typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)))
                    {
                        ...
                        app.RegisterCLRMethodRedirection(method, Blendable_0);
        ...
        static StackObject* Blendable_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = DG.Tweening.Core.Extensions.Blendable<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>(@t);

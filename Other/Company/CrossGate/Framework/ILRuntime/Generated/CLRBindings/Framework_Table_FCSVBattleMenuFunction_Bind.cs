...
{
    unsafe class Framework_Table_FCSVBattleMenuFunction_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVBattleMenuFunction);
            ...
            args = new Type[]{typeof(System.UInt32), typeof(Framework.Table.FCSVBattleMenuFunction.Data).MakeByRefType()};
            ...
            app.RegisterCLRMethodRedirection(method, GetAll_3);
            args = new Type[]{typeof(System.UInt32)};
            method = type.GetMethod("GetConfData", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetConfData_4);
        ...
        static StackObject* ReadByFilePath_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVBattleMenuFunction instance_of_this_method = (Framework.Table.FCSVBattleMenuFunction)typeof(Framework.Table.FCSVBattleMenuFunction).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* TryGetValue_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Framework.Table.FCSVBattleMenuFunction.Data @data = (Framework.Table.FCSVBattleMenuFunction.Data)typeof(Framework.Table.FCSVBattleMenuFunction.Data).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as Framework.Table.FCSVBattleMenuFunction.Data[];
        ...
        static StackObject* GetAll_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* GetConfData_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);

...
{
    unsafe class Framework_Table_FCSVChatBack_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVChatBack);
            ...
            args = new Type[]{typeof(System.UInt32), typeof(Framework.Table.FCSVChatBack.Data).MakeByRefType()};
        ...
        static StackObject* ReadByFilePath_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVChatBack instance_of_this_method = (Framework.Table.FCSVChatBack)typeof(Framework.Table.FCSVChatBack).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* TryGetValue_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Framework.Table.FCSVChatBack.Data @data = (Framework.Table.FCSVChatBack.Data)typeof(Framework.Table.FCSVChatBack.Data).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as Framework.Table.FCSVChatBack.Data[];

...
{
    unsafe class Framework_Table_FCSVCommodityList_Binding_Data_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVCommodityList.Data);
            args = new Type[]{};
            ...
            args = new Type[]{};
            method = type.GetMethod("get_show", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_show_2);
            args = new Type[]{};
        ...
        static StackObject* get_id_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVCommodityList.Data instance_of_this_method = (Framework.Table.FCSVCommodityList.Data)typeof(Framework.Table.FCSVCommodityList.Data).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* get_show_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);

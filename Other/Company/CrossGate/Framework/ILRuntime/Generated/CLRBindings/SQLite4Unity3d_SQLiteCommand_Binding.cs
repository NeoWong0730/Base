...
{
    unsafe class SQLite4Unity3d_SQLiteCommand_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(SQLite4Unity3d.SQLiteCommand);
            args = new Type[]{typeof(System.Type)};
            method = type.GetMethod("ExecuteQuery", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ExecuteQuery_0);


        }


        static StackObject* ExecuteQuery_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {

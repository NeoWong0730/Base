...
{
    unsafe class Framework_Table_FCSVCookBookReward_Binding_Data_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVCookBookReward.Data);
            args = new Type[]{};
        ...
        static StackObject* get_score_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVCookBookReward.Data instance_of_this_method = (Framework.Table.FCSVCookBookReward.Data)typeof(Framework.Table.FCSVCookBookReward.Data).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);

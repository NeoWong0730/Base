...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_LayoutRebuilder_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(UnityEngine.RectTransform)};
            method = type.GetMethod("MarkLayoutForRebuild", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, MarkLayoutForRebuild_1);
        ...
        static StackObject* MarkLayoutForRebuild_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);

...
{
    unsafe class Framework_Table_FCSVDecisiveArenaRankingRedward_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVDecisiveArenaRankingRedward);
            ...
            app.RegisterCLRMethodRedirection(method, GetByIndex_4);
            args = new Type[]{typeof(System.UInt32)};
            method = type.GetMethod("GetConfData", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetConfData_5);
        ...
        static StackObject* ReadByFilePath_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVDecisiveArenaRankingRedward instance_of_this_method = (Framework.Table.FCSVDecisiveArenaRankingRedward)typeof(Framework.Table.FCSVDecisiveArenaRankingRedward).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* GetByIndex_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* GetConfData_5(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);

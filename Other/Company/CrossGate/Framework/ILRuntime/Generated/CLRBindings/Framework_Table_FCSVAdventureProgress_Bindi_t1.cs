...
{
    unsafe class Framework_Table_FCSVAdventureProgress_Binding_Data_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVAdventureProgress.Data);
            args = new Type[]{};
        ...
        static StackObject* get_sort_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVAdventureProgress.Data instance_of_this_method = (Framework.Table.FCSVAdventureProgress.Data)typeof(Framework.Table.FCSVAdventureProgress.Data).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);

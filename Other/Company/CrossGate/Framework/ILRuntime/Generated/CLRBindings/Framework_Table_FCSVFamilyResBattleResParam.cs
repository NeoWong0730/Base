...
{
    unsafe class Framework_Table_FCSVFamilyResBattleResParameter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVFamilyResBattleResParameter);
        ...
        static StackObject* GetConfData_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVFamilyResBattleResParameter instance_of_this_method = (Framework.Table.FCSVFamilyResBattleResParameter)typeof(Framework.Table.FCSVFamilyResBattleResParameter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);

...
{
    unsafe class System_Json_JsonValue_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Json.JsonValue);
            ...
            args = new Type[]{typeof(System.Json.JsonValue)};
            ...
            args = new Type[]{typeof(System.Json.JsonValue)};
            method = methods.Where(t => t.Name.Equals("op_Implicit") && t.ReturnType == typeof(System.UInt32) && t.CheckMethodParams(args)).Single();
        ...
        static StackObject* ContainsKey_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Json.JsonValue instance_of_this_method = (System.Json.JsonValue)typeof(System.Json.JsonValue).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* op_Implicit_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Json.JsonValue @value = (System.Json.JsonValue)typeof(System.Json.JsonValue).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* op_Implicit_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = (System.UInt32)value;

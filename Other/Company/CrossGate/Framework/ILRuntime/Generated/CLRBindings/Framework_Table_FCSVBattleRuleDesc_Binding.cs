...
{
    unsafe class Framework_Table_FCSVBattleRuleDesc_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVBattleRuleDesc);
        ...
        static StackObject* GetConfData_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVBattleRuleDesc instance_of_this_method = (Framework.Table.FCSVBattleRuleDesc)typeof(Framework.Table.FCSVBattleRuleDesc).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);

...
{
    unsafe class Framework_Table_FCSVLevelGift_Binding_Data_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVLevelGift.Data);
            args = new Type[]{};
        ...
        static StackObject* get_Level_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVLevelGift.Data instance_of_this_method = (Framework.Table.FCSVLevelGift.Data)typeof(Framework.Table.FCSVLevelGift.Data).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);

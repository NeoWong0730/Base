...
{
    unsafe class Framework_Table_FCSVVideoType_Binding_Data_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVVideoType.Data);
            args = new Type[]{};
        ...
        static StackObject* get_Name_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVVideoType.Data instance_of_this_method = (Framework.Table.FCSVVideoType.Data)typeof(Framework.Table.FCSVVideoType.Data).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);

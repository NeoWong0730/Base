...
{
    unsafe class Framework_TimelineLifeCircle_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Framework.TimelineLifeCircle);
        ...
        {
            return Framework.TimelineLifeCircle.eventEmitter;
        }

        static StackObject* CopyToStack_eventEmitter_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = Framework.TimelineLifeCircle.eventEmitter;

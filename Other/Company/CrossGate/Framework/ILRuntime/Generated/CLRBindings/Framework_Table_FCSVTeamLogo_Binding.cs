...
{
    unsafe class Framework_Table_FCSVTeamLogo_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVTeamLogo);
            ...
            args = new Type[]{typeof(System.UInt32), typeof(Framework.Table.FCSVTeamLogo.Data).MakeByRefType()};
        ...
        static StackObject* GetConfData_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVTeamLogo instance_of_this_method = (Framework.Table.FCSVTeamLogo)typeof(Framework.Table.FCSVTeamLogo).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* TryGetValue_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Framework.Table.FCSVTeamLogo.Data @data = (Framework.Table.FCSVTeamLogo.Data)typeof(Framework.Table.FCSVTeamLogo.Data).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as Framework.Table.FCSVTeamLogo.Data[];

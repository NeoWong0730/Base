...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_Shadow_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_effectColor_0);
            args = new Type[]{typeof(UnityEngine.Vector2)};
            method = type.GetMethod("set_effectDistance", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_effectDistance_1);


        }


        static StackObject* set_effectColor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.Shadow instance_of_this_method = (UnityEngine.UI.Shadow)typeof(UnityEngine.UI.Shadow).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* set_effectDistance_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);

...
{
    unsafe class Framework_Table_FCSVDecisiveArenaParam_Binding_Data_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVDecisiveArenaParam.Data);
        ...
        {
            return ((Framework.Table.FCSVDecisiveArenaParam.Data)o).str_value;
        }

        static StackObject* CopyToStack_str_value_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Framework.Table.FCSVDecisiveArenaParam.Data)o).str_value;

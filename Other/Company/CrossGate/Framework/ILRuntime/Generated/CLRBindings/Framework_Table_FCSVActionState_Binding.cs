...
{
    unsafe class Framework_Table_FCSVActionState_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.Table.FCSVActionState);
            args = new Type[]{};
            method = type.GetMethod("GetAll", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetAll_0);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("ReadByFilePath", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ReadByFilePath_1);
            args = new Type[]{};
            method = type.GetMethod("Clear", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Clear_2);
            args = new Type[]{typeof(System.UInt32)};
            method = type.GetMethod("GetConfData", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetConfData_3);
            args = new Type[]{typeof(System.UInt32), typeof(Framework.Table.FCSVActionState.Data).MakeByRefType()};
        ...
        static StackObject* GetAll_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.Table.FCSVActionState instance_of_this_method = (Framework.Table.FCSVActionState)typeof(Framework.Table.FCSVActionState).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* ReadByFilePath_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* GetConfData_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* TryGetValue_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Framework.Table.FCSVActionState.Data @data = (Framework.Table.FCSVActionState.Data)typeof(Framework.Table.FCSVActionState.Data).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as Framework.Table.FCSVActionState.Data[];

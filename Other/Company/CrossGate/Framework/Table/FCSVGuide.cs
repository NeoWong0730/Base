...
namespace Framework.Table
{
    public class FCSVGuide
    {
	    sealed public class Data
	    {
			...
			public float auto_time { get; private set; }
			public readonly string effect;
			public uint effect_type { get; private set; }
			public uint finish_type { get; private set; }
			public uint prefab_type { get; private set; }
			public readonly List<uint> prefab_range;
			public uint tippos_type { get; private set; }
    ...
    public class FCSVGuideAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGuide);
            }
        }
        ...
        public class Adapter : FCSVGuide, CrossBindingAdaptorType
        {

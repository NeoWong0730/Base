...
{
    public class FCSVPartnerBelonging
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint list_belonging { get; private set; }
    ...
    public class FCSVPartnerBelongingAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPartnerBelonging);
            }
        }
        ...
        public class Adapter : FCSVPartnerBelonging, CrossBindingAdaptorType
        {

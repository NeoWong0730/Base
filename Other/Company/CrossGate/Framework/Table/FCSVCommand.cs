...
namespace Framework.Table
{
    ...
    public class FCSVCommandAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCommand);
            }
        }
        ...
        public class Adapter : FCSVCommand, CrossBindingAdaptorType
        {

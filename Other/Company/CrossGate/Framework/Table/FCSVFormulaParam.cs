...
namespace Framework.Table
{
    ...
    public class FCSVFormulaParamAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFormulaParam);
            }
        }
        ...
        public class Adapter : FCSVFormulaParam, CrossBindingAdaptorType
        {

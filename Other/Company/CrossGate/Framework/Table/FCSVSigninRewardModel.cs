...
{
    public class FCSVSigninRewardModel
    {
    ...
    public class FCSVSigninRewardModelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSigninRewardModel);
            }
        }
        ...
        public class Adapter : FCSVSigninRewardModel, CrossBindingAdaptorType
        {

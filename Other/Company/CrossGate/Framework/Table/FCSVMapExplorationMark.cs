...
{
    public class FCSVMapExplorationMark
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint function_id { get; private set; }
			public uint resource_icon1 { get; private set; }
			public uint resource_icon2 { get; private set; }
			public uint type_lan { get; private set; }
			public uint List_lan { get; private set; }
			public uint Des_lan { get; private set; }
			public uint List_Icon { get; private set; }
			public uint main_icon { get; private set; }
			public byte tab_type { get; private set; }
    ...
    public class FCSVMapExplorationMarkAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVMapExplorationMark);
            }
        }
        ...
        public class Adapter : FCSVMapExplorationMark, CrossBindingAdaptorType
        {

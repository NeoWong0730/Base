...
{
    public class FCSVTitleColumn
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public int columnType { get; private set; }
			public int columnCondition { get; private set; }
    ...
    public class FCSVTitleColumnAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTitleColumn);
            }
        }
        ...
        public class Adapter : FCSVTitleColumn, CrossBindingAdaptorType
        {

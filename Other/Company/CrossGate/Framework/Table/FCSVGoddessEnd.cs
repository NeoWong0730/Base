...
{
    public class FCSVGoddessEnd
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<uint> stageId;
			public uint endingName { get; private set; }
			public uint endingLan { get; private set; }
    ...
    public class FCSVGoddessEndAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGoddessEnd);
            }
        }
        ...
        public class Adapter : FCSVGoddessEnd, CrossBindingAdaptorType
        {

...
{
    public class FCSVDailyActivityReward
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Activity { get; private set; }
    ...
    public class FCSVDailyActivityRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDailyActivityReward);
            }
        }
        ...
        public class Adapter : FCSVDailyActivityReward, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVDressUnlockAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDressUnlock);
            }
        }
        ...
        public class Adapter : FCSVDressUnlock, CrossBindingAdaptorType
        {

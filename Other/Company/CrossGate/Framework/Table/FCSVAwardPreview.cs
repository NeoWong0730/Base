...
namespace Framework.Table
{
    ...
    public class FCSVAwardPreviewAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAwardPreview);
            }
        }
        ...
        public class Adapter : FCSVAwardPreview, CrossBindingAdaptorType
        {

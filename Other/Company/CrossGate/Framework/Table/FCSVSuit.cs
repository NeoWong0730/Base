...
{
    public class FCSVSuit
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint suit_id { get; private set; }
			public uint suit_name { get; private set; }
			public uint slot_id { get; private set; }
    ...
    public class FCSVSuitAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSuit);
            }
        }
        ...
        public class Adapter : FCSVSuit, CrossBindingAdaptorType
        {

...
{
    public class FCSVCampInformation
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint camp_name { get; private set; }
			public uint camp_description { get; private set; }
			public uint campUnlocked_drop { get; private set; }
			public uint camp_icon { get; private set; }
			public uint camp_background { get; private set; }
			public uint coreBoss_id { get; private set; }
			public Color32 FontColor { get; private set; }
			public Color32 ImageColor { get; private set; }
    ...
    public class FCSVCampInformationAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCampInformation);
            }
        }
        ...
        public class Adapter : FCSVCampInformation, CrossBindingAdaptorType
        {

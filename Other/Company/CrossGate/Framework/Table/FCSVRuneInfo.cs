...
{
    public class FCSVRuneInfo
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint rune_type { get; private set; }
			public uint rune_lvl { get; private set; }
			public uint is_exclusive { get; private set; }
			public readonly List<uint> rune_attribute;
			public uint rune_passiveskillID { get; private set; }
			public uint disintegrate { get; private set; }
			public uint stack_max { get; private set; }
			public uint icon { get; private set; }
			public uint rune_name { get; private set; }
			public uint typeID { get; private set; }
			public uint lvlID { get; private set; }
    ...
    public class FCSVRuneInfoAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVRuneInfo);
            }
        }
        ...
        public class Adapter : FCSVRuneInfo, CrossBindingAdaptorType
        {

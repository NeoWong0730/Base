...
namespace Framework.Table
{
    public class FCSVLifeSkill
    {
	    sealed public class Data
	    {
			...
			public uint lucky__value_max { get; private set; }
			public uint learn_npc { get; private set; }
			public uint task_id { get; private set; }
			public uint icon_id_learn { get; private set; }
			public uint picture { get; private set; }
			public readonly string npc_image;
			public uint desc_id { get; private set; }
    ...
    public class FCSVLifeSkillAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVLifeSkill);
            }
        }
        ...
        public class Adapter : FCSVLifeSkill, CrossBindingAdaptorType
        {

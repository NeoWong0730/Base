...
{
    public class FCSVBiographySeries
    {
    ...
    public class FCSVBiographySeriesAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBiographySeries);
            }
        }
        ...
        public class Adapter : FCSVBiographySeries, CrossBindingAdaptorType
        {

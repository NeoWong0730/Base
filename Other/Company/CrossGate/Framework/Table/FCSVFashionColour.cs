...
{
    public class FCSVFashionColour
    {
    ...
    public class FCSVFashionColourAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFashionColour);
            }
        }
        ...
        public class Adapter : FCSVFashionColour, CrossBindingAdaptorType
        {

...
{
    public class FCSVTalentExchange
    {
    ...
    public class FCSVTalentExchangeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTalentExchange);
            }
        }
        ...
        public class Adapter : FCSVTalentExchange, CrossBindingAdaptorType
        {

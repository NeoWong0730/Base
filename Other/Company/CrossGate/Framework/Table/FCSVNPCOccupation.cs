...
{
    public class FCSVNPCOccupation
    {
	    sealed public class Data
	    {
			...
			public uint nameicon { get; private set; }
    ...
    public class FCSVNPCOccupationAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVNPCOccupation);
            }
        }
        ...
        public class Adapter : FCSVNPCOccupation, CrossBindingAdaptorType
        {

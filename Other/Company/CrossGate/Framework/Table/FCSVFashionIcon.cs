...
{
    public class FCSVFashionIcon
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly string Icon_Path;
			public float Icon_scale { get; private set; }
			public readonly List<float> Icon_pos;
			public float CompeteIcon_scale { get; private set; }
			public readonly List<float> CompeteIcon_pos;
			public float Arena_scale { get; private set; }
    ...
    public class FCSVFashionIconAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFashionIcon);
            }
        }
        ...
        public class Adapter : FCSVFashionIcon, CrossBindingAdaptorType
        {

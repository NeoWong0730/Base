...
namespace Framework.Table
{
    public class FCSVMatch
    {
	    sealed public class Data
	    {
			...
			public uint ActOpen { get; private set; }
			public uint CanTeam { get; private set; }
    ...
    public class FCSVMatchAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVMatch);
            }
        }
        ...
        public class Adapter : FCSVMatch, CrossBindingAdaptorType
        {

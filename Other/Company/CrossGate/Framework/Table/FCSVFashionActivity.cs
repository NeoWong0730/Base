...
namespace Framework.Table
{
    ...
    public class FCSVFashionActivityAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFashionActivity);
            }
        }
        ...
        public class Adapter : FCSVFashionActivity, CrossBindingAdaptorType
        {

...
{
    public class FCSVOrnamentsAttributes
    {
	    sealed public class Data
	    {
			...
			public uint min_attr { get; private set; }
			public uint max_attr { get; private set; }
    ...
    public class FCSVOrnamentsAttributesAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVOrnamentsAttributes);
            }
        }
        ...
        public class Adapter : FCSVOrnamentsAttributes, CrossBindingAdaptorType
        {

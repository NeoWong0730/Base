...
{
    public class FCSVFriendSendItem
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint itemPrice { get; private set; }
			public uint itemPrice_type { get; private set; }
    ...
    public class FCSVFriendSendItemAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFriendSendItem);
            }
        }
        ...
        public class Adapter : FCSVFriendSendItem, CrossBindingAdaptorType
        {

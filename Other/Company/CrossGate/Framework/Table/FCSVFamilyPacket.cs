...
{
    public class FCSVFamilyPacket
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Packet_Type { get; private set; }
    ...
    public class FCSVFamilyPacketAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyPacket);
            }
        }
        ...
        public class Adapter : FCSVFamilyPacket, CrossBindingAdaptorType
        {

...
{
    public class FCSVPedigreedTaskGroup
    {
    ...
    public class FCSVPedigreedTaskGroupAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPedigreedTaskGroup);
            }
        }
        ...
        public class Adapter : FCSVPedigreedTaskGroup, CrossBindingAdaptorType
        {

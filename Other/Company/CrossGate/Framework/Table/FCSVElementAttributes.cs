...
{
    public class FCSVElementAttributes
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<List<uint>> elementAttributes;
			public uint durable { get; private set; }
    ...
    public class FCSVElementAttributesAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVElementAttributes);
            }
        }
        ...
        public class Adapter : FCSVElementAttributes, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVNaviMapAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVNaviMap);
            }
        }
        ...
        public class Adapter : FCSVNaviMap, CrossBindingAdaptorType
        {

...
{
    public class FCSVEquipmentEffect
    {
	    sealed public class Data
	    {
			...
			public uint descripe { get; private set; }
    ...
    public class FCSVEquipmentEffectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVEquipmentEffect);
            }
        }
        ...
        public class Adapter : FCSVEquipmentEffect, CrossBindingAdaptorType
        {

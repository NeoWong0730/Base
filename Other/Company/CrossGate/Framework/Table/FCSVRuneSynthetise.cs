...
{
    public class FCSVRuneSynthetise
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<uint> synthetise_expend;
			public uint synthetise_production { get; private set; }
			public uint synthetise_maxnum { get; private set; }
			public readonly string bg_path;
			public uint baseIcon { get; private set; }
    ...
    public class FCSVRuneSynthetiseAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVRuneSynthetise);
            }
        }
        ...
        public class Adapter : FCSVRuneSynthetise, CrossBindingAdaptorType
        {

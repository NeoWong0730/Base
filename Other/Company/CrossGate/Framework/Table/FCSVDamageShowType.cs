...
{
    public class FCSVDamageShowType
    {
    ...
    public class FCSVDamageShowTypeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDamageShowType);
            }
        }
        ...
        public class Adapter : FCSVDamageShowType, CrossBindingAdaptorType
        {

...
{
    public class FCSVAwakeningCondtion
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint descripvive_lag_Id { get; private set; }
			public uint Condition_lag_Id { get; private set; }
			public uint pop_up_box { get; private set; }
			public uint tel_type { get; private set; }
			public readonly List<List<uint>> skip_Id;
			public readonly List<uint> function_Id;
			public uint not_open { get; private set; }
    ...
    public class FCSVAwakeningCondtionAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAwakeningCondtion);
            }
        }
        ...
        public class Adapter : FCSVAwakeningCondtion, CrossBindingAdaptorType
        {

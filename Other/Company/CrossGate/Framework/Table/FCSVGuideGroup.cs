...
namespace Framework.Table
{
    public class FCSVGuideGroup
    {
	    sealed public class Data
	    {
			...
			public uint task_limited { get; private set; }
			public uint task_finish { get; private set; }
			public uint tasktarget_finish { get; private set; }
			public uint function_id { get; private set; }
			public uint UI_id { get; private set; }
			public readonly List<string> Tab_path;
			public uint enemy_id { get; private set; }
    ...
    public class FCSVGuideGroupAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGuideGroup);
            }
        }
        ...
        public class Adapter : FCSVGuideGroup, CrossBindingAdaptorType
        {

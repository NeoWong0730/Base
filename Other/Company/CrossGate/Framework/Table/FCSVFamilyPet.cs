...
namespace Framework.Table
{
    public class FCSVFamilyPet
    {
	    sealed public class Data
	    {
			...
			public uint familyPet_id { get; private set; }
			public uint icon_id { get; private set; }
			public readonly string icon2_id;
			public uint growthValueMax { get; private set; }
			public uint dailyGrowthValueMax { get; private set; }
			public readonly List<uint> train_id;
			public uint simpleText { get; private set; }
			public uint rewardPreview { get; private set; }
			public uint diffcultyDetails { get; private set; }
			public uint battle_id { get; private set; }
			public readonly List<List<uint>> moodPassiveSkill_id;
			public readonly List<List<uint>> healthPassiveSkill_id;
			public uint trainingIntegralCondition { get; private set; }
    ...
    public class FCSVFamilyPetAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyPet);
            }
        }
        ...
        public class Adapter : FCSVFamilyPet, CrossBindingAdaptorType
        {

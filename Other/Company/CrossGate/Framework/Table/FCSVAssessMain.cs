...
namespace Framework.Table
{
    public class FCSVAssessMain
    {
	    sealed public class Data
	    {
			...
			public byte Tips { get; private set; }
    ...
    public class FCSVAssessMainAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAssessMain);
            }
        }
        ...
        public class Adapter : FCSVAssessMain, CrossBindingAdaptorType
        {

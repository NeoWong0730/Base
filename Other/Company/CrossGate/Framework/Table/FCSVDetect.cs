...
{
    public class FCSVDetect
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint TaskID { get; private set; }
			public uint TaskTargetNum { get; private set; }
			public uint duration { get; private set; }
			public readonly string DetectAction;
			public uint Fx { get; private set; }
			public readonly string EndAction;
			public uint EndFx { get; private set; }
			public uint Result { get; private set; }
			public uint ClueText { get; private set; }
    ...
    public class FCSVDetectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDetect);
            }
        }
        ...
        public class Adapter : FCSVDetect, CrossBindingAdaptorType
        {

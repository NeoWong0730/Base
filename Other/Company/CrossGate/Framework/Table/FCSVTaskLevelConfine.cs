...
{
    public class FCSVTaskLevelConfine
    {
    ...
    public class FCSVTaskLevelConfineAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTaskLevelConfine);
            }
        }
        ...
        public class Adapter : FCSVTaskLevelConfine, CrossBindingAdaptorType
        {

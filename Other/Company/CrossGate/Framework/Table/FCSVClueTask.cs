...
{
    public class FCSVClueTask
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint TaskStar { get; private set; }
			public uint TaskName { get; private set; }
			public uint TaskDes { get; private set; }
			public uint TaskType { get; private set; }
			public uint TriggerCondition_PlayerLevel { get; private set; }
			public uint TriggerCondition_DetectiveLevel { get; private set; }
			public uint TriggerCondition_AdventureLevel { get; private set; }
			public readonly List<uint> TriggerCondition_FinishTasks;
			public readonly List<uint> TriggerCondition_UnlockMaps;
			public uint TriggerCondition_Special { get; private set; }
			public readonly List<uint> PhasedTasksGroup;
			public uint TaskCompleteDes { get; private set; }
    ...
    public class FCSVClueTaskAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVClueTask);
            }
        }
        ...
        public class Adapter : FCSVClueTask, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVGMMailAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGMMail);
            }
        }
        ...
        public class Adapter : FCSVGMMail, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVLanguageAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVLanguage);
            }
        }
        ...
        public class Adapter : FCSVLanguage, CrossBindingAdaptorType
        {

...
{
    public class FCSVPetNewSkillSummary
    {
    ...
    public class FCSVPetNewSkillSummaryAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewSkillSummary);
            }
        }
        ...
        public class Adapter : FCSVPetNewSkillSummary, CrossBindingAdaptorType
        {

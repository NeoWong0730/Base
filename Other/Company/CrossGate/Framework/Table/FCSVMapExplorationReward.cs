...
{
    public class FCSVMapExplorationReward
    {
	    sealed public class Data
	    {
			...
			public uint ExplorationDegree { get; private set; }
			public uint DropId { get; private set; }
			public uint lan { get; private set; }
			public uint title_lan { get; private set; }
			public uint title_icon { get; private set; }
    ...
    public class FCSVMapExplorationRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVMapExplorationReward);
            }
        }
        ...
        public class Adapter : FCSVMapExplorationReward, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVGoddessGiftAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGoddessGift);
            }
        }
        ...
        public class Adapter : FCSVGoddessGift, CrossBindingAdaptorType
        {

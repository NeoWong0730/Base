...
{
    public class FCSVShock
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint duration { get; private set; }
			public uint strength_x { get; private set; }
			public uint strength_y { get; private set; }
			public uint strength_z { get; private set; }
			public uint vibrato { get; private set; }
			public uint randomness { get; private set; }
    ...
    public class FCSVShockAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVShock);
            }
        }
        ...
        public class Adapter : FCSVShock, CrossBindingAdaptorType
        {

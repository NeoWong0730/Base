...
{
    public class FCSVBattlePassUpgrade
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Base_Reward { get; private set; }
			public uint Advanced_reward { get; private set; }
			public uint Reward_Type { get; private set; }
    ...
    public class FCSVBattlePassUpgradeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattlePassUpgrade);
            }
        }
        ...
        public class Adapter : FCSVBattlePassUpgrade, CrossBindingAdaptorType
        {

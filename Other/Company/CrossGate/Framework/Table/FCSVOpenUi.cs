...
{
    public class FCSVOpenUi
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Uiid { get; private set; }
			public uint ui_para { get; private set; }
			public int ui_para1 { get; private set; }
			public int ui_para2 { get; private set; }
    ...
    public class FCSVOpenUiAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVOpenUi);
            }
        }
        ...
        public class Adapter : FCSVOpenUi, CrossBindingAdaptorType
        {

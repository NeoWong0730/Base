...
{
    public class FCSVFamilyBossParam
    {
    ...
    public class FCSVFamilyBossParamAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyBossParam);
            }
        }
        ...
        public class Adapter : FCSVFamilyBossParam, CrossBindingAdaptorType
        {

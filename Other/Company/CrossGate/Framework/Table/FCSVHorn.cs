...
{
    public class FCSVHorn
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint sortIndex_id { get; private set; }
    ...
    public class FCSVHornAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVHorn);
            }
        }
        ...
        public class Adapter : FCSVHorn, CrossBindingAdaptorType
        {

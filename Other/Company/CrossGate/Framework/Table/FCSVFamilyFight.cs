...
{
    public class FCSVFamilyFight
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint familyActiveName { get; private set; }
			public uint familyActiveIcon { get; private set; }
			public uint funcId { get; private set; }
    ...
    public class FCSVFamilyFightAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyFight);
            }
        }
        ...
        public class Adapter : FCSVFamilyFight, CrossBindingAdaptorType
        {

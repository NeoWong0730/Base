...
{
    public class FCSVCareerTeaching
    {
	    sealed public class Data
	    {
			...
			public readonly List<uint> control_desc;
            ...
            public Data(uint id, BinaryReader binaryReader, TableShareData shareData)
            {
				...
				control_desc = shareData.GetShareData<List<uint>>(binaryReader, 0);
    ...
    public class FCSVCareerTeachingAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCareerTeaching);
            }
        }
        ...
        public class Adapter : FCSVCareerTeaching, CrossBindingAdaptorType
        {

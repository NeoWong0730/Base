...
{
    public class FCSVChallengeLevel
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint rule_name { get; private set; }
			public uint difficulty_level { get; private set; }
			public readonly List<uint> challengeLevelLimit;
			public readonly List<uint> BOSS_id;
			public uint island_id { get; private set; }
			public uint rulePage_leve { get; private set; }
			public uint rulePage_description { get; private set; }
			public uint rulePage_time { get; private set; }
			public uint rulePage_rewardTimes { get; private set; }
    ...
    public class FCSVChallengeLevelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVChallengeLevel);
            }
        }
        ...
        public class Adapter : FCSVChallengeLevel, CrossBindingAdaptorType
        {

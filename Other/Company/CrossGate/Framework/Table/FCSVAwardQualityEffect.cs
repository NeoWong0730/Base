...
{
    public class FCSVAwardQualityEffect
    {
    ...
    public class FCSVAwardQualityEffectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAwardQualityEffect);
            }
        }
        ...
        public class Adapter : FCSVAwardQualityEffect, CrossBindingAdaptorType
        {

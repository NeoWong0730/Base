...
{
    public class FCSVFavorabilityBehavior
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Name { get; private set; }
			public uint CostPoint { get; private set; }
			public uint DailyTotal { get; private set; }
			public uint DailyTimes { get; private set; }
			public uint FunctionOpenid { get; private set; }
			public uint IncreaseFavorabilityValue { get; private set; }
    ...
    public class FCSVFavorabilityBehaviorAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFavorabilityBehavior);
            }
        }
        ...
        public class Adapter : FCSVFavorabilityBehavior, CrossBindingAdaptorType
        {

...
{
    public class FCSVBattleStage
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint enemy_group { get; private set; }
			public uint battle_stage { get; private set; }
			public uint battle_scene { get; private set; }
			public uint position_type { get; private set; }
			public uint new_role { get; private set; }
			public readonly List<uint> skill_id;
			public uint refresh_work_id { get; private set; }
    ...
    public class FCSVBattleStageAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattleStage);
            }
        }
        ...
        public class Adapter : FCSVBattleStage, CrossBindingAdaptorType
        {

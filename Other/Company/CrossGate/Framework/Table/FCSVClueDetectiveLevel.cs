...
{
    public class FCSVClueDetectiveLevel
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint UpgradeExp { get; private set; }
			public uint Name { get; private set; }
			public uint Badge { get; private set; }
    ...
    public class FCSVClueDetectiveLevelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVClueDetectiveLevel);
            }
        }
        ...
        public class Adapter : FCSVClueDetectiveLevel, CrossBindingAdaptorType
        {

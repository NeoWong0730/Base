...
{
    public class FCSVCookLv
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint need_score { get; private set; }
    ...
    public class FCSVCookLvAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCookLv);
            }
        }
        ...
        public class Adapter : FCSVCookLv, CrossBindingAdaptorType
        {

...
{
    public class FCSVNPCFavorabilityStage
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Favorabilityid { get; private set; }
			public uint Stage { get; private set; }
			public uint FavorabilityValueMax { get; private set; }
			public uint WishTask { get; private set; }
			public uint RewardType { get; private set; }
			public uint LetterLan { get; private set; }
			public uint Reward { get; private set; }
			public uint SickDia { get; private set; }
			public uint InteractiveDia { get; private set; }
			public uint WishTaskDia { get; private set; }
			public uint LetterDia { get; private set; }
			public uint TalkDia { get; private set; }
    ...
    public class FCSVNPCFavorabilityStageAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVNPCFavorabilityStage);
            }
        }
        ...
        public class Adapter : FCSVNPCFavorabilityStage, CrossBindingAdaptorType
        {

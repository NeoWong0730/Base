...
{
    public class FCSVFamilyResBattleResParameter
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint WhetherExist { get; private set; }
			public uint RefreshInterval { get; private set; }
			public uint GetResource { get; private set; }
			public uint GetPersonalScore { get; private set; }
    ...
    public class FCSVFamilyResBattleResParameterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyResBattleResParameter);
            }
        }
        ...
        public class Adapter : FCSVFamilyResBattleResParameter, CrossBindingAdaptorType
        {

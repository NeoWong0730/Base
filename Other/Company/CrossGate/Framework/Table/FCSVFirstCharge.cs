...
namespace Framework.Table
{
    ...
    public class FCSVFirstChargeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFirstCharge);
            }
        }
        ...
        public class Adapter : FCSVFirstCharge, CrossBindingAdaptorType
        {

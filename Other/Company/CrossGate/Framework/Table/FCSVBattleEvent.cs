...
namespace Framework.Table
{
    ...
    public class FCSVBattleEventAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattleEvent);
            }
        }
        ...
        public class Adapter : FCSVBattleEvent, CrossBindingAdaptorType
        {

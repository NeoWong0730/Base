...
namespace Framework.Table
{
    public class FCSVGuideEffect
    {
	    sealed public class Data
	    {
			...
			public float effect_time { get; private set; }
			...
			public uint arrow_direction { get; private set; }
    ...
    public class FCSVGuideEffectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGuideEffect);
            }
        }
        ...
        public class Adapter : FCSVGuideEffect, CrossBindingAdaptorType
        {

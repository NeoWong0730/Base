...
{
    public class FCSVCharacterAttribute
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint attr_id { get; private set; }
			public uint totol_exp { get; private set; }
			public uint upgrade_exp { get; private set; }
			public readonly List<List<uint>> attribute;
			public uint offline_exp { get; private set; }
			public byte pet_summon_num { get; private set; }
			public uint VitalityLimit { get; private set; }
			public uint AidPointLimit { get; private set; }
			public uint CaptainPointLimit { get; private set; }
			public uint PerWorkingHourExp { get; private set; }
			public uint DailyHangupTotalExp { get; private set; }
			public uint WelfareExp { get; private set; }
			public uint FamilyReceptionSecondExp { get; private set; }
    ...
    public class FCSVCharacterAttributeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCharacterAttribute);
            }
        }
        ...
        public class Adapter : FCSVCharacterAttribute, CrossBindingAdaptorType
        {

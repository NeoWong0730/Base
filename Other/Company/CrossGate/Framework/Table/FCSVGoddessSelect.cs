...
{
    public class FCSVGoddessSelect
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint StageLan { get; private set; }
			public uint QuestionLan { get; private set; }
			public uint StageId1 { get; private set; }
			public uint lanid1 { get; private set; }
			public uint StageId2 { get; private set; }
			public uint lanid2 { get; private set; }
			public uint StageId3 { get; private set; }
			public uint lanid3 { get; private set; }
			public uint StageId4 { get; private set; }
			public uint lanid4 { get; private set; }
    ...
    public class FCSVGoddessSelectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGoddessSelect);
            }
        }
        ...
        public class Adapter : FCSVGoddessSelect, CrossBindingAdaptorType
        {

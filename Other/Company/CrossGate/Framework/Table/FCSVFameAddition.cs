...
{
    public class FCSVFameAddition
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint level_gap { get; private set; }
			public uint add_ratio { get; private set; }
    ...
    public class FCSVFameAdditionAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFameAddition);
            }
        }
        ...
        public class Adapter : FCSVFameAddition, CrossBindingAdaptorType
        {

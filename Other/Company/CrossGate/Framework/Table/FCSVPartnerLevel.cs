...
namespace Framework.Table
{
    ...
    public class FCSVPartnerLevelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPartnerLevel);
            }
        }
        ...
        public class Adapter : FCSVPartnerLevel, CrossBindingAdaptorType
        {

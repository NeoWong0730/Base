...
namespace Framework.Table
{
    ...
    public class FCSVBattleDropAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattleDrop);
            }
        }
        ...
        public class Adapter : FCSVBattleDrop, CrossBindingAdaptorType
        {

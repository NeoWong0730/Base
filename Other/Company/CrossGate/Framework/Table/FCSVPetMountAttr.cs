...
namespace Framework.Table
{
    public class FCSVPetMountAttr
    {
	    sealed public class Data
	    {
			...
			public uint gear_param { get; private set; }
    ...
    public class FCSVPetMountAttrAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetMountAttr);
            }
        }
        ...
        public class Adapter : FCSVPetMountAttr, CrossBindingAdaptorType
        {

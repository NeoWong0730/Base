...
{
    public class FCSVFameRank
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint name { get; private set; }
			public uint lvup_cost { get; private set; }
			public readonly List<List<uint>> rank_attr;
			public readonly List<List<uint>> lv_attr;
			public uint rank_score { get; private set; }
			public uint lv_score { get; private set; }
    ...
    public class FCSVFameRankAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFameRank);
            }
        }
        ...
        public class Adapter : FCSVFameRank, CrossBindingAdaptorType
        {

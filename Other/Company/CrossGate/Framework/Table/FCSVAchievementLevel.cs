...
{
    public class FCSVAchievementLevel
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Level { get; private set; }
			public uint Level_Test { get; private set; }
			public uint Need_Points { get; private set; }
    ...
    public class FCSVAchievementLevelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAchievementLevel);
            }
        }
        ...
        public class Adapter : FCSVAchievementLevel, CrossBindingAdaptorType
        {

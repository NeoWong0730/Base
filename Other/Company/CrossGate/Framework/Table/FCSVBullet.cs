...
{
    public class FCSVBullet
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint show_hp_change { get; private set; }
			public uint track_type { get; private set; }
			public uint position { get; private set; }
			public uint is_forward { get; private set; }
			public int parma1 { get; private set; }
			public uint bullet_change_type { get; private set; }
			public int parma2 { get; private set; }
			public uint parma3 { get; private set; }
			public int position_offsetx { get; private set; }
			public int position_offsety { get; private set; }
			public int position_offsetz { get; private set; }
    ...
    public class FCSVBulletAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBullet);
            }
        }
        ...
        public class Adapter : FCSVBullet, CrossBindingAdaptorType
        {

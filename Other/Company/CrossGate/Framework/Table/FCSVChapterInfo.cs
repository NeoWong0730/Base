...
{
    public class FCSVChapterInfo
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint category { get; private set; }
			public uint ChapterNum { get; private set; }
			public uint ChapterOpenlv { get; private set; }
			public uint ChapterDescribe { get; private set; }
			public uint ChapterTaskNum { get; private set; }
			public uint DropWatchId { get; private set; }
			public uint DropDescribe { get; private set; }
    ...
    public class FCSVChapterInfoAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVChapterInfo);
            }
        }
        ...
        public class Adapter : FCSVChapterInfo, CrossBindingAdaptorType
        {

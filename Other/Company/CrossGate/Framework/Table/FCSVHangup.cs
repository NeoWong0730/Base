...
{
    public class FCSVHangup
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint HangupName { get; private set; }
			public uint HangupDes { get; private set; }
    ...
    public class FCSVHangupAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVHangup);
            }
        }
        ...
        public class Adapter : FCSVHangup, CrossBindingAdaptorType
        {

...
{
    public class FCSVArenaWinAward
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint CourtId { get; private set; }
			public uint Win { get; private set; }
			public uint Fail { get; private set; }
    ...
    public class FCSVArenaWinAwardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVArenaWinAward);
            }
        }
        ...
        public class Adapter : FCSVArenaWinAward, CrossBindingAdaptorType
        {

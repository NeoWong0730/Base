...
{
    public class FCSVFamilyPetMood
    {
    ...
    public class FCSVFamilyPetMoodAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyPetMood);
            }
        }
        ...
        public class Adapter : FCSVFamilyPetMood, CrossBindingAdaptorType
        {

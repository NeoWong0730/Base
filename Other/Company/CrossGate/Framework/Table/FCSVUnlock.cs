...
{
    public class FCSVUnlock
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint qteUIId { get; private set; }
			public uint CompletionTime { get; private set; }
			public uint QteText { get; private set; }
    ...
    public class FCSVUnlockAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVUnlock);
            }
        }
        ...
        public class Adapter : FCSVUnlock, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVBoxTypeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBoxType);
            }
        }
        ...
        public class Adapter : FCSVBoxType, CrossBindingAdaptorType
        {

...
{
    public class FCSVFamilyResBattleParameter
    {
    ...
    public class FCSVFamilyResBattleParameterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyResBattleParameter);
            }
        }
        ...
        public class Adapter : FCSVFamilyResBattleParameter, CrossBindingAdaptorType
        {

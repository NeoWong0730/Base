...
{
    public class FCSVTreasuresUnlock
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint store_lv { get; private set; }
    ...
    public class FCSVTreasuresUnlockAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTreasuresUnlock);
            }
        }
        ...
        public class Adapter : FCSVTreasuresUnlock, CrossBindingAdaptorType
        {

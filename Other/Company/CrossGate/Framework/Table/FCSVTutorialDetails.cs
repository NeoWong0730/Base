...
{
    public class FCSVTutorialDetails
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint tutorial_text { get; private set; }
    ...
    public class FCSVTutorialDetailsAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTutorialDetails);
            }
        }
        ...
        public class Adapter : FCSVTutorialDetails, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVAttrConvertAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAttrConvert);
            }
        }
        ...
        public class Adapter : FCSVAttrConvert, CrossBindingAdaptorType
        {

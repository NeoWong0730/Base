...
{
    public class FCSVPassiveSkill
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint behavior_name { get; private set; }
			public uint behavior_work_id { get; private set; }
			public uint effect_trigger { get; private set; }
    ...
    public class FCSVPassiveSkillAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPassiveSkill);
            }
        }
        ...
        public class Adapter : FCSVPassiveSkill, CrossBindingAdaptorType
        {

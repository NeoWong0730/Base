...
namespace Framework.Table
{
    public class FCSVSign
    {
	    sealed public class Data
	    {
			...
			public uint Pond { get; private set; }
			public uint Prob_1 { get; private set; }
			public uint Prob_2 { get; private set; }
    ...
    public class FCSVSignAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSign);
            }
        }
        ...
        public class Adapter : FCSVSign, CrossBindingAdaptorType
        {

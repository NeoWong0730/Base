...
namespace Framework.Table
{
    public class FCSVTerrorSeries
    {
	    sealed public class Data
	    {
			...
			public uint instance_des { get; private set; }
    ...
    public class FCSVTerrorSeriesAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTerrorSeries);
            }
        }
        ...
        public class Adapter : FCSVTerrorSeries, CrossBindingAdaptorType
        {

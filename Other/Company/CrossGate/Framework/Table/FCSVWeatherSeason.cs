...
{
    public class FCSVWeatherSeason
    {
    ...
    public class FCSVWeatherSeasonAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVWeatherSeason);
            }
        }
        ...
        public class Adapter : FCSVWeatherSeason, CrossBindingAdaptorType
        {

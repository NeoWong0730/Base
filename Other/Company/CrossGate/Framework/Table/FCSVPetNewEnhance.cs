...
{
    public class FCSVPetNewEnhance
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint exp { get; private set; }
			public byte pet_lv { get; private set; }
    ...
    public class FCSVPetNewEnhanceAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewEnhance);
            }
        }
        ...
        public class Adapter : FCSVPetNewEnhance, CrossBindingAdaptorType
        {

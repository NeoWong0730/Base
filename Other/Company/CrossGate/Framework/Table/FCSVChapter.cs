...
{
    public class FCSVChapter
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint chapterName { get; private set; }
    ...
    public class FCSVChapterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVChapter);
            }
        }
        ...
        public class Adapter : FCSVChapter, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVFamilyActiveAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyActive);
            }
        }
        ...
        public class Adapter : FCSVFamilyActive, CrossBindingAdaptorType
        {

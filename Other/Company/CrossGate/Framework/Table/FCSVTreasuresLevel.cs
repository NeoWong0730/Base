...
{
    public class FCSVTreasuresLevel
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint bg { get; private set; }
    ...
    public class FCSVTreasuresLevelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTreasuresLevel);
            }
        }
        ...
        public class Adapter : FCSVTreasuresLevel, CrossBindingAdaptorType
        {

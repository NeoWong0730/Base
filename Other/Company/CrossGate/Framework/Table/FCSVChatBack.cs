...
{
    public class FCSVChatBack
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint BackName { get; private set; }
			public uint BackDescribe { get; private set; }
			public uint Lock { get; private set; }
			public uint LimitedTime { get; private set; }
			public uint BackGetFor { get; private set; }
			public readonly List<uint> BackParamFor;
			public uint BackGetLimit { get; private set; }
    ...
    public class FCSVChatBackAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVChatBack);
            }
        }
        ...
        public class Adapter : FCSVChatBack, CrossBindingAdaptorType
        {

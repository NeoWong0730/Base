...
{
    public class FCSVFavorabilityPlaceReward
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint PlaceName { get; private set; }
			public uint RewardName { get; private set; }
			public uint RewardDes { get; private set; }
    ...
    public class FCSVFavorabilityPlaceRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFavorabilityPlaceReward);
            }
        }
        ...
        public class Adapter : FCSVFavorabilityPlaceReward, CrossBindingAdaptorType
        {

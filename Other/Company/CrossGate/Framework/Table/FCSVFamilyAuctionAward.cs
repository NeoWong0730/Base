...
{
    public class FCSVFamilyAuctionAward
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint ActId { get; private set; }
    ...
    public class FCSVFamilyAuctionAwardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyAuctionAward);
            }
        }
        ...
        public class Adapter : FCSVFamilyAuctionAward, CrossBindingAdaptorType
        {

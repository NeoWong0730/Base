...
namespace Framework.Table
{
    ...
    public class FCSVPartnerSkillAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPartnerSkill);
            }
        }
        ...
        public class Adapter : FCSVPartnerSkill, CrossBindingAdaptorType
        {

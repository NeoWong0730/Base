...
namespace Framework.Table
{
    ...
    public class FCSVActivityTimeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVActivityTime);
            }
        }
        ...
        public class Adapter : FCSVActivityTime, CrossBindingAdaptorType
        {

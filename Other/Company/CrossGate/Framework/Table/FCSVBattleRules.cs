...
namespace Framework.Table
{
    ...
    public class FCSVBattleRulesAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattleRules);
            }
        }
        ...
        public class Adapter : FCSVBattleRules, CrossBindingAdaptorType
        {

...
{
    public class FCSVFamilyResBattleTeam
    {
    ...
    public class FCSVFamilyResBattleTeamAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyResBattleTeam);
            }
        }
        ...
        public class Adapter : FCSVFamilyResBattleTeam, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVAiBubbleChatAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAiBubbleChat);
            }
        }
        ...
        public class Adapter : FCSVAiBubbleChat, CrossBindingAdaptorType
        {

...
{
    public class FCSVOrnamentsUpgrade
    {
	    sealed public class Data
	    {
			...
			public uint extra_attr_num { get; private set; }
			public uint extra_attr_add { get; private set; }
			public uint senior_max_num { get; private set; }
			public uint senior_rate { get; private set; }
			public uint senior_group { get; private set; }
			public uint senior_skill_pro { get; private set; }
			public uint junior_group { get; private set; }
			public uint skill_pro { get; private set; }
    ...
    public class FCSVOrnamentsUpgradeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVOrnamentsUpgrade);
            }
        }
        ...
        public class Adapter : FCSVOrnamentsUpgrade, CrossBindingAdaptorType
        {

...
{
    public class FCSVMonsterAttribute
    {
    ...
    public class FCSVMonsterAttributeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVMonsterAttribute);
            }
        }
        ...
        public class Adapter : FCSVMonsterAttribute, CrossBindingAdaptorType
        {

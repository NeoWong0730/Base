...
namespace Framework.Table
{
    ...
    public class FCSVAidPointAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAidPoint);
            }
        }
        ...
        public class Adapter : FCSVAidPoint, CrossBindingAdaptorType
        {

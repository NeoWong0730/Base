...
namespace Framework.Table
{
    public class FCSVIndustryTask
    {
	    sealed public class Data
	    {
			...
			public uint minConsumeNum { get; private set; }
    ...
    public class FCSVIndustryTaskAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVIndustryTask);
            }
        }
        ...
        public class Adapter : FCSVIndustryTask, CrossBindingAdaptorType
        {

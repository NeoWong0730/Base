...
{
    public class FCSVTeamTarget
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint play_name { get; private set; }
			public uint client_in { get; private set; }
			public readonly List<uint> param1;
			public uint target_in { get; private set; }
			public uint client_out { get; private set; }
			public readonly List<uint> param2;
			public uint target_out { get; private set; }
    ...
    public class FCSVTeamTargetAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTeamTarget);
            }
        }
        ...
        public class Adapter : FCSVTeamTarget, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVDubbingAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDubbing);
            }
        }
        ...
        public class Adapter : FCSVDubbing, CrossBindingAdaptorType
        {

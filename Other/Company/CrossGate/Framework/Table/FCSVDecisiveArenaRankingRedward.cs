...
{
    public class FCSVDecisiveArenaRankingRedward
    {
    ...
    public class FCSVDecisiveArenaRankingRedwardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDecisiveArenaRankingRedward);
            }
        }
        ...
        public class Adapter : FCSVDecisiveArenaRankingRedward, CrossBindingAdaptorType
        {

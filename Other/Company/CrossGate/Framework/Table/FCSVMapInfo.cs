...
namespace Framework.Table
{
    public class FCSVMapInfo
    {
	    sealed public class Data
	    {
			...
			public uint room_pointx { get; private set; }
			public uint room_pointy { get; private set; }
			public uint room_pointz { get; private set; }
			public uint sound_bgm { get; private set; }
			public readonly List<int> monster_id;
			public readonly List<int> map_lv;
			public int fog_type { get; private set; }
			public int minimap_showtype { get; private set; }
			...
			public float ui_length { get; private set; }
			public float ui_width { get; private set; }
			public uint can_pvp { get; private set; }
			public uint use_scence { get; private set; }
			public uint weather { get; private set; }
			public readonly List<int> remove_weather;
			public byte EnemySwitch { get; private set; }
			...
			public uint PromptName { get; private set; }
			public uint PromptContent { get; private set; }
    ...
    public class FCSVMapInfoAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVMapInfo);
            }
        }
        ...
        public class Adapter : FCSVMapInfo, CrossBindingAdaptorType
        {

...
{
    public class FCSBiographyChapter
    {
    ...
    public class FCSBiographyChapterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSBiographyChapter);
            }
        }
        ...
        public class Adapter : FCSBiographyChapter, CrossBindingAdaptorType
        {

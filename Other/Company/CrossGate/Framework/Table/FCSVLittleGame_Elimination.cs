...
namespace Framework.Table
{
    ...
    public class FCSVLittleGame_EliminationAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVLittleGame_Elimination);
            }
        }
        ...
        public class Adapter : FCSVLittleGame_Elimination, CrossBindingAdaptorType
        {

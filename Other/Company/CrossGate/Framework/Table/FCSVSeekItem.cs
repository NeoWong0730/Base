...
namespace Framework.Table
{
    public class FCSVSeekItem
    {
	    sealed public class Data
	    {
			...
			public uint spaceTips { get; private set; }
			public uint errorTips { get; private set; }
			public uint trueTips { get; private set; }
			public readonly List<uint> itemId;
			public uint showItem { get; private set; }
			public uint effectType { get; private set; }
    ...
    public class FCSVSeekItemAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSeekItem);
            }
        }
        ...
        public class Adapter : FCSVSeekItem, CrossBindingAdaptorType
        {

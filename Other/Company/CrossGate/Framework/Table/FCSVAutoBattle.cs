...
{
    public class FCSVAutoBattle
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint order_1time { get; private set; }
			public uint order_2time { get; private set; }
    ...
    public class FCSVAutoBattleAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAutoBattle);
            }
        }
        ...
        public class Adapter : FCSVAutoBattle, CrossBindingAdaptorType
        {

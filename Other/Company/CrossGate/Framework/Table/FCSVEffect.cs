...
{
    public class FCSVEffect
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint pre_load { get; private set; }
			public uint tie_point { get; private set; }
			public uint isrotate { get; private set; }
			public int rotation_x { get; private set; }
			public int rotation_y { get; private set; }
			public int rotation_z { get; private set; }
			public uint fx_starttime { get; private set; }
			public uint fx_duration { get; private set; }
    ...
    public class FCSVEffectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVEffect);
            }
        }
        ...
        public class Adapter : FCSVEffect, CrossBindingAdaptorType
        {

...
{
    public class FCSVAdventureProgress
    {
    ...
    public class FCSVAdventureProgressAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAdventureProgress);
            }
        }
        ...
        public class Adapter : FCSVAdventureProgress, CrossBindingAdaptorType
        {

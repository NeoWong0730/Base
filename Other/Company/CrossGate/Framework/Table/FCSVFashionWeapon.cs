...
{
    public class FCSVFashionWeapon
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint WeaponName { get; private set; }
			public uint WeaponDescribe { get; private set; }
    ...
    public class FCSVFashionWeaponAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFashionWeapon);
            }
        }
        ...
        public class Adapter : FCSVFashionWeapon, CrossBindingAdaptorType
        {

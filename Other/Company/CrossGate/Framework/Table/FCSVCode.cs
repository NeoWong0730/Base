...
{
    public class FCSVCode
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint condition { get; private set; }
			public uint CodeOptions { get; private set; }
			public uint CodeDialogue { get; private set; }
			public uint CorrectCode { get; private set; }
			public uint CorrectDialogue { get; private set; }
			public byte CodeResults { get; private set; }
			public readonly List<uint> CodeResultsID;
			public uint WrongCode { get; private set; }
    ...
    public class FCSVCodeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCode);
            }
        }
        ...
        public class Adapter : FCSVCode, CrossBindingAdaptorType
        {

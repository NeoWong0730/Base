...
{
    public class FCSVArenaSegmentInformation
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Rank { get; private set; }
			public uint RankSubordinate { get; private set; }
			public uint RankInherit { get; private set; }
			public uint RankDisplay { get; private set; }
			public readonly string RankIcon;
			public uint RankIcon1 { get; private set; }
    ...
    public class FCSVArenaSegmentInformationAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVArenaSegmentInformation);
            }
        }
        ...
        public class Adapter : FCSVArenaSegmentInformation, CrossBindingAdaptorType
        {

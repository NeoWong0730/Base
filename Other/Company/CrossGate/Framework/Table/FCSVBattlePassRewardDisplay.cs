...
{
    public class FCSVBattlePassRewardDisplay
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Job_Id { get; private set; }
			public readonly List<string> Show_Item;
			public readonly List<uint> Hero_Id;
			public uint Fashionid { get; private set; }
			public uint Reward_Name { get; private set; }
			...
			public uint spin_speed { get; private set; }
			public uint spin_axle { get; private set; }
			public readonly List<uint> Ornaments_Id;
			public uint Weapon_Id { get; private set; }
			public uint equip_id { get; private set; }
    ...
    public class FCSVBattlePassRewardDisplayAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattlePassRewardDisplay);
            }
        }
        ...
        public class Adapter : FCSVBattlePassRewardDisplay, CrossBindingAdaptorType
        {

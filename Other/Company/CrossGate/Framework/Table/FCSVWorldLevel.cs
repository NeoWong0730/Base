...
{
    public class FCSVWorldLevel
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint world_level { get; private set; }
    ...
    public class FCSVWorldLevelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVWorldLevel);
            }
        }
        ...
        public class Adapter : FCSVWorldLevel, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVErrorCodeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVErrorCode);
            }
        }
        ...
        public class Adapter : FCSVErrorCode, CrossBindingAdaptorType
        {

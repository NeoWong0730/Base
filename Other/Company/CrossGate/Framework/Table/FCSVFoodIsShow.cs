...
namespace Framework.Table
{
    ...
    public class FCSVFoodIsShowAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFoodIsShow);
            }
        }
        ...
        public class Adapter : FCSVFoodIsShow, CrossBindingAdaptorType
        {

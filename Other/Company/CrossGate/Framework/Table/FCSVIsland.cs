...
{
    public class FCSVIsland
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public int island_type { get; private set; }
    ...
    public class FCSVIslandAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVIsland);
            }
        }
        ...
        public class Adapter : FCSVIsland, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    public class FCSVTeaching
    {
	    sealed public class Data
	    {
			...
			public uint detail { get; private set; }
    ...
    public class FCSVTeachingAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTeaching);
            }
        }
        ...
        public class Adapter : FCSVTeaching, CrossBindingAdaptorType
        {

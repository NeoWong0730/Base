...
namespace Framework.Table
{
    ...
    public class FCSVItemSourceAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVItemSource);
            }
        }
        ...
        public class Adapter : FCSVItemSource, CrossBindingAdaptorType
        {

...
{
    public class FCSVCluePhasedTasksGroup
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint PhasedTasksName { get; private set; }
			public uint PhasedTasksDes { get; private set; }
			public readonly List<uint> SubTask;
			public uint DisplayClueType { get; private set; }
			public uint DisplayCluePara { get; private set; }
			public uint TaskUnableReceiveTip { get; private set; }
    ...
    public class FCSVCluePhasedTasksGroupAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCluePhasedTasksGroup);
            }
        }
        ...
        public class Adapter : FCSVCluePhasedTasksGroup, CrossBindingAdaptorType
        {

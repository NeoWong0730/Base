...
{
    public class FCSVExploringSkill
    {
    ...
    public class FCSVExploringSkillAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVExploringSkill);
            }
        }
        ...
        public class Adapter : FCSVExploringSkill, CrossBindingAdaptorType
        {

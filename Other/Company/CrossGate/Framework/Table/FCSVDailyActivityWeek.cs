...
{
    public class FCSVDailyActivityWeek
    {
    ...
    public class FCSVDailyActivityWeekAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDailyActivityWeek);
            }
        }
        ...
        public class Adapter : FCSVDailyActivityWeek, CrossBindingAdaptorType
        {

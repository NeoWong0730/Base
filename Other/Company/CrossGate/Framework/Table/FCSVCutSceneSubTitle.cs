...
{
    public class FCSVCutSceneSubTitle
    {
    ...
    public class FCSVCutSceneSubTitleAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCutSceneSubTitle);
            }
        }
        ...
        public class Adapter : FCSVCutSceneSubTitle, CrossBindingAdaptorType
        {

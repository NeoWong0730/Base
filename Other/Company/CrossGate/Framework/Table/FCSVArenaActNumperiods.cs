...
{
    public class FCSVArenaActNumperiods
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public ulong OpenTime { get; private set; }
			public uint OpenDays { get; private set; }
    ...
    public class FCSVArenaActNumperiodsAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVArenaActNumperiods);
            }
        }
        ...
        public class Adapter : FCSVArenaActNumperiods, CrossBindingAdaptorType
        {

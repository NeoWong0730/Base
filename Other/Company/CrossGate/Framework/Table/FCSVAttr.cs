...
namespace Framework.Table
{
    public class FCSVAttr
    {
	    sealed public class Data
	    {
			...
			public uint BPValue { get; private set; }
			public uint isShow { get; private set; }
			public uint attr_type { get; private set; }
			public uint attr_icon { get; private set; }
			public uint show_type { get; private set; }
			public int add_type { get; private set; }
			public byte pet_show_type { get; private set; }
			public uint pet_show_sor { get; private set; }
			public uint attr_show { get; private set; }
			public uint order_list { get; private set; }
    ...
    public class FCSVAttrAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAttr);
            }
        }
        ...
        public class Adapter : FCSVAttr, CrossBindingAdaptorType
        {

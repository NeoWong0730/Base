...
{
    public class FCSVNpcFunctionData
    {
    ...
    public class FCSVNpcFunctionDataAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVNpcFunctionData);
            }
        }
        ...
        public class Adapter : FCSVNpcFunctionData, CrossBindingAdaptorType
        {

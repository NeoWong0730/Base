...
{
    public class FCSVLifeSkillLevel
    {
	    sealed public class Data
	    {
			...
			public uint collection_npc { get; private set; }
			public readonly List<uint> active_npc;
			public uint cost_vitality { get; private set; }
    ...
    public class FCSVLifeSkillLevelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVLifeSkillLevel);
            }
        }
        ...
        public class Adapter : FCSVLifeSkillLevel, CrossBindingAdaptorType
        {

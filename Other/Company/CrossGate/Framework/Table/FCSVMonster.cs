...
{
    public class FCSVMonster
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint monster_name { get; private set; }
			public uint monster_id { get; private set; }
			public uint monster_rank { get; private set; }
			public uint monster_behavior_rank { get; private set; }
			public uint genus { get; private set; }
			public uint level { get; private set; }
			public readonly List<uint> dynamic_level;
			public readonly List<List<uint>> template_attr;
			public uint is_dynamic { get; private set; }
			public uint attr_id { get; private set; }
			public uint body_part { get; private set; }
			public uint init_buff { get; private set; }
			public uint dead_behavior { get; private set; }
			public readonly string model;
			public uint weapon_id { get; private set; }
			public readonly List<uint> weapon_action_id;
			public uint ex_name { get; private set; }
			public uint unlock_pet { get; private set; }
			public uint template_id { get; private set; }
			public uint name_colour { get; private set; }
			public uint zooming { get; private set; }
			public uint approach_bubble { get; private set; }
			public uint die_bubble { get; private set; }
            ...
            public Data(uint id, BinaryReader binaryReader, TableShareData shareData)
            {
				...
				init_buff = ReadHelper.ReadUInt(binaryReader);
    ...
    public class FCSVMonsterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVMonster);
            }
        }
        ...
        public class Adapter : FCSVMonster, CrossBindingAdaptorType
        {

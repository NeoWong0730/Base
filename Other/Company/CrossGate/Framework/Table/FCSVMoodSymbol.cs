...
namespace Framework.Table
{
    ...
    public class FCSVMoodSymbolAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVMoodSymbol);
            }
        }
        ...
        public class Adapter : FCSVMoodSymbol, CrossBindingAdaptorType
        {

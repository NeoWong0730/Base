...
{
    public class FCSVFamilyPacketLimit
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Cumulative_Amount_Dowm { get; private set; }
			public uint Item_Id { get; private set; }
			public uint Item_Num { get; private set; }
			public uint Packet_Day_Quota { get; private set; }
			public uint Packet_Week_Quota { get; private set; }
    ...
    public class FCSVFamilyPacketLimitAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyPacketLimit);
            }
        }
        ...
        public class Adapter : FCSVFamilyPacketLimit, CrossBindingAdaptorType
        {

...
{
    public class FCSVActiveSkillEffective
    {
	    sealed public class Data
	    {
			...
			public uint min_magic_attack { get; private set; }
			public uint base_magic_attack { get; private set; }
			public uint wind_attribute { get; private set; }
			public uint earth_attribute { get; private set; }
			public uint water_attribute { get; private set; }
			public uint fire_attribute { get; private set; }
			public uint effect_type { get; private set; }
			public uint skill_effect_type { get; private set; }
			public uint damage_type { get; private set; }
			public uint effect_to_target { get; private set; }
			public uint effect_to_target2 { get; private set; }
			public uint fixed_damage { get; private set; }
    ...
    public class FCSVActiveSkillEffectiveAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVActiveSkillEffective);
            }
        }
        ...
        public class Adapter : FCSVActiveSkillEffective, CrossBindingAdaptorType
        {

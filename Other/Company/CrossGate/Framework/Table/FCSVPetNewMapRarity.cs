...
{
    public class FCSVPetNewMapRarity
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint BooksRarity { get; private set; }
			public uint type_pic { get; private set; }
    ...
    public class FCSVPetNewMapRarityAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewMapRarity);
            }
        }
        ...
        public class Adapter : FCSVPetNewMapRarity, CrossBindingAdaptorType
        {

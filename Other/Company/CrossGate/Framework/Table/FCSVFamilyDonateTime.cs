...
{
    public class FCSVFamilyDonateTime
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint GoldSingleCost { get; private set; }
			public uint DiamondsSingleCost { get; private set; }
    ...
    public class FCSVFamilyDonateTimeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyDonateTime);
            }
        }
        ...
        public class Adapter : FCSVFamilyDonateTime, CrossBindingAdaptorType
        {

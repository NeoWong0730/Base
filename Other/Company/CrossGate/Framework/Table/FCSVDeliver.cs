...
namespace Framework.Table
{
    ...
    public class FCSVDeliverAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDeliver);
            }
        }
        ...
        public class Adapter : FCSVDeliver, CrossBindingAdaptorType
        {

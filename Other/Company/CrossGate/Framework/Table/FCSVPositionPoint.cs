...
{
    public class FCSVPositionPoint
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint totol_point_number { get; private set; }
    ...
    public class FCSVPositionPointAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPositionPoint);
            }
        }
        ...
        public class Adapter : FCSVPositionPoint, CrossBindingAdaptorType
        {

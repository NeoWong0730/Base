...
{
    public class FCSVFamilyPetHealth
    {
	    sealed public class Data
	    {
			...
			public uint trainingTips { get; private set; }
			public readonly List<uint> Range;
			public uint addGrowthRatio { get; private set; }
    ...
    public class FCSVFamilyPetHealthAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyPetHealth);
            }
        }
        ...
        public class Adapter : FCSVFamilyPetHealth, CrossBindingAdaptorType
        {

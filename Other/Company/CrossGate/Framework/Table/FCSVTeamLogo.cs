...
{
    public class FCSVTeamLogo
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint TeamName { get; private set; }
			public uint TeamDescribe { get; private set; }
			public uint Lock { get; private set; }
			public uint LimitedTime { get; private set; }
			public uint TeamGetFor { get; private set; }
			public readonly List<uint> TeamParamFor;
			public uint TeamGetLimit { get; private set; }
			public readonly List<uint> TeamParamLimit;
			public uint TeamIcon { get; private set; }
			public uint FullTeamIcon { get; private set; }
			public uint Unlocktips { get; private set; }
    ...
    public class FCSVTeamLogoAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTeamLogo);
            }
        }
        ...
        public class Adapter : FCSVTeamLogo, CrossBindingAdaptorType
        {

...
{
    public class FCSVPetNewSeal
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint card { get; private set; }
			public uint seal_area_spe { get; private set; }
			public readonly List<uint> seal_quality;
			public uint seal_type { get; private set; }
			public uint map { get; private set; }
			public readonly List<int> coordinate_center;
			public readonly List<uint> center_range;
			public uint seal_range { get; private set; }
			public readonly List<int> coordinate;
			public uint AccInfo { get; private set; }
			public uint enemy_group { get; private set; }
			public uint seal_difficulty { get; private set; }
    ...
    public class FCSVPetNewSealAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewSeal);
            }
        }
        ...
        public class Adapter : FCSVPetNewSeal, CrossBindingAdaptorType
        {

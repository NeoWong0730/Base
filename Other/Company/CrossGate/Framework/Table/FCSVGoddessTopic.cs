...
{
    public class FCSVGoddessTopic
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint PlayType { get; private set; }
			public uint topicLan { get; private set; }
			public uint topicId { get; private set; }
			public uint topicDifficulty { get; private set; }
			...
			public uint teamTarget { get; private set; }
    ...
    public class FCSVGoddessTopicAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGoddessTopic);
            }
        }
        ...
        public class Adapter : FCSVGoddessTopic, CrossBindingAdaptorType
        {

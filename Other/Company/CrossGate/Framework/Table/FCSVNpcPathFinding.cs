...
{
    public class FCSVNpcPathFinding
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint RegionID { get; private set; }
			public uint FuncitonName { get; private set; }
    ...
    public class FCSVNpcPathFindingAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVNpcPathFinding);
            }
        }
        ...
        public class Adapter : FCSVNpcPathFinding, CrossBindingAdaptorType
        {

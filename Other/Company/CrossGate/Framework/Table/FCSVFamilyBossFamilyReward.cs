...
{
    public class FCSVFamilyBossFamilyReward
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Family_Rank { get; private set; }
    ...
    public class FCSVFamilyBossFamilyRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyBossFamilyReward);
            }
        }
        ...
        public class Adapter : FCSVFamilyBossFamilyReward, CrossBindingAdaptorType
        {

...
{
    public class FCSVChoseTargetLimit
    {
    ...
    public class FCSVChoseTargetLimitAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVChoseTargetLimit);
            }
        }
        ...
        public class Adapter : FCSVChoseTargetLimit, CrossBindingAdaptorType
        {

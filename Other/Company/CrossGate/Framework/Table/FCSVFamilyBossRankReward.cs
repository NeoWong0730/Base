...
{
    public class FCSVFamilyBossRankReward
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Activity_Group { get; private set; }
			public uint Presonal_Rank { get; private set; }
    ...
    public class FCSVFamilyBossRankRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyBossRankReward);
            }
        }
        ...
        public class Adapter : FCSVFamilyBossRankReward, CrossBindingAdaptorType
        {

...
{
    public class FCSVFunctionGroup
    {
	    sealed public class Data
	    {
			...
			public uint acquiesceDialogue { get; private set; }
    ...
    public class FCSVFunctionGroupAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFunctionGroup);
            }
        }
        ...
        public class Adapter : FCSVFunctionGroup, CrossBindingAdaptorType
        {

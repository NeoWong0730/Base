...
{
    public class FCSVGuideCondition
    {
    ...
    public class FCSVGuideConditionAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGuideCondition);
            }
        }
        ...
        public class Adapter : FCSVGuideCondition, CrossBindingAdaptorType
        {

...
{
    public class FCSVPetNewLoyaty
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint runaway { get; private set; }
			public uint noting { get; private set; }
			public uint attack { get; private set; }
			public uint defence { get; private set; }
			public uint keeping { get; private set; }
			public uint changeposition { get; private set; }
    ...
    public class FCSVPetNewLoyatyAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewLoyaty);
            }
        }
        ...
        public class Adapter : FCSVPetNewLoyaty, CrossBindingAdaptorType
        {

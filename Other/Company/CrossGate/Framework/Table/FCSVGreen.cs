...
namespace Framework.Table
{
    public class FCSVGreen
    {
	    sealed public class Data
	    {
			...
			public uint uint_array2 { get; private set; }
    ...
    public class FCSVGreenAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGreen);
            }
        }
        ...
        public class Adapter : FCSVGreen, CrossBindingAdaptorType
        {

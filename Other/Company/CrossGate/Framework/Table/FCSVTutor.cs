...
{
    public class FCSVTutor
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint TutorLevel { get; private set; }
			public uint TutorExp { get; private set; }
			public uint TutorLevelLan { get; private set; }
    ...
    public class FCSVTutorAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTutor);
            }
        }
        ...
        public class Adapter : FCSVTutor, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVRobotAttrAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVRobotAttr);
            }
        }
        ...
        public class Adapter : FCSVRobotAttr, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVStageRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVStageReward);
            }
        }
        ...
        public class Adapter : FCSVStageReward, CrossBindingAdaptorType
        {

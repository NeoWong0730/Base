...
namespace Framework.Table
{
    ...
    public class FCSVActionStateAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVActionState);
            }
        }
        ...
        public class Adapter : FCSVActionState, CrossBindingAdaptorType
        {

...
{
    public class FCSVChatframe
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint ChatName { get; private set; }
			public uint ChatDescribe { get; private set; }
			public uint Lock { get; private set; }
			public uint LimitedTime { get; private set; }
			public uint ChatGetFor { get; private set; }
			public readonly List<uint> ChatParamFor;
			public uint ChatGetLimit { get; private set; }
			public readonly List<uint> ChatParamLimit;
			public uint ChatIcon { get; private set; }
    ...
    public class FCSVChatframeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVChatframe);
            }
        }
        ...
        public class Adapter : FCSVChatframe, CrossBindingAdaptorType
        {

...
{
    public class FCSVFashionSuit
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint FashionId { get; private set; }
			public uint SuitName { get; private set; }
    ...
    public class FCSVFashionSuitAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFashionSuit);
            }
        }
        ...
        public class Adapter : FCSVFashionSuit, CrossBindingAdaptorType
        {

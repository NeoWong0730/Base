...
{
    public class FCSVAdventureCriminal
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint name { get; private set; }
			public uint isUrgent { get; private set; }
			public uint preTaskId { get; private set; }
			public uint preLevel { get; private set; }
			public uint simpleDes { get; private set; }
			public uint detailedDes { get; private set; }
			public uint acceptTaskId { get; private set; }
			public readonly List<uint> nodeTask;
			public uint finishTaskId { get; private set; }
    ...
    public class FCSVAdventureCriminalAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAdventureCriminal);
            }
        }
        ...
        public class Adapter : FCSVAdventureCriminal, CrossBindingAdaptorType
        {

...
{
    public class FCSVTravellerAwakening
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint NameId { get; private set; }
			public uint StepsId { get; private set; }
			...
			public uint ActTitle { get; private set; }
			public uint BuffID { get; private set; }
			public uint PassiveInfoID { get; private set; }
    ...
    public class FCSVTravellerAwakeningAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTravellerAwakening);
            }
        }
        ...
        public class Adapter : FCSVTravellerAwakening, CrossBindingAdaptorType
        {

...
{
    public class FCSVImprintLabel
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Label_Name { get; private set; }
    ...
    public class FCSVImprintLabelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVImprintLabel);
            }
        }
        ...
        public class Adapter : FCSVImprintLabel, CrossBindingAdaptorType
        {

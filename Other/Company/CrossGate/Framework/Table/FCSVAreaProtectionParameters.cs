...
{
    public class FCSVAreaProtectionParameters
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint rewardTimes { get; private set; }
			public uint minimumTeamSize { get; private set; }
			public uint countdown { get; private set; }
			public uint restartCountdown { get; private set; }
    ...
    public class FCSVAreaProtectionParametersAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAreaProtectionParameters);
            }
        }
        ...
        public class Adapter : FCSVAreaProtectionParameters, CrossBindingAdaptorType
        {

...
{
    public class FCSVFunctionOpen
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Condition_id { get; private set; }
			public uint functionClose { get; private set; }
			public uint Active_UI { get; private set; }
			public uint FunctionUiId { get; private set; }
			public uint FunctionSonId { get; private set; }
			public uint Active_Name { get; private set; }
			...
			public uint Icon_UI { get; private set; }
			public readonly string Icon_Path;
			public uint Effect_ActiveUIid { get; private set; }
    ...
    public class FCSVFunctionOpenAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFunctionOpen);
            }
        }
        ...
        public class Adapter : FCSVFunctionOpen, CrossBindingAdaptorType
        {

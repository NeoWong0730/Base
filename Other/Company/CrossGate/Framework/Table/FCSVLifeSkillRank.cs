...
{
    public class FCSVLifeSkillRank
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint desc_id { get; private set; }
			public uint level_max { get; private set; }
			public uint role_level { get; private set; }
    ...
    public class FCSVLifeSkillRankAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVLifeSkillRank);
            }
        }
        ...
        public class Adapter : FCSVLifeSkillRank, CrossBindingAdaptorType
        {

...
{
    public class FCSVArenaRandAward
    {
    ...
    public class FCSVArenaRandAwardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVArenaRandAward);
            }
        }
        ...
        public class Adapter : FCSVArenaRandAward, CrossBindingAdaptorType
        {

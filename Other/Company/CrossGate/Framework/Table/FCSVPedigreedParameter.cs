...
{
    public class FCSVPedigreedParameter
    {
    ...
    public class FCSVPedigreedParameterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPedigreedParameter);
            }
        }
        ...
        public class Adapter : FCSVPedigreedParameter, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVGuideModelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGuideModel);
            }
        }
        ...
        public class Adapter : FCSVGuideModel, CrossBindingAdaptorType
        {

...
{
    public class FCSVFamilyAuctionDrop
    {
    ...
    public class FCSVFamilyAuctionDropAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyAuctionDrop);
            }
        }
        ...
        public class Adapter : FCSVFamilyAuctionDrop, CrossBindingAdaptorType
        {

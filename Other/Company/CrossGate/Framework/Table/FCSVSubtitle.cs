...
{
    public class FCSVSubtitle
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly string picModel;
			public uint subtitleModel { get; private set; }
			public bool lens { get { return ReadHelper.GetBoolByIndex(boolArray0, 0); } }
			public readonly List<uint> content;
			public uint voiceModel { get; private set; }
			public uint musicModel { get; private set; }
			public uint wordNumber { get; private set; }
			public uint retainTime { get; private set; }
    ...
    public class FCSVSubtitleAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSubtitle);
            }
        }
        ...
        public class Adapter : FCSVSubtitle, CrossBindingAdaptorType
        {

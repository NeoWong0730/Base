...
{
    public class FCSVFamilyResBattleResult
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint FamilyReward { get; private set; }
			public uint PersonalReward { get; private set; }
    ...
    public class FCSVFamilyResBattleResultAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyResBattleResult);
            }
        }
        ...
        public class Adapter : FCSVFamilyResBattleResult, CrossBindingAdaptorType
        {

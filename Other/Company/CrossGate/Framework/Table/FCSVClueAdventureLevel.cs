...
{
    public class FCSVClueAdventureLevel
    {
    ...
    public class FCSVClueAdventureLevelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVClueAdventureLevel);
            }
        }
        ...
        public class Adapter : FCSVClueAdventureLevel, CrossBindingAdaptorType
        {

...
{
    public class FCSVSystemEffect
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly string FxPath;
			public int FxParticle { get; private set; }
			public int FxType { get; private set; }
    ...
    public class FCSVSystemEffectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSystemEffect);
            }
        }
        ...
        public class Adapter : FCSVSystemEffect, CrossBindingAdaptorType
        {

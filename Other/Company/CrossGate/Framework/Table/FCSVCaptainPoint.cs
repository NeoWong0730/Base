...
{
    public class FCSVCaptainPoint
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint BattleType { get; private set; }
			public uint Name { get; private set; }
			public uint Teambattle_type { get; private set; }
    ...
    public class FCSVCaptainPointAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCaptainPoint);
            }
        }
        ...
        public class Adapter : FCSVCaptainPoint, CrossBindingAdaptorType
        {

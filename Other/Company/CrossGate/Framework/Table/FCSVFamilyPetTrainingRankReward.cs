...
{
    public class FCSVFamilyPetTrainingRankReward
    {
    ...
    public class FCSVFamilyPetTrainingRankRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyPetTrainingRankReward);
            }
        }
        ...
        public class Adapter : FCSVFamilyPetTrainingRankReward, CrossBindingAdaptorType
        {

...
{
    public class FCSVFashionWeaponModel
    {
    ...
    public class FCSVFashionWeaponModelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFashionWeaponModel);
            }
        }
        ...
        public class Adapter : FCSVFashionWeaponModel, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    public class FCSVExchangeItem
    {
	    sealed public class Data
	    {
			...
			public uint Exchange_Item { get; private set; }
			public uint Limit_Type { get; private set; }
			public uint Limit_Max { get; private set; }
			public uint Quest_ActivityId { get; private set; }
			public uint DaliyQuset { get; private set; }
            ...
            public Data(uint id, BinaryReader binaryReader, TableShareData shareData)
            {
				...
				Quest_ActivityId = ReadHelper.ReadUInt(binaryReader);
				DaliyQuset = ReadHelper.ReadUInt(binaryReader);
    ...
    public class FCSVExchangeItemAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVExchangeItem);
            }
        }
        ...
        public class Adapter : FCSVExchangeItem, CrossBindingAdaptorType
        {

...
{
    public class FCSVLittleGame_OneTOuchDraw
    {
	    sealed public class Data
	    {
			...
			public uint ArrowId { get; private set; }
    ...
    public class FCSVLittleGame_OneTOuchDrawAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVLittleGame_OneTOuchDraw);
            }
        }
        ...
        public class Adapter : FCSVLittleGame_OneTOuchDraw, CrossBindingAdaptorType
        {

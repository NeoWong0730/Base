...
{
    public class FCSVFamilyDonate
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint DonationType { get; private set; }
			public uint DonationNum { get; private set; }
			public readonly List<uint> ItemAcquisition;
			public uint DonationReward { get; private set; }
			public uint IncreaseFamilyFunding { get; private set; }
    ...
    public class FCSVFamilyDonateAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyDonate);
            }
        }
        ...
        public class Adapter : FCSVFamilyDonate, CrossBindingAdaptorType
        {

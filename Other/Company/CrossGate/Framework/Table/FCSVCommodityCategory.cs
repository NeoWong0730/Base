...
{
    public class FCSVCommodityCategory
    {
	    sealed public class Data
	    {
			...
			public uint list { get; private set; }
    ...
    public class FCSVCommodityCategoryAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCommodityCategory);
            }
        }
        ...
        public class Adapter : FCSVCommodityCategory, CrossBindingAdaptorType
        {

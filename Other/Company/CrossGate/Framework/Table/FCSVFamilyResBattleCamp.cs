...
{
    public class FCSVFamilyResBattleCamp
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint submitNpcId { get; private set; }
    ...
    public class FCSVFamilyResBattleCampAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyResBattleCamp);
            }
        }
        ...
        public class Adapter : FCSVFamilyResBattleCamp, CrossBindingAdaptorType
        {

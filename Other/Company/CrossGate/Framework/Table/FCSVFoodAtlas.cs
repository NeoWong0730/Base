...
{
    public class FCSVFoodAtlas
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint access1 { get; private set; }
			public readonly List<List<uint>> parameter1;
			public uint desc1 { get; private set; }
			public uint access2 { get; private set; }
			public readonly List<List<uint>> parameter2;
			public uint desc2 { get; private set; }
			public uint access3 { get; private set; }
			public readonly List<List<uint>> parameter3;
			public uint desc3 { get; private set; }
    ...
    public class FCSVFoodAtlasAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFoodAtlas);
            }
        }
        ...
        public class Adapter : FCSVFoodAtlas, CrossBindingAdaptorType
        {

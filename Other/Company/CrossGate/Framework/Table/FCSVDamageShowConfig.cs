...
{
    public class FCSVDamageShowConfig
    {
    ...
    public class FCSVDamageShowConfigAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDamageShowConfig);
            }
        }
        ...
        public class Adapter : FCSVDamageShowConfig, CrossBindingAdaptorType
        {

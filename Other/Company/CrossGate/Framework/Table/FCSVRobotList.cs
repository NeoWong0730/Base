...
{
    public class FCSVRobotList
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<uint> name;
			public uint model_id { get; private set; }
    ...
    public class FCSVRobotListAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVRobotList);
            }
        }
        ...
        public class Adapter : FCSVRobotList, CrossBindingAdaptorType
        {

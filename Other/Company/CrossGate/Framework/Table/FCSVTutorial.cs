...
namespace Framework.Table
{
    ...
    public class FCSVTutorialAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTutorial);
            }
        }
        ...
        public class Adapter : FCSVTutorial, CrossBindingAdaptorType
        {

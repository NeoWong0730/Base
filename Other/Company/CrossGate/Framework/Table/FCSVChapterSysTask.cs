...
{
    public class FCSVChapterSysTask
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint TaskName { get; private set; }
			public uint TaskNameLag { get; private set; }
			public uint Chapter { get; private set; }
			public uint ChapterSys { get; private set; }
			public uint Type { get; private set; }
			public uint Reach { get; private set; }
			public uint GhidanceGroup { get; private set; }
			...
			public uint MainDisplay { get; private set; }
			public uint DropWatchId { get; private set; }
			public uint TryAgain { get; private set; }
    ...
    public class FCSVChapterSysTaskAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVChapterSysTask);
            }
        }
        ...
        public class Adapter : FCSVChapterSysTask, CrossBindingAdaptorType
        {

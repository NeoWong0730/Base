...
{
    public class FCSVDailyActivityPush
    {
	    sealed public class Data
	    {
			...
			public uint CycleShow { get; private set; }
			public uint TimeShow { get; private set; }
    ...
    public class FCSVDailyActivityPushAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDailyActivityPush);
            }
        }
        ...
        public class Adapter : FCSVDailyActivityPush, CrossBindingAdaptorType
        {

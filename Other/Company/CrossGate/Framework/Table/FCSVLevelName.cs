...
{
    public class FCSVLevelName
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint level_name { get; private set; }
    ...
    public class FCSVLevelNameAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVLevelName);
            }
        }
        ...
        public class Adapter : FCSVLevelName, CrossBindingAdaptorType
        {

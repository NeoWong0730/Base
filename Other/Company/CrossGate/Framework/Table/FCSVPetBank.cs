...
{
    public class FCSVPetBank
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<List<uint>> uarray2_value;
			public uint fund_type { get; private set; }
			public uint tab_name { get; private set; }
    ...
    public class FCSVPetBankAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetBank);
            }
        }
        ...
        public class Adapter : FCSVPetBank, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVBondEffectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBondEffect);
            }
        }
        ...
        public class Adapter : FCSVBondEffect, CrossBindingAdaptorType
        {

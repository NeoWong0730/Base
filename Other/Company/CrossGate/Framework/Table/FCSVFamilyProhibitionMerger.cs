...
{
    public class FCSVFamilyProhibitionMerger
    {
    ...
    public class FCSVFamilyProhibitionMergerAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyProhibitionMerger);
            }
        }
        ...
        public class Adapter : FCSVFamilyProhibitionMerger, CrossBindingAdaptorType
        {

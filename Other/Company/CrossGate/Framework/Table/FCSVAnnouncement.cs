...
namespace Framework.Table
{
    public class FCSVAnnouncement
    {
	    sealed public class Data
	    {
			...
			public uint LvShow { get; private set; }
			public uint MissionShow { get; private set; }
    ...
    public class FCSVAnnouncementAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAnnouncement);
            }
        }
        ...
        public class Adapter : FCSVAnnouncement, CrossBindingAdaptorType
        {

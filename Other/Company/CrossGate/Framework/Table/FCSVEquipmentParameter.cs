...
{
    public class FCSVEquipmentParameter
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint is_band { get; private set; }
			public uint lower_limit { get; private set; }
			public uint upper_limit { get; private set; }
    ...
    public class FCSVEquipmentParameterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVEquipmentParameter);
            }
        }
        ...
        public class Adapter : FCSVEquipmentParameter, CrossBindingAdaptorType
        {

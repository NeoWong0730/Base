...
{
    public class FCSVIconConfigure
    {
    ...
    public class FCSVIconConfigureAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVIconConfigure);
            }
        }
        ...
        public class Adapter : FCSVIconConfigure, CrossBindingAdaptorType
        {

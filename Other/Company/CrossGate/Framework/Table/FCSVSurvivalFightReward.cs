...
{
    public class FCSVSurvivalFightReward
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint PlayerLv { get; private set; }
			public uint BeforeWin { get; private set; }
			public uint BeforeFail { get; private set; }
			public uint AfterWin { get; private set; }
			public uint AfterFail { get; private set; }
    ...
    public class FCSVSurvivalFightRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSurvivalFightReward);
            }
        }
        ...
        public class Adapter : FCSVSurvivalFightReward, CrossBindingAdaptorType
        {

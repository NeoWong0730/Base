...
namespace Framework.Table
{
    public class FCSVCompose
    {
	    sealed public class Data
	    {
			...
			public uint maxBatchCompse { get; private set; }
			public uint SynthesisTab { get; private set; }
    ...
    public class FCSVComposeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCompose);
            }
        }
        ...
        public class Adapter : FCSVCompose, CrossBindingAdaptorType
        {

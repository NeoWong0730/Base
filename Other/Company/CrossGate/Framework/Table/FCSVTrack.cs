...
{
    public class FCSVTrack
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint cell { get; private set; }
    ...
    public class FCSVTrackAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTrack);
            }
        }
        ...
        public class Adapter : FCSVTrack, CrossBindingAdaptorType
        {

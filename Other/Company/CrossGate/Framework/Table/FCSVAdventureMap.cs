...
namespace Framework.Table
{
    public class FCSVAdventureMap
    {
	    sealed public class Data
	    {
			...
			public uint mapDes { get; private set; }
    ...
    public class FCSVAdventureMapAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAdventureMap);
            }
        }
        ...
        public class Adapter : FCSVAdventureMap, CrossBindingAdaptorType
        {

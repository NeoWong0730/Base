...
namespace Framework.Table
{
    ...
    public class FCSVRuneLvlIDAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVRuneLvlID);
            }
        }
        ...
        public class Adapter : FCSVRuneLvlID, CrossBindingAdaptorType
        {

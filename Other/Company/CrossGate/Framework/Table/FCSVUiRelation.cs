...
{
    public class FCSVUiRelation
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint UIID { get; private set; }
			public uint relationUiid { get; private set; }
    ...
    public class FCSVUiRelationAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVUiRelation);
            }
        }
        ...
        public class Adapter : FCSVUiRelation, CrossBindingAdaptorType
        {

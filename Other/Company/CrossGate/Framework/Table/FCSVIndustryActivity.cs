...
{
    public class FCSVIndustryActivity
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint industryIcon { get; private set; }
			public uint findNPC { get; private set; }
			public uint industryName { get; private set; }
			public uint playName { get; private set; }
			public uint playIntroduce { get; private set; }
    ...
    public class FCSVIndustryActivityAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVIndustryActivity);
            }
        }
        ...
        public class Adapter : FCSVIndustryActivity, CrossBindingAdaptorType
        {

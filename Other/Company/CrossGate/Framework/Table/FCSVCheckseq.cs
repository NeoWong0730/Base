...
namespace Framework.Table
{
    public class FCSVCheckseq
    {
	    sealed public class Data
	    {
			...
			public uint CondiNoPasarTips { get; private set; }
    ...
    public class FCSVCheckseqAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCheckseq);
            }
        }
        ...
        public class Adapter : FCSVCheckseq, CrossBindingAdaptorType
        {

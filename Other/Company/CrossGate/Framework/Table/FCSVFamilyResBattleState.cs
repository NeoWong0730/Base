...
{
    public class FCSVFamilyResBattleState
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint SrateText { get; private set; }
			public uint stageCDLanId { get; private set; }
    ...
    public class FCSVFamilyResBattleStateAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyResBattleState);
            }
        }
        ...
        public class Adapter : FCSVFamilyResBattleState, CrossBindingAdaptorType
        {

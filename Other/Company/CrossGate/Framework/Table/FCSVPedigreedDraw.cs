...
{
    public class FCSVPedigreedDraw
    {
	    sealed public class Data
	    {
			...
			public uint Special_Signs { get; private set; }
			public readonly List<uint> Reward_ID;
			public uint Show_Item { get; private set; }
    ...
    public class FCSVPedigreedDrawAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPedigreedDraw);
            }
        }
        ...
        public class Adapter : FCSVPedigreedDraw, CrossBindingAdaptorType
        {

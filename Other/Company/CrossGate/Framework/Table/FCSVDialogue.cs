...
{
    public class FCSVDialogue
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint whetherSkipDialogue { get; private set; }
			public uint whetherAutomaticDialogue { get; private set; }
			public uint whetherShowSymbol { get; private set; }
			public uint dialoguePerform { get; private set; }
			public uint DubbingId { get; private set; }
    ...
    public class FCSVDialogueAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDialogue);
            }
        }
        ...
        public class Adapter : FCSVDialogue, CrossBindingAdaptorType
        {

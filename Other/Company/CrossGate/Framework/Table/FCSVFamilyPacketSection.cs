...
{
    public class FCSVFamilyPacketSection
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Packet_Mix { get; private set; }
			public uint Packet_Max { get; private set; }
			public uint Packet_Part { get; private set; }
			public uint Packet_Extra_Part { get; private set; }
    ...
    public class FCSVFamilyPacketSectionAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyPacketSection);
            }
        }
        ...
        public class Adapter : FCSVFamilyPacketSection, CrossBindingAdaptorType
        {

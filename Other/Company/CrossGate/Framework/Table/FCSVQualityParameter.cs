...
{
    public class FCSVQualityParameter
    {
    ...
    public class FCSVQualityParameterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVQualityParameter);
            }
        }
        ...
        public class Adapter : FCSVQualityParameter, CrossBindingAdaptorType
        {

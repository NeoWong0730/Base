...
namespace Framework.Table
{
    ...
    public class FCSVSuitEffectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSuitEffect);
            }
        }
        ...
        public class Adapter : FCSVSuitEffect, CrossBindingAdaptorType
        {

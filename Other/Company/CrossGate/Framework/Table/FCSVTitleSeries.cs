...
{
    public class FCSVTitleSeries
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint seriesLan { get; private set; }
			public readonly List<List<uint>> seriesProperty;
			public int seriesPoint { get; private set; }
    ...
    public class FCSVTitleSeriesAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTitleSeries);
            }
        }
        ...
        public class Adapter : FCSVTitleSeries, CrossBindingAdaptorType
        {

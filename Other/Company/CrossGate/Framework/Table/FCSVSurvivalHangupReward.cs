...
{
    public class FCSVSurvivalHangupReward
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint PlayerLv { get; private set; }
			public uint HangUp { get; private set; }
    ...
    public class FCSVSurvivalHangupRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSurvivalHangupReward);
            }
        }
        ...
        public class Adapter : FCSVSurvivalHangupReward, CrossBindingAdaptorType
        {

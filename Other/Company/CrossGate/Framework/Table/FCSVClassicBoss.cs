...
{
    public class FCSVClassicBoss
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public byte UnlockType { get; private set; }
			public uint CriminalID { get; private set; }
			public uint TaskID { get; private set; }
			public byte TaskLv { get; private set; }
			...
			public uint PreviousInformation { get; private set; }
			public uint DropID { get; private set; }
			public uint Navigation { get; private set; }
    ...
    public class FCSVClassicBossAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVClassicBoss);
            }
        }
        ...
        public class Adapter : FCSVClassicBoss, CrossBindingAdaptorType
        {

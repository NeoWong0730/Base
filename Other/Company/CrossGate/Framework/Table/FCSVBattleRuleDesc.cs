...
{
    public class FCSVBattleRuleDesc
    {
    ...
    public class FCSVBattleRuleDescAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattleRuleDesc);
            }
        }
        ...
        public class Adapter : FCSVBattleRuleDesc, CrossBindingAdaptorType
        {

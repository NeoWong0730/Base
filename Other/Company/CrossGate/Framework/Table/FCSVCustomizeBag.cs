...
namespace Framework.Table
{
    ...
    public class FCSVCustomizeBagAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCustomizeBag);
            }
        }
        ...
        public class Adapter : FCSVCustomizeBag, CrossBindingAdaptorType
        {

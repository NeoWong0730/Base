...
{
    public class FCSVFamilyPetType
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint food_Type { get; private set; }
			public uint maxStage { get; private set; }
    ...
    public class FCSVFamilyPetTypeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyPetType);
            }
        }
        ...
        public class Adapter : FCSVFamilyPetType, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    public class FCSVGleanings
    {
	    sealed public class Data
	    {
			...
			public uint type2_id { get; private set; }
			public uint TypeName { get; private set; }
			public uint SubTypeName { get; private set; }
			...
			public uint deblock_condition { get; private set; }
    ...
    public class FCSVGleaningsAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGleanings);
            }
        }
        ...
        public class Adapter : FCSVGleanings, CrossBindingAdaptorType
        {

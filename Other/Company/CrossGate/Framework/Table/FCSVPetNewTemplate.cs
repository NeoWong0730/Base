...
{
    public class FCSVPetNewTemplate
    {
	    sealed public class Data
	    {
			...
			public byte default_point { get; private set; }
    ...
    public class FCSVPetNewTemplateAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewTemplate);
            }
        }
        ...
        public class Adapter : FCSVPetNewTemplate, CrossBindingAdaptorType
        {

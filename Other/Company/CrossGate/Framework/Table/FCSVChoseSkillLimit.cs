...
{
    public class FCSVChoseSkillLimit
    {
	    sealed public class Data
	    {
			...
			public uint ui_effect { get; private set; }
    ...
    public class FCSVChoseSkillLimitAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVChoseSkillLimit);
            }
        }
        ...
        public class Adapter : FCSVChoseSkillLimit, CrossBindingAdaptorType
        {

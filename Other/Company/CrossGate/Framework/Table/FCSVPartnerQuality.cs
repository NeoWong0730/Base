...
{
    public class FCSVPartnerQuality
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint portrait { get; private set; }
    ...
    public class FCSVPartnerQualityAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPartnerQuality);
            }
        }
        ...
        public class Adapter : FCSVPartnerQuality, CrossBindingAdaptorType
        {

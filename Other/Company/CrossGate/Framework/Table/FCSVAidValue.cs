...
namespace Framework.Table
{
    ...
    public class FCSVAidValueAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAidValue);
            }
        }
        ...
        public class Adapter : FCSVAidValue, CrossBindingAdaptorType
        {

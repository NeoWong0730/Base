...
{
    public class FCSVSubmitPetCondition
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint tips { get; private set; }
			public uint PetsID { get; private set; }
			public uint PetsGear { get; private set; }
			public uint PetsGearMore { get; private set; }
			public uint PetsLessenGear { get; private set; }
			public uint PetsLessenGearMore { get; private set; }
			public uint PetsArrest { get; private set; }
			public uint PetsArrestMore { get; private set; }
			public uint PetsScore { get; private set; }
    ...
    public class FCSVSubmitPetConditionAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSubmitPetCondition);
            }
        }
        ...
        public class Adapter : FCSVSubmitPetCondition, CrossBindingAdaptorType
        {

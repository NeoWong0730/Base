...
{
    public class FCSVAchievementType
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint MainClassTest { get; private set; }
			public uint MainClassIcon { get; private set; }
    ...
    public class FCSVAchievementTypeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAchievementType);
            }
        }
        ...
        public class Adapter : FCSVAchievementType, CrossBindingAdaptorType
        {

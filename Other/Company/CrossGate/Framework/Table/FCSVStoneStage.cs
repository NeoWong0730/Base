...
namespace Framework.Table
{
    public class FCSVStoneStage
    {
	    sealed public class Data
	    {
			...
			public uint icon_light { get; private set; }
			public uint desc_light { get; private set; }
			public uint icon_dark { get; private set; }
			public uint desc_dark { get; private set; }
    ...
    public class FCSVStoneStageAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVStoneStage);
            }
        }
        ...
        public class Adapter : FCSVStoneStage, CrossBindingAdaptorType
        {

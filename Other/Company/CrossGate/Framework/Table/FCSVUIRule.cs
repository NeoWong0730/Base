...
namespace Framework.Table
{
    ...
    public class FCSVUIRuleAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVUIRule);
            }
        }
        ...
        public class Adapter : FCSVUIRule, CrossBindingAdaptorType
        {

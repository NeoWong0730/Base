...
{
    public class FCSVJewelRecommend
    {
    ...
    public class FCSVJewelRecommendAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVJewelRecommend);
            }
        }
        ...
        public class Adapter : FCSVJewelRecommend, CrossBindingAdaptorType
        {

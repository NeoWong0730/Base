...
namespace Framework.Table
{
    ...
    public class FCSVTaskLanguageAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTaskLanguage);
            }
        }
        ...
        public class Adapter : FCSVTaskLanguage, CrossBindingAdaptorType
        {

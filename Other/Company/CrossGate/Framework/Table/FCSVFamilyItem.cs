...
{
    public class FCSVFamilyItem
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint industryType { get; private set; }
			public uint submission_drop { get; private set; }
			public uint consumeNum { get; private set; }
			public uint submissionMinLevel { get; private set; }
    ...
    public class FCSVFamilyItemAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyItem);
            }
        }
        ...
        public class Adapter : FCSVFamilyItem, CrossBindingAdaptorType
        {

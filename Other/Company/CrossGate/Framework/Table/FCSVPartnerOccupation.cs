...
{
    public class FCSVPartnerOccupation
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint list_occupation { get; private set; }
    ...
    public class FCSVPartnerOccupationAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPartnerOccupation);
            }
        }
        ...
        public class Adapter : FCSVPartnerOccupation, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVFashionScroeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFashionScroe);
            }
        }
        ...
        public class Adapter : FCSVFashionScroe, CrossBindingAdaptorType
        {

...
{
    public class FCSVBOOSFightPlayMode
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint playMode { get; private set; }
			public readonly List<uint> difficulty_id;
			public readonly List<uint> playModeLevelLimit;
			public uint dailyActivites { get; private set; }
			public uint rewardLimit { get; private set; }
			public uint rewardLimitDay { get; private set; }
			public uint teamPlayModeId { get; private set; }
			public uint headIcon_id { get; private set; }
			public Color32 themeColor { get; private set; }
    ...
    public class FCSVBOOSFightPlayModeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBOOSFightPlayMode);
            }
        }
        ...
        public class Adapter : FCSVBOOSFightPlayMode, CrossBindingAdaptorType
        {

...
{
    public class FCSVBackgroundStory
    {
	    sealed public class Data
	    {
			...
			public uint actication_reward { get; private set; }
    ...
    public class FCSVBackgroundStoryAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBackgroundStory);
            }
        }
        ...
        public class Adapter : FCSVBackgroundStory, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    public class FCSVexpRetrieve
    {
	    sealed public class Data
	    {
			...
			public uint Exp_Ratio { get; private set; }
    ...
    public class FCSVexpRetrieveAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVexpRetrieve);
            }
        }
        ...
        public class Adapter : FCSVexpRetrieve, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVRuneTypeIDAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVRuneTypeID);
            }
        }
        ...
        public class Adapter : FCSVRuneTypeID, CrossBindingAdaptorType
        {

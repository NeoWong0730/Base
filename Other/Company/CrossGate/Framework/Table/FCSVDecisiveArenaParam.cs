...
{
    public class FCSVDecisiveArenaParam
    {
    ...
    public class FCSVDecisiveArenaParamAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDecisiveArenaParam);
            }
        }
        ...
        public class Adapter : FCSVDecisiveArenaParam, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    public class FCSVTemporary
    {
	    sealed public class Data
	    {
			...
			public uint up { get; private set; }
			public uint time { get; private set; }
			public uint type { get; private set; }
			public uint lev { get; private set; }
			public uint equip_lev { get; private set; }
    ...
    public class FCSVTemporaryAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTemporary);
            }
        }
        ...
        public class Adapter : FCSVTemporary, CrossBindingAdaptorType
        {

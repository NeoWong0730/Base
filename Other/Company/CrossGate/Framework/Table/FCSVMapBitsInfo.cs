...
{
    public class FCSVMapBitsInfo
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint mapBits { get; private set; }
    ...
    public class FCSVMapBitsInfoAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVMapBitsInfo);
            }
        }
        ...
        public class Adapter : FCSVMapBitsInfo, CrossBindingAdaptorType
        {

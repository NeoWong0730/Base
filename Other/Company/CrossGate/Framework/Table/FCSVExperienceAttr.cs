...
{
    public class FCSVExperienceAttr
    {
	    sealed public class Data
	    {
			...
			public uint add_value { get; private set; }
			public uint max_level { get; private set; }
			public uint double_cost_level { get; private set; }
    ...
    public class FCSVExperienceAttrAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVExperienceAttr);
            }
        }
        ...
        public class Adapter : FCSVExperienceAttr, CrossBindingAdaptorType
        {

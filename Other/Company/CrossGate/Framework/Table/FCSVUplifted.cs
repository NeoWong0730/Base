...
namespace Framework.Table
{
    ...
    public class FCSVUpliftedAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVUplifted);
            }
        }
        ...
        public class Adapter : FCSVUplifted, CrossBindingAdaptorType
        {

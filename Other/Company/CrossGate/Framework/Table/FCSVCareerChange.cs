...
{
    public class FCSVCareerChange
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint money { get; private set; }
			public uint reward_Id { get; private set; }
			public uint money_see { get; private set; }
    ...
    public class FCSVCareerChangeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCareerChange);
            }
        }
        ...
        public class Adapter : FCSVCareerChange, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVItemFunAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVItemFun);
            }
        }
        ...
        public class Adapter : FCSVItemFun, CrossBindingAdaptorType
        {

...
{
    public class FCSVConditionalGift
    {
    ...
    public class FCSVConditionalGiftAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVConditionalGift);
            }
        }
        ...
        public class Adapter : FCSVConditionalGift, CrossBindingAdaptorType
        {

...
{
    public class FCSVFormulaSelect
    {
	    sealed public class Data
	    {
			...
			public uint id_formula { get; private set; }
    ...
    public class FCSVFormulaSelectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFormulaSelect);
            }
        }
        ...
        public class Adapter : FCSVFormulaSelect, CrossBindingAdaptorType
        {

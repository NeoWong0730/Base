...
{
    public class FCSVTipsLvl
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint lvl { get; private set; }
			public uint lan_id { get; private set; }
    ...
    public class FCSVTipsLvlAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTipsLvl);
            }
        }
        ...
        public class Adapter : FCSVTipsLvl, CrossBindingAdaptorType
        {

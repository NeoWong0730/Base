...
{
    public class FCSVDialogueLanguage
    {
    ...
    public class FCSVDialogueLanguageAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDialogueLanguage);
            }
        }
        ...
        public class Adapter : FCSVDialogueLanguage, CrossBindingAdaptorType
        {

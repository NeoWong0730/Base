...
{
    public class FCSVChatWord
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint WordName { get; private set; }
			public uint WordDescribe { get; private set; }
			public uint Lock { get; private set; }
			public uint LimitedTime { get; private set; }
			public uint WordGetFor { get; private set; }
			public readonly List<uint> WordParamFor;
			public uint WordGetLimit { get; private set; }
			public readonly List<uint> WordParamLimit;
			public uint WordIcon { get; private set; }
    ...
    public class FCSVChatWordAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVChatWord);
            }
        }
        ...
        public class Adapter : FCSVChatWord, CrossBindingAdaptorType
        {

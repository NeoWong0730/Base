...
{
    public class FCSVBattlePassTask
    {
    ...
    public class FCSVBattlePassTaskAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattlePassTask);
            }
        }
        ...
        public class Adapter : FCSVBattlePassTask, CrossBindingAdaptorType
        {

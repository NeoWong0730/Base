...
{
    public class FCSVArenaMaxStars
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint RankSubordinateNum { get; private set; }
			public uint MaxStar { get; private set; }
    ...
    public class FCSVArenaMaxStarsAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVArenaMaxStars);
            }
        }
        ...
        public class Adapter : FCSVArenaMaxStars, CrossBindingAdaptorType
        {

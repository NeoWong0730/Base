...
{
    public class FCSVAreaProtection
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly string name;
			public uint eventName_id { get; private set; }
			public uint eventDescription_id { get; private set; }
			public uint entrustDescription_id { get; private set; }
			public uint dialogue_id { get; private set; }
			public readonly List<uint> task_id_array;
			public readonly List<uint> drop_id_array;
			public readonly List<List<uint>> openTime;
			public uint eventLv { get; private set; }
			public uint map_id { get; private set; }
			...
			public uint eventName_direction { get; private set; }
    ...
    public class FCSVAreaProtectionAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAreaProtection);
            }
        }
        ...
        public class Adapter : FCSVAreaProtection, CrossBindingAdaptorType
        {

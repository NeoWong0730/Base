...
{
    public class FCSVDynamicAttribute
    {
    ...
    public class FCSVDynamicAttributeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDynamicAttribute);
            }
        }
        ...
        public class Adapter : FCSVDynamicAttribute, CrossBindingAdaptorType
        {

...
{
    public class FCSVResolving
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint weight { get; private set; }
			public uint min_weight { get; private set; }
    ...
    public class FCSVResolvingAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVResolving);
            }
        }
        ...
        public class Adapter : FCSVResolving, CrossBindingAdaptorType
        {

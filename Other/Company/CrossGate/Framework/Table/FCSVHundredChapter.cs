...
{
    public class FCSVHundredChapter
    {
    ...
    public class FCSVHundredChapterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVHundredChapter);
            }
        }
        ...
        public class Adapter : FCSVHundredChapter, CrossBindingAdaptorType
        {

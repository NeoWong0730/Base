...
{
    public class FCSVNubber
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint url_resources { get; private set; }
			public uint para_id { get; private set; }
			public uint proportion { get; private set; }
			public readonly List<int> model_position;
			public uint auto_use { get; private set; }
    ...
    public class FCSVNubberAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVNubber);
            }
        }
        ...
        public class Adapter : FCSVNubber, CrossBindingAdaptorType
        {

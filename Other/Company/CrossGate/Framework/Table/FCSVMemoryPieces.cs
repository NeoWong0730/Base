...
{
    public class FCSVMemoryPieces
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly string icon;
			public uint title_name { get; private set; }
			public uint memory_name { get; private set; }
			public readonly string show_image;
			public uint memory_text { get; private set; }
    ...
    public class FCSVMemoryPiecesAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVMemoryPieces);
            }
        }
        ...
        public class Adapter : FCSVMemoryPieces, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVPetReleaseAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetRelease);
            }
        }
        ...
        public class Adapter : FCSVPetRelease, CrossBindingAdaptorType
        {

...
{
    public class FCSVTaskCategory
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint name { get; private set; }
			public uint simpleName { get; private set; }
			public bool WhetherTips { get { return ReadHelper.GetBoolByIndex(boolArray0, 0); } }
			public uint taskTypeTips { get; private set; }
			public readonly List<uint> taskTypeTipsColour;
			public uint typeImage { get; private set; }
			public uint wordStyle { get; private set; }
			public int priority { get; private set; }
			public uint traceLimit { get; private set; }
			public uint funcOpenId { get; private set; }
			public uint iconId { get; private set; }
			public uint lightIconId { get; private set; }
			...
			public uint TaskButtonType { get; private set; }
    ...
    public class FCSVTaskCategoryAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTaskCategory);
            }
        }
        ...
        public class Adapter : FCSVTaskCategory, CrossBindingAdaptorType
        {

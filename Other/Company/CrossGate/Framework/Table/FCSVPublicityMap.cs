...
namespace Framework.Table
{
    ...
    public class FCSVPublicityMapAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPublicityMap);
            }
        }
        ...
        public class Adapter : FCSVPublicityMap, CrossBindingAdaptorType
        {

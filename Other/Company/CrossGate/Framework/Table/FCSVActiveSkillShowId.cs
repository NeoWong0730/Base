...
{
    public class FCSVActiveSkillShowId
    {
	    sealed public class Data
	    {
			...
			public uint hit_to_fly { get; private set; }
			public uint is_dead { get; private set; }
    ...
    public class FCSVActiveSkillShowIdAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVActiveSkillShowId);
            }
        }
        ...
        public class Adapter : FCSVActiveSkillShowId, CrossBindingAdaptorType
        {

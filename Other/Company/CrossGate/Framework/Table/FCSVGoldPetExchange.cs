...
{
    public class FCSVGoldPetExchange
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Pet_id { get; private set; }
    ...
    public class FCSVGoldPetExchangeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGoldPetExchange);
            }
        }
        ...
        public class Adapter : FCSVGoldPetExchange, CrossBindingAdaptorType
        {

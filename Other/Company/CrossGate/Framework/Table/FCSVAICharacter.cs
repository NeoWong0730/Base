...
namespace Framework.Table
{
    public class FCSVAICharacter
    {
	    sealed public class Data
	    {
			...
			public uint disLan { get; private set; }
    ...
    public class FCSVAICharacterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAICharacter);
            }
        }
        ...
        public class Adapter : FCSVAICharacter, CrossBindingAdaptorType
        {

...
{
    public class FCSVBattleScene
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public int battle_scene_pointx { get; private set; }
			public int battle_scene_pointy { get; private set; }
			public int battle_scene_pointz { get; private set; }
			public int pith { get; private set; }
			...
			public int x_offset { get; private set; }
			public int y_offset { get; private set; }
			public int z_offset { get; private set; }
    ...
    public class FCSVBattleSceneAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattleScene);
            }
        }
        ...
        public class Adapter : FCSVBattleScene, CrossBindingAdaptorType
        {

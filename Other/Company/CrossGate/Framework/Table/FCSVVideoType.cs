...
namespace Framework.Table
{
    ...
    public class FCSVVideoTypeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVVideoType);
            }
        }
        ...
        public class Adapter : FCSVVideoType, CrossBindingAdaptorType
        {

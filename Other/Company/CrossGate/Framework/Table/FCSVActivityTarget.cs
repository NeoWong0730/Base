...
{
    public class FCSVActivityTarget
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Activityid { get; private set; }
			public uint RankType { get; private set; }
			...
			public uint Langid { get; private set; }
			public uint Tel_type { get; private set; }
			public readonly List<uint> Skip_Id;
			public uint ActivityType { get; private set; }
			public uint Dropid { get; private set; }
			public uint Points { get; private set; }
			public uint Functionid { get; private set; }
			public uint FamilyIn { get; private set; }
    ...
    public class FCSVActivityTargetAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVActivityTarget);
            }
        }
        ...
        public class Adapter : FCSVActivityTarget, CrossBindingAdaptorType
        {

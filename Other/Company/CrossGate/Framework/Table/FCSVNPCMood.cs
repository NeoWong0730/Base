...
namespace Framework.Table
{
    ...
    public class FCSVNPCMoodAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVNPCMood);
            }
        }
        ...
        public class Adapter : FCSVNPCMood, CrossBindingAdaptorType
        {

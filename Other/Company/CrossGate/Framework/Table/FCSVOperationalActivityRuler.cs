...
{
    public class FCSVOperationalActivityRuler
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Activity_Name { get; private set; }
			public uint Activity_Type { get; private set; }
			public uint Activity_Switch { get; private set; }
			public uint Product_Type { get; private set; }
			public uint Begining_Date { get; private set; }
			public uint Duration_Day { get; private set; }
			public uint Open_Bottom { get; private set; }
			public uint RollingShow_Id { get; private set; }
			public uint Rolling_Time { get; private set; }
			public uint RollingLoop_Time { get; private set; }
            ...
            public Data(uint id, BinaryReader binaryReader, TableShareData shareData)
            {
				...
				Server_Switch = shareData.GetShareData<List<uint>>(binaryReader, 0);
    ...
    public class FCSVOperationalActivityRulerAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVOperationalActivityRuler);
            }
        }
        ...
        public class Adapter : FCSVOperationalActivityRuler, CrossBindingAdaptorType
        {

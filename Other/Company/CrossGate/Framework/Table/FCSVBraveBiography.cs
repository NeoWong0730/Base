...
{
    public class FCSVBraveBiography
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint biography_name { get; private set; }
			public uint biography_text { get; private set; }
    ...
    public class FCSVBraveBiographyAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBraveBiography);
            }
        }
        ...
        public class Adapter : FCSVBraveBiography, CrossBindingAdaptorType
        {

...
{
    public class FCSVCharacterWeapon
    {
    ...
    public class FCSVCharacterWeaponAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCharacterWeapon);
            }
        }
        ...
        public class Adapter : FCSVCharacterWeapon, CrossBindingAdaptorType
        {

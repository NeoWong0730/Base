...
{
    public class FCSVPetNewSkillSort
    {
	    sealed public class Data
	    {
			...
			public uint sort_type { get; private set; }
    ...
    public class FCSVPetNewSkillSortAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewSkillSort);
            }
        }
        ...
        public class Adapter : FCSVPetNewSkillSort, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVRanklistsortAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVRanklistsort);
            }
        }
        ...
        public class Adapter : FCSVRanklistsort, CrossBindingAdaptorType
        {

...
{
    public class FCSVBattlePassPurchase
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Title_Des { get; private set; }
			public uint Activation_Des { get; private set; }
			public uint Icon_ID { get; private set; }
			public uint Drop_Reward { get; private set; }
			public uint Price { get; private set; }
			public uint Extra_Level { get; private set; }
    ...
    public class FCSVBattlePassPurchaseAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattlePassPurchase);
            }
        }
        ...
        public class Adapter : FCSVBattlePassPurchase, CrossBindingAdaptorType
        {

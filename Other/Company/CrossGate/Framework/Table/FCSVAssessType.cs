...
{
    public class FCSVAssessType
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint langid { get; private set; }
			public uint RankPic { get; private set; }
			public uint Sort { get; private set; }
			public uint Reward_int { get; private set; }
    ...
    public class FCSVAssessTypeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAssessType);
            }
        }
        ...
        public class Adapter : FCSVAssessType, CrossBindingAdaptorType
        {

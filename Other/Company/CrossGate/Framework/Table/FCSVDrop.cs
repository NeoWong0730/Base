...
namespace Framework.Table
{
    public class FCSVDrop
    {
	    sealed public class Data
	    {
			...
			public uint equip_para { get; private set; }
    ...
    public class FCSVDropAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDrop);
            }
        }
        ...
        public class Adapter : FCSVDrop, CrossBindingAdaptorType
        {

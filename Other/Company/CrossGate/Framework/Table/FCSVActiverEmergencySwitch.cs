...
{
    public class FCSVActiverEmergencySwitch
    {
    ...
    public class FCSVActiverEmergencySwitchAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVActiverEmergencySwitch);
            }
        }
        ...
        public class Adapter : FCSVActiverEmergencySwitch, CrossBindingAdaptorType
        {

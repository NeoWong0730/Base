...
namespace Framework.Table
{
    ...
    public class FCSVDeviceAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDevice);
            }
        }
        ...
        public class Adapter : FCSVDevice, CrossBindingAdaptorType
        {

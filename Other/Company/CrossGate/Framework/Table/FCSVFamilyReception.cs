...
{
    public class FCSVFamilyReception
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint familyCastleLv { get; private set; }
			public uint receptionStar { get; private set; }
			public uint receptionValue { get; private set; }
			public uint level1Food { get; private set; }
			public uint level2Food { get; private set; }
			public uint level3Food { get; private set; }
			public uint foodTotal { get; private set; }
			public uint level1monster { get; private set; }
			public uint level2monster { get; private set; }
			public uint level3monster { get; private set; }
			public uint monsterTotal { get; private set; }
    ...
    public class FCSVFamilyReceptionAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyReception);
            }
        }
        ...
        public class Adapter : FCSVFamilyReception, CrossBindingAdaptorType
        {

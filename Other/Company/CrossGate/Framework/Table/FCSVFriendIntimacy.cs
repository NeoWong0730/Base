...
{
    public class FCSVFriendIntimacy
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint IntimacyLvlLan { get; private set; }
			public uint IntimacyLvl { get; private set; }
			public uint IntimacyNeed { get; private set; }
			public uint PresentLimited1 { get; private set; }
			public uint PresentLimited2 { get; private set; }
			public uint PresentLimited3 { get; private set; }
			public uint RoleViewLevel { get; private set; }
    ...
    public class FCSVFriendIntimacyAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFriendIntimacy);
            }
        }
        ...
        public class Adapter : FCSVFriendIntimacy, CrossBindingAdaptorType
        {

...
{
    public class FCSVAdventureLevel
    {
    ...
    public class FCSVAdventureLevelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAdventureLevel);
            }
        }
        ...
        public class Adapter : FCSVAdventureLevel, CrossBindingAdaptorType
        {

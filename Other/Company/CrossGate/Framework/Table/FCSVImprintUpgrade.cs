...
{
    public class FCSVImprintUpgrade
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Node_ID { get; private set; }
			...
			public uint Consume_Coin { get; private set; }
    ...
    public class FCSVImprintUpgradeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVImprintUpgrade);
            }
        }
        ...
        public class Adapter : FCSVImprintUpgrade, CrossBindingAdaptorType
        {

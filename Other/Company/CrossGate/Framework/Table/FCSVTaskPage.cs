...
namespace Framework.Table
{
    public class FCSVTaskPage
    {
	    sealed public class Data
	    {
			...
			public uint unlockTip { get; private set; }
    ...
    public class FCSVTaskPageAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTaskPage);
            }
        }
        ...
        public class Adapter : FCSVTaskPage, CrossBindingAdaptorType
        {

...
{
    public class FCSVGenus
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<uint> damageRate;
			public uint damageRate1 { get; private set; }
			public uint damageRate2 { get; private set; }
			public uint damageRate3 { get; private set; }
			public uint damageRate4 { get; private set; }
			public uint damageRate5 { get; private set; }
			public uint damageRate6 { get; private set; }
			public uint damageRate7 { get; private set; }
			public uint damageRate8 { get; private set; }
			public uint damageRate9 { get; private set; }
			public uint damageRate10 { get; private set; }
			public uint rale_icon { get; private set; }
			public uint rale_name { get; private set; }
    ...
    public class FCSVGenusAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGenus);
            }
        }
        ...
        public class Adapter : FCSVGenus, CrossBindingAdaptorType
        {

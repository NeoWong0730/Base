...
namespace Framework.Table
{
    ...
    public class FCSVWeatherTimeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVWeatherTime);
            }
        }
        ...
        public class Adapter : FCSVWeatherTime, CrossBindingAdaptorType
        {

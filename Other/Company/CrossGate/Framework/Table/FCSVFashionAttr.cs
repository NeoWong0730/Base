...
namespace Framework.Table
{
    ...
    public class FCSVFashionAttrAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFashionAttr);
            }
        }
        ...
        public class Adapter : FCSVFashionAttr, CrossBindingAdaptorType
        {

...
{
    public class FCSVRanklistset
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Rankid { get; private set; }
    ...
    public class FCSVRanklistsetAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVRanklistset);
            }
        }
        ...
        public class Adapter : FCSVRanklistset, CrossBindingAdaptorType
        {

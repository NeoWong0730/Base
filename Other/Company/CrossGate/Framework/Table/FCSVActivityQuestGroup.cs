...
{
    public class FCSVActivityQuestGroup
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Activity_Id { get; private set; }
			public uint Quest_Info { get; private set; }
			public uint QuestType { get; private set; }
    ...
    public class FCSVActivityQuestGroupAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVActivityQuestGroup);
            }
        }
        ...
        public class Adapter : FCSVActivityQuestGroup, CrossBindingAdaptorType
        {

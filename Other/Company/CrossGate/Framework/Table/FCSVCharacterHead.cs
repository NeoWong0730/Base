...
{
    public class FCSVCharacterHead
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint IconId_Li { get; private set; }
    ...
    public class FCSVCharacterHeadAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCharacterHead);
            }
        }
        ...
        public class Adapter : FCSVCharacterHead, CrossBindingAdaptorType
        {

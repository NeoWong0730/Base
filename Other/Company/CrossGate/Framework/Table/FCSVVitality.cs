...
namespace Framework.Table
{
    ...
    public class FCSVVitalityAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVVitality);
            }
        }
        ...
        public class Adapter : FCSVVitality, CrossBindingAdaptorType
        {

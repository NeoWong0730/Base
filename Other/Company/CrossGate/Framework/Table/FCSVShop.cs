...
{
    public class FCSVShop
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint show_num { get; private set; }
			public uint random_show { get; private set; }
			public uint price_type { get; private set; }
			public readonly List<List<uint>> refresh_time;
			public readonly List<uint> show_currency;
			public uint tab_icon { get; private set; }
			public readonly List<uint> refresh_random;
			public uint npc_name { get; private set; }
			public uint npc_id { get; private set; }
    ...
    public class FCSVShopAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVShop);
            }
        }
        ...
        public class Adapter : FCSVShop, CrossBindingAdaptorType
        {

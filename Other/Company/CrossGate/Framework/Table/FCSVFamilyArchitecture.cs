...
{
    public class FCSVFamilyArchitecture
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Architecture { get; private set; }
			public uint BuildLevel { get; private set; }
			public uint MaxLevel { get; private set; }
			public uint InitialLevel { get; private set; }
			public readonly List<uint> FrontBuilding;
			public uint DemandLevel { get; private set; }
			public uint demandProsperityLevel { get; private set; }
			public uint BuildLag { get; private set; }
			public uint FundsRequired { get; private set; }
			public uint MaintenanceCost { get; private set; }
			public uint RefundOfFees { get; private set; }
			public uint UpgradeTime { get; private set; }
			public uint Name { get; private set; }
			public uint Introduce { get; private set; }
    ...
    public class FCSVFamilyArchitectureAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyArchitecture);
            }
        }
        ...
        public class Adapter : FCSVFamilyArchitecture, CrossBindingAdaptorType
        {

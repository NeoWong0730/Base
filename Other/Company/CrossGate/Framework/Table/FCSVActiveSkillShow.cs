...
{
    public class FCSVActiveSkillShow
    {
	    sealed public class Data
	    {
			...
			public uint repeat_interval { get; private set; }
    ...
    public class FCSVActiveSkillShowAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVActiveSkillShow);
            }
        }
        ...
        public class Adapter : FCSVActiveSkillShow, CrossBindingAdaptorType
        {

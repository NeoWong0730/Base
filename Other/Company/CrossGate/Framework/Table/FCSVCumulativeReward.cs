...
{
    public class FCSVCumulativeReward
    {
    ...
    public class FCSVCumulativeRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCumulativeReward);
            }
        }
        ...
        public class Adapter : FCSVCumulativeReward, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVWelfareTypeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVWelfareType);
            }
        }
        ...
        public class Adapter : FCSVWelfareType, CrossBindingAdaptorType
        {

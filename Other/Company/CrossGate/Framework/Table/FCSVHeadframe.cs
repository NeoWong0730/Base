...
{
    public class FCSVHeadframe
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint HeadframeName { get; private set; }
			public uint HeadframeDescribe { get; private set; }
			public uint Lock { get; private set; }
			public uint LimitedTime { get; private set; }
			public uint HeadframeGetFor { get; private set; }
			public readonly List<uint> HeadframeParamFor;
			public uint HeadframeGetLimit { get; private set; }
			public readonly List<uint> HeadframeParamLimit;
			public uint HeadframeIcon { get; private set; }
    ...
    public class FCSVHeadframeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVHeadframe);
            }
        }
        ...
        public class Adapter : FCSVHeadframe, CrossBindingAdaptorType
        {

...
{
    public class FCSVBOSSInformation
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint BOSS_level { get; private set; }
			public readonly List<uint> limit_level;
			public uint minimumTeamSize { get; private set; }
			...
			public uint location_description { get; private set; }
			public uint AI_description { get; private set; }
			public uint biographyKey_drop { get; private set; }
			public uint challengeMode_id { get; private set; }
			public uint playMode_id { get; private set; }
			public uint bossManual_id { get; private set; }
			public uint targetNPC { get; private set; }
			public uint bossRankSubType { get; private set; }
    ...
    public class FCSVBOSSInformationAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBOSSInformation);
            }
        }
        ...
        public class Adapter : FCSVBOSSInformation, CrossBindingAdaptorType
        {

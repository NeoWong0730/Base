...
{
    public class FCSVTutorialFirstHeading
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint firstHeadingName { get; private set; }
			public uint firstHeadingSrot { get; private set; }
    ...
    public class FCSVTutorialFirstHeadingAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTutorialFirstHeading);
            }
        }
        ...
        public class Adapter : FCSVTutorialFirstHeading, CrossBindingAdaptorType
        {

...
{
    public class FCSVImprintNode
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Label_Id { get; private set; }
			public uint Imprint_Name { get; private set; }
			public uint Node_Type { get; private set; }
			public readonly List<uint> Coordinate;
			public uint Farme { get; private set; }
			public uint Farme_Text { get; private set; }
			public readonly List<uint> Front_Node;
			public uint Level_Cap { get; private set; }
			public uint Node_Icon { get; private set; }
    ...
    public class FCSVImprintNodeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVImprintNode);
            }
        }
        ...
        public class Adapter : FCSVImprintNode, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVHangupParamAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVHangupParam);
            }
        }
        ...
        public class Adapter : FCSVHangupParam, CrossBindingAdaptorType
        {

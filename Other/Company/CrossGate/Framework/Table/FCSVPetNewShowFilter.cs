...
{
    public class FCSVPetNewShowFilter
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint pet_list { get; private set; }
			public uint list_pic { get; private set; }
			public uint map_sequence { get; private set; }
    ...
    public class FCSVPetNewShowFilterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewShowFilter);
            }
        }
        ...
        public class Adapter : FCSVPetNewShowFilter, CrossBindingAdaptorType
        {

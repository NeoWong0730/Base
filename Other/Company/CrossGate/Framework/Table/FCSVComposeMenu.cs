...
namespace Framework.Table
{
    ...
    public class FCSVComposeMenuAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVComposeMenu);
            }
        }
        ...
        public class Adapter : FCSVComposeMenu, CrossBindingAdaptorType
        {

...
{
    public class FCSVFamilyResBattleCombatParameter
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint BattleWinScore { get; private set; }
			public uint BattleFailScore { get; private set; }
    ...
    public class FCSVFamilyResBattleCombatParameterAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyResBattleCombatParameter);
            }
        }
        ...
        public class Adapter : FCSVFamilyResBattleCombatParameter, CrossBindingAdaptorType
        {

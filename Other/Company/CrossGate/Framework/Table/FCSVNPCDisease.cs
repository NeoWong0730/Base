...
namespace Framework.Table
{
    ...
    public class FCSVNPCDiseaseAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVNPCDisease);
            }
        }
        ...
        public class Adapter : FCSVNPCDisease, CrossBindingAdaptorType
        {

...
{
    public class FCSVOperatereward
    {
	    sealed public class Data
	    {
			...
			public uint titleTips { get; private set; }
    ...
    public class FCSVOperaterewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVOperatereward);
            }
        }
        ...
        public class Adapter : FCSVOperatereward, CrossBindingAdaptorType
        {

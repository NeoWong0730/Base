...
{
    public class FCSVOneCoinLottey
    {
	    sealed public class Data
	    {
			...
			public uint LuckyMail_Id { get; private set; }
			public uint ReturnMail_Id { get; private set; }
			public uint ErrorCode_Id { get; private set; }
    ...
    public class FCSVOneCoinLotteyAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVOneCoinLottey);
            }
        }
        ...
        public class Adapter : FCSVOneCoinLottey, CrossBindingAdaptorType
        {

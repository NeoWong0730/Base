...
namespace Framework.Table
{
    public class FCSVCutScene
    {
	    sealed public class Data
	    {
			...
			public byte dayNight { get; private set; }
			public byte forEnter { get; private set; }
			public byte forExit { get; private set; }
			public ushort fadeoutTime { get; private set; }
    ...
    public class FCSVCutSceneAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCutScene);
            }
        }
        ...
        public class Adapter : FCSVCutScene, CrossBindingAdaptorType
        {

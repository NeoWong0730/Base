...
namespace Framework.Table
{
    ...
    public class FCSVFavorabilityGiftAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFavorabilityGift);
            }
        }
        ...
        public class Adapter : FCSVFavorabilityGift, CrossBindingAdaptorType
        {

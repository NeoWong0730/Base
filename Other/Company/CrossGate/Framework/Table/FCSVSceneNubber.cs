...
{
    public class FCSVSceneNubber
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<int> zozeId;
			public uint minimumMove { get; private set; }
			...
			public uint skipTime { get; private set; }
			public uint returnTime { get; private set; }
    ...
    public class FCSVSceneNubberAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSceneNubber);
            }
        }
        ...
        public class Adapter : FCSVSceneNubber, CrossBindingAdaptorType
        {

...
{
    public class FCSVSurvivalRankReward
    {
	    sealed public class Data
	    {
			...
			public uint DropView { get; private set; }
			public uint Rewardshow { get; private set; }
    ...
    public class FCSVSurvivalRankRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSurvivalRankReward);
            }
        }
        ...
        public class Adapter : FCSVSurvivalRankReward, CrossBindingAdaptorType
        {

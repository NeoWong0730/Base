...
{
    public class FCSVHead
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint HeadName { get; private set; }
			public uint HeadDescribe { get; private set; }
			public uint Lock { get; private set; }
			public uint LimitedTime { get; private set; }
			public uint HeadGetFor { get; private set; }
			public readonly List<uint> HeadParamFor;
			public uint HeadGetLimit { get; private set; }
    ...
    public class FCSVHeadAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVHead);
            }
        }
        ...
        public class Adapter : FCSVHead, CrossBindingAdaptorType
        {

...
{
    public class FCSVTaskGoal
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint TaskID { get; private set; }
			public uint PathfindingType { get; private set; }
			public uint PathfindingMap { get; private set; }
			public uint PathfindingTargetID { get; private set; }
			public uint GenerateFunctionType { get; private set; }
			public uint FunctionParameter { get; private set; }
			public uint TitleText { get; private set; }
			public uint FunctionFrontDialogue { get; private set; }
			public uint FunctionFrontAnimation { get; private set; }
			public uint TargetType { get; private set; }
			public uint TargetParameter1 { get; private set; }
			public uint TargetParameter2 { get; private set; }
			public uint TargetParameter3 { get; private set; }
			public uint TargetParameter4 { get; private set; }
			public uint TargetParameter5 { get; private set; }
			public uint TargetParameter6 { get; private set; }
			public uint TargetParameter7 { get; private set; }
			...
			public uint TaskOpenUiId { get; private set; }
			public readonly List<List<uint>> TaskOpenGuideId;
			public uint WayfindingTips { get; private set; }
			public readonly List<uint> EscortNpc;
			public uint MoveSpeed { get; private set; }
			public readonly List<List<uint>> EscortNpcLocation;
			public uint EscortNpcOrientations { get; private set; }
			public uint EscortNpcTriggerDis { get; private set; }
			public readonly List<List<uint>> EscortLocation;
			public uint EscortTips { get; private set; }
			public uint EscortStartTips { get; private set; }
			public uint EscortCompleteTips { get; private set; }
			public readonly List<uint> TracingNpc;
			public uint TracingMoveSpeed { get; private set; }
			public readonly List<List<uint>> TracingNpcLocation;
			public uint TracingNpcOrientations { get; private set; }
			public uint TracingNpcTriggerDis { get; private set; }
			public readonly List<List<uint>> TracingLocation;
			public uint TracingTips { get; private set; }
			public uint TracingAlertScope { get; private set; }
			public uint TracingAlertTime { get; private set; }
			public uint TracingPunishWay { get; private set; }
			public uint PunishNpcMoveSpeed { get; private set; }
			public readonly string PunishNpcMoveAction;
			public uint TracingFailDistance { get; private set; }
			public uint FailDistanceTime { get; private set; }
			public uint PunishFight { get; private set; }
			public uint TracingStartTips { get; private set; }
			public uint TracingCompleteTips { get; private set; }
			public uint TracingFailTips { get; private set; }
			public readonly List<uint> FollowNpc;
			public uint FollowMoveSpeed { get; private set; }
			public readonly List<List<uint>> FollowNpcLocation;
			public uint FollowNpcOrientations { get; private set; }
			...
			public uint FollowNpcTargetScope { get; private set; }
			public uint FollowTips { get; private set; }
			public uint FollowStartTips { get; private set; }
			public uint FollowCompleteTips { get; private set; }
			public uint TaskFrontPerform { get; private set; }
			public uint TaskAfterPerform { get; private set; }
			public uint LimitTime { get; private set; }
			public uint LimitOpenNpc { get; private set; }
			public uint LimitOpenType { get; private set; }
			public uint LimitOpenChoose { get; private set; }
			public uint LimitOpenText { get; private set; }
			public uint FunctionOpenList { get; private set; }
    ...
    public class FCSVTaskGoalAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTaskGoal);
            }
        }
        ...
        public class Adapter : FCSVTaskGoal, CrossBindingAdaptorType
        {

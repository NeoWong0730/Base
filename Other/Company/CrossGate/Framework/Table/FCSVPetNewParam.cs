...
namespace Framework.Table
{
    ...
    public class FCSVPetNewParamAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewParam);
            }
        }
        ...
        public class Adapter : FCSVPetNewParam, CrossBindingAdaptorType
        {

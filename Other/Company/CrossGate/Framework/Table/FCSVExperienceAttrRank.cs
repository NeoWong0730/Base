...
{
    public class FCSVExperienceAttrRank
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint need_point { get; private set; }
    ...
    public class FCSVExperienceAttrRankAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVExperienceAttrRank);
            }
        }
        ...
        public class Adapter : FCSVExperienceAttrRank, CrossBindingAdaptorType
        {

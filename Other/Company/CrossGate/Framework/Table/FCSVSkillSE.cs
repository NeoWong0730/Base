...
namespace Framework.Table
{
    ...
    public class FCSVSkillSEAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSkillSE);
            }
        }
        ...
        public class Adapter : FCSVSkillSE, CrossBindingAdaptorType
        {

...
{
    public class FCSVInstance
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Type { get; private set; }
			public uint TeamUp { get; private set; }
			public uint Name { get; private set; }
			public uint PlayType { get; private set; }
			public uint pre_instance { get; private set; }
			public readonly List<uint> lv;
			public uint limite_number { get; private set; }
			public readonly List<List<uint>> Ticket;
			public uint FirstReward { get; private set; }
			public uint Des { get; private set; }
			public uint PreviousDes { get; private set; }
			public uint FirstPassReward { get; private set; }
			public readonly string bg;
			public uint DeductionLayers { get; private set; }
			public uint AutoVote { get; private set; }
			public int RecommondPoint { get; private set; }
    ...
    public class FCSVInstanceAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVInstance);
            }
        }
        ...
        public class Adapter : FCSVInstance, CrossBindingAdaptorType
        {

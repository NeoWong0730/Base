...
namespace Framework.Table
{
    ...
    public class FCSVSigninRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSigninReward);
            }
        }
        ...
        public class Adapter : FCSVSigninReward, CrossBindingAdaptorType
        {

...
{
    public class FCSVPetNewReBuild
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint need_pet_lv { get; private set; }
			public uint remake_hint { get; private set; }
			public uint gold_remake_hint { get; private set; }
			public uint max_skill { get; private set; }
			public uint present_max_skill { get; private set; }
			public readonly List<List<uint>> reset_cost;
			public uint skill_success_rate { get; private set; }
			...
			public ushort max_luck { get; private set; }
			public ushort remake_value { get; private set; }
			public uint remake_lan { get; private set; }
    ...
    public class FCSVPetNewReBuildAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewReBuild);
            }
        }
        ...
        public class Adapter : FCSVPetNewReBuild, CrossBindingAdaptorType
        {

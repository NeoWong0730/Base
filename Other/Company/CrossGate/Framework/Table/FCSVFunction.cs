...
{
    public class FCSVFunction
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly string functionName;
			public uint functionIcon { get; private set; }
			public uint topType { get; private set; }
			public uint priority { get; private set; }
			public uint TitleColour { get; private set; }
    ...
    public class FCSVFunctionAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFunction);
            }
        }
        ...
        public class Adapter : FCSVFunction, CrossBindingAdaptorType
        {

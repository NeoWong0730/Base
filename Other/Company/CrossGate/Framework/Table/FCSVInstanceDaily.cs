...
{
    public class FCSVInstanceDaily
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint InstanceId { get; private set; }
			public uint LayerStage { get; private set; }
			public uint Layerlevel { get; private set; }
			public uint Award { get; private set; }
			public uint RandomAward { get; private set; }
			public uint Name { get; private set; }
			public uint Describe { get; private set; }
			public uint icon { get; private set; }
			public byte ChangeUI { get; private set; }
			public uint LevelLimited { get; private set; }
			public uint Awakeningid { get; private set; }
    ...
    public class FCSVInstanceDailyAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVInstanceDaily);
            }
        }
        ...
        public class Adapter : FCSVInstanceDaily, CrossBindingAdaptorType
        {

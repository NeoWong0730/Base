...
{
    public class FCSVPromoteCareer
    {
	    sealed public class Data
	    {
			...
			public uint isFull { get; private set; }
			public readonly List<uint> skillLimit;
			public int pvePoint { get; private set; }
			public int pvpAddPoint { get; private set; }
			public readonly List<uint> battleLevel;
			public uint head { get; private set; }
			public uint professionLan { get; private set; }
			...
			public int propertyPoint { get; private set; }
			public uint levelLimit { get; private set; }
			public uint advanceNpc { get; private set; }
			public uint advanceDia { get; private set; }
    ...
    public class FCSVPromoteCareerAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPromoteCareer);
            }
        }
        ...
        public class Adapter : FCSVPromoteCareer, CrossBindingAdaptorType
        {

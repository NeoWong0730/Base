...
{
    public class FCSVGrowthFund
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Charge_Id { get; private set; }
    ...
    public class FCSVGrowthFundAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGrowthFund);
            }
        }
        ...
        public class Adapter : FCSVGrowthFund, CrossBindingAdaptorType
        {

...
{
    public class FCSVInteractivePerform
    {
    ...
    public class FCSVInteractivePerformAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVInteractivePerform);
            }
        }
        ...
        public class Adapter : FCSVInteractivePerform, CrossBindingAdaptorType
        {

...
{
    public class FCSVTips
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<uint> random_content;
			public uint random_time { get; private set; }
    ...
    public class FCSVTipsAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTips);
            }
        }
        ...
        public class Adapter : FCSVTips, CrossBindingAdaptorType
        {

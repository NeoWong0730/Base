...
namespace Framework.Table
{
    ...
    public class FCSVPromptBoxAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPromptBox);
            }
        }
        ...
        public class Adapter : FCSVPromptBox, CrossBindingAdaptorType
        {

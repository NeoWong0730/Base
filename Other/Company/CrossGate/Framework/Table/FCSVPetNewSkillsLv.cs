...
{
    public class FCSVPetNewSkillsLv
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint exp { get; private set; }
			public uint total_exp { get; private set; }
			public uint pet_level { get; private set; }
    ...
    public class FCSVPetNewSkillsLvAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewSkillsLv);
            }
        }
        ...
        public class Adapter : FCSVPetNewSkillsLv, CrossBindingAdaptorType
        {

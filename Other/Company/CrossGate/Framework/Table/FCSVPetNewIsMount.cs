...
{
    public class FCSVPetNewIsMount
    {
    ...
    public class FCSVPetNewIsMountAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewIsMount);
            }
        }
        ...
        public class Adapter : FCSVPetNewIsMount, CrossBindingAdaptorType
        {

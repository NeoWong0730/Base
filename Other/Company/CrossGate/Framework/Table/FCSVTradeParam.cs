...
namespace Framework.Table
{
    ...
    public class FCSVTradeParamAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTradeParam);
            }
        }
        ...
        public class Adapter : FCSVTradeParam, CrossBindingAdaptorType
        {

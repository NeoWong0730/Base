...
{
    public class FCSVArenaCumlativeRewards
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<List<uint>> CumulativeWin;
			public uint SeasonDefaultRward { get; private set; }
    ...
    public class FCSVArenaCumlativeRewardsAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVArenaCumlativeRewards);
            }
        }
        ...
        public class Adapter : FCSVArenaCumlativeRewards, CrossBindingAdaptorType
        {

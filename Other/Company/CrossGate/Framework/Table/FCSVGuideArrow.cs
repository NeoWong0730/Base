...
{
    public class FCSVGuideArrow
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public float arrow_time { get; private set; }
    ...
    public class FCSVGuideArrowAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGuideArrow);
            }
        }
        ...
        public class Adapter : FCSVGuideArrow, CrossBindingAdaptorType
        {

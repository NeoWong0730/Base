...
namespace Framework.Table
{
    public class FCSVFashionModel
    {
	    sealed public class Data
	    {
			...
			public uint show_label { get; private set; }
			public readonly string model;
			public uint ui_show_workID { get; private set; }
    ...
    public class FCSVFashionModelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFashionModel);
            }
        }
        ...
        public class Adapter : FCSVFashionModel, CrossBindingAdaptorType
        {

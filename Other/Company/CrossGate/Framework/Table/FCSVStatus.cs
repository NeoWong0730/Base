...
{
    public class FCSVStatus
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint clientcontrol { get; private set; }
			public uint durationtime { get; private set; }
    ...
    public class FCSVStatusAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVStatus);
            }
        }
        ...
        public class Adapter : FCSVStatus, CrossBindingAdaptorType
        {

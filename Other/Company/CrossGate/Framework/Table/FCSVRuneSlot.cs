...
{
    public class FCSVRuneSlot
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint slot_category { get; private set; }
			public uint slot_type { get; private set; }
			public uint slot_level { get; private set; }
			public uint slot_unlocklevel { get; private set; }
			public uint slot_sequence { get; private set; }
			public uint slot_unlocknum { get; private set; }
    ...
    public class FCSVRuneSlotAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVRuneSlot);
            }
        }
        ...
        public class Adapter : FCSVRuneSlot, CrossBindingAdaptorType
        {

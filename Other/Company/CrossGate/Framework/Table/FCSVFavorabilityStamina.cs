...
{
    public class FCSVFavorabilityStamina
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint FavorabilityStamina { get; private set; }
			public uint MaxFavorabilityStamina { get; private set; }
    ...
    public class FCSVFavorabilityStaminaAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFavorabilityStamina);
            }
        }
        ...
        public class Adapter : FCSVFavorabilityStamina, CrossBindingAdaptorType
        {

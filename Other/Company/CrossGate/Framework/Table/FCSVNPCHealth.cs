...
namespace Framework.Table
{
    ...
    public class FCSVNPCHealthAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVNPCHealth);
            }
        }
        ...
        public class Adapter : FCSVNPCHealth, CrossBindingAdaptorType
        {

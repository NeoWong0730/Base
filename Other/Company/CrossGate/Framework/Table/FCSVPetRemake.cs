...
{
    public class FCSVPetRemake
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint remake_num { get; private set; }
			public uint item_id { get; private set; }
			public uint success_rate { get; private set; }
			public ushort add_luck { get; private set; }
			public byte add_attr_rate { get; private set; }
    ...
    public class FCSVPetRemakeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetRemake);
            }
        }
        ...
        public class Adapter : FCSVPetRemake, CrossBindingAdaptorType
        {

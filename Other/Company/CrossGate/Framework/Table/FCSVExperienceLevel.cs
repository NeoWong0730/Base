...
{
    public class FCSVExperienceLevel
    {
	    sealed public class Data
	    {
			...
			public uint need_technology { get; private set; }
    ...
    public class FCSVExperienceLevelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVExperienceLevel);
            }
        }
        ...
        public class Adapter : FCSVExperienceLevel, CrossBindingAdaptorType
        {

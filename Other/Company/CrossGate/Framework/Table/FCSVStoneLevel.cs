...
{
    public class FCSVStoneLevel
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint stone_id { get; private set; }
			public uint stone_level { get; private set; }
			public uint sum_stage { get; private set; }
			public uint exp_stone { get; private set; }
			public uint exp_stone_add { get; private set; }
			public readonly List<uint> cost_money;
			public uint activeskill { get; private set; }
			public uint passiveskill { get; private set; }
			public uint decompose { get; private set; }
    ...
    public class FCSVStoneLevelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVStoneLevel);
            }
        }
        ...
        public class Adapter : FCSVStoneLevel, CrossBindingAdaptorType
        {

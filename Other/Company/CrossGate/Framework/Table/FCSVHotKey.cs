...
{
    public class FCSVHotKey
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint language_id { get; private set; }
    ...
    public class FCSVHotKeyAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVHotKey);
            }
        }
        ...
        public class Adapter : FCSVHotKey, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVLevelGiftAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVLevelGift);
            }
        }
        ...
        public class Adapter : FCSVLevelGift, CrossBindingAdaptorType
        {

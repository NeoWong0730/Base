...
{
    public class FCSVActiveSkillBehavior
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint role_id { get; private set; }
    ...
    public class FCSVActiveSkillBehaviorAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVActiveSkillBehavior);
            }
        }
        ...
        public class Adapter : FCSVActiveSkillBehavior, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVJewelAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVJewel);
            }
        }
        ...
        public class Adapter : FCSVJewel, CrossBindingAdaptorType
        {

...
{
    public class FCSVTeam
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint seq_id { get; private set; }
			public uint play_name { get; private set; }
			public uint play_type { get; private set; }
			public uint subclass_name { get; private set; }
			public uint FunctionOpenId { get; private set; }
			public uint subclass { get; private set; }
			public uint module { get; private set; }
			public uint OpeningLevel { get; private set; }
			public uint HideLevel { get; private set; }
			public uint lv_min { get; private set; }
			public uint lv_max { get; private set; }
			public uint play_desc { get; private set; }
			public uint jump_id { get; private set; }
			public uint is_come { get; private set; }
			public uint is_show { get; private set; }
			public uint is_captain { get; private set; }
    ...
    public class FCSVTeamAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTeam);
            }
        }
        ...
        public class Adapter : FCSVTeam, CrossBindingAdaptorType
        {

...
{
    public class FCSVFamilyArchitectureEffect
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint HouseLevel { get; private set; }
			public uint UnlockLimit { get; private set; }
			public readonly List<uint> UnlockSkillId;
			public uint CapitalCeiling { get; private set; }
			public uint DividendCap { get; private set; }
			public uint SignInReward { get; private set; }
			public uint DailyDonationLimit { get; private set; }
			public readonly List<uint> RewardCollectionTrigger;
			public readonly List<uint> DailyReward;
			public uint BulidIcon { get; private set; }
			public uint BulidName { get; private set; }
			public uint CurrentEffectDescription { get; private set; }
			public uint NextEffectDescription { get; private set; }
    ...
    public class FCSVFamilyArchitectureEffectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyArchitectureEffect);
            }
        }
        ...
        public class Adapter : FCSVFamilyArchitectureEffect, CrossBindingAdaptorType
        {

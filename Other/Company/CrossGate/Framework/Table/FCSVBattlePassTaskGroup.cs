...
{
    public class FCSVBattlePassTaskGroup
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Task_Des { get; private set; }
    ...
    public class FCSVBattlePassTaskGroupAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattlePassTaskGroup);
            }
        }
        ...
        public class Adapter : FCSVBattlePassTaskGroup, CrossBindingAdaptorType
        {

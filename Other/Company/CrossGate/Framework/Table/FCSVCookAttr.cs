...
namespace Framework.Table
{
    ...
    public class FCSVCookAttrAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCookAttr);
            }
        }
        ...
        public class Adapter : FCSVCookAttr, CrossBindingAdaptorType
        {

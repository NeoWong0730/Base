...
{
    public class FCSVMall
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint mall_name { get; private set; }
			public readonly List<uint> shop_id;
			public readonly List<uint> tab_name;
			public int args_num { get; private set; }
    ...
    public class FCSVMallAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVMall);
            }
        }
        ...
        public class Adapter : FCSVMall, CrossBindingAdaptorType
        {

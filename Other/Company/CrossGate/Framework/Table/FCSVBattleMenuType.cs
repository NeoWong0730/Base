...
{
    public class FCSVBattleMenuType
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint lanId { get; private set; }
    ...
    public class FCSVBattleMenuTypeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBattleMenuType);
            }
        }
        ...
        public class Adapter : FCSVBattleMenuType, CrossBindingAdaptorType
        {

...
{
    public class FCSVFavorabilityStageName
    {
    ...
    public class FCSVFavorabilityStageNameAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFavorabilityStageName);
            }
        }
        ...
        public class Adapter : FCSVFavorabilityStageName, CrossBindingAdaptorType
        {

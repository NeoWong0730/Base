...
{
    public class FCSVNewBiographySeries
    {
    ...
    public class FCSVNewBiographySeriesAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVNewBiographySeries);
            }
        }
        ...
        public class Adapter : FCSVNewBiographySeries, CrossBindingAdaptorType
        {

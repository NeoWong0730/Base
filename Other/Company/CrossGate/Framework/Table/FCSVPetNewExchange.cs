...
{
    public class FCSVPetNewExchange
    {
    ...
    public class FCSVPetNewExchangeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewExchange);
            }
        }
        ...
        public class Adapter : FCSVPetNewExchange, CrossBindingAdaptorType
        {

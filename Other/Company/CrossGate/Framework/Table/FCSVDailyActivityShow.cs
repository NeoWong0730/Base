...
{
    public class FCSVDailyActivityShow
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint ActiveTypeName { get; private set; }
			public uint Activeicon { get; private set; }
			public uint Customize { get; private set; }
    ...
    public class FCSVDailyActivityShowAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVDailyActivityShow);
            }
        }
        ...
        public class Adapter : FCSVDailyActivityShow, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    public class FCSVWordStyle
    {
	    sealed public class Data
	    {
			...
			public byte FontStyle { get; private set; }
			public byte FontSize { get; private set; }
			public float Linespacing { get; private set; }
			public Color32 Shadow { get; private set; }
			public sbyte ShadowX { get; private set; }
			public sbyte ShadowY { get; private set; }
			public Color32 Outline { get; private set; }
			public sbyte OutlineX { get; private set; }
			public sbyte OutlineY { get; private set; }
			public byte GradientColorDir { get; private set; }
			public byte GradientColorMode { get; private set; }
    ...
    public class FCSVWordStyleAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVWordStyle);
            }
        }
        ...
        public class Adapter : FCSVWordStyle, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    public class FCSVBrave
    {
	    sealed public class Data
	    {
			...
			public uint Ideal { get; private set; }
			public uint Height { get; private set; }
			public uint Weight { get; private set; }
			public uint Character { get; private set; }
			public uint Hobby { get; private set; }
    ...
    public class FCSVBraveAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBrave);
            }
        }
        ...
        public class Adapter : FCSVBrave, CrossBindingAdaptorType
        {

...
{
    public class FCSVBubble
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint BubbleTime { get; private set; }
			public uint BubbleText { get; private set; }
			public uint BubbleTextInterval { get; private set; }
			public uint BubbleSounds { get; private set; }
			public uint BubbleDelay { get; private set; }
			public uint BubblePriority { get; private set; }
			public uint BubbleType { get; private set; }
			public readonly List<int> offset;
			public uint Type { get; private set; }
			public uint MoodId { get; private set; }
			public uint PeopleType { get; private set; }
			public uint CharacterHead { get; private set; }
			public uint NPCHead { get; private set; }
    ...
    public class FCSVBubbleAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVBubble);
            }
        }
        ...
        public class Adapter : FCSVBubble, CrossBindingAdaptorType
        {

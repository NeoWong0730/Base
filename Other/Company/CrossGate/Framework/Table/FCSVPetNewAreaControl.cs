...
{
    public class FCSVPetNewAreaControl
    {
    ...
    public class FCSVPetNewAreaControlAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewAreaControl);
            }
        }
        ...
        public class Adapter : FCSVPetNewAreaControl, CrossBindingAdaptorType
        {

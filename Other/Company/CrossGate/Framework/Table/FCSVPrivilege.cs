...
namespace Framework.Table
{
    ...
    public class FCSVPrivilegeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPrivilege);
            }
        }
        ...
        public class Adapter : FCSVPrivilege, CrossBindingAdaptorType
        {

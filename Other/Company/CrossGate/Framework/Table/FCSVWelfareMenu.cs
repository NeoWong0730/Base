...
namespace Framework.Table
{
    ...
    public class FCSVWelfareMenuAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVWelfareMenu);
            }
        }
        ...
        public class Adapter : FCSVWelfareMenu, CrossBindingAdaptorType
        {

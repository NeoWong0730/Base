...
namespace Framework.Table
{
    ...
    public class FCSVRanklistmainAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVRanklistmain);
            }
        }
        ...
        public class Adapter : FCSVRanklistmain, CrossBindingAdaptorType
        {

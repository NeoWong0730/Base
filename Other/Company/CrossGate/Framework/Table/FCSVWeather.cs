...
namespace Framework.Table
{
    ...
    public class FCSVWeatherAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVWeather);
            }
        }
        ...
        public class Adapter : FCSVWeather, CrossBindingAdaptorType
        {

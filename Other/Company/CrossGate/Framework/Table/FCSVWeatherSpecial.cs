...
{
    public class FCSVWeatherSpecial
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<uint> time;
			public uint last_time { get; private set; }
    ...
    public class FCSVWeatherSpecialAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVWeatherSpecial);
            }
        }
        ...
        public class Adapter : FCSVWeatherSpecial, CrossBindingAdaptorType
        {

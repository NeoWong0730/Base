...
{
    public class FCSVCookBookReward
    {
    ...
    public class FCSVCookBookRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCookBookReward);
            }
        }
        ...
        public class Adapter : FCSVCookBookReward, CrossBindingAdaptorType
        {

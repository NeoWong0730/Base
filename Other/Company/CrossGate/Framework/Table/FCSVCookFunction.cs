...
namespace Framework.Table
{
    ...
    public class FCSVCookFunctionAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCookFunction);
            }
        }
        ...
        public class Adapter : FCSVCookFunction, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVMoneyShowAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVMoneyShow);
            }
        }
        ...
        public class Adapter : FCSVMoneyShow, CrossBindingAdaptorType
        {

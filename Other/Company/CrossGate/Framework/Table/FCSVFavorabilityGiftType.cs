...
{
    public class FCSVFavorabilityGiftType
    {
    ...
    public class FCSVFavorabilityGiftTypeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFavorabilityGiftType);
            }
        }
        ...
        public class Adapter : FCSVFavorabilityGiftType, CrossBindingAdaptorType
        {

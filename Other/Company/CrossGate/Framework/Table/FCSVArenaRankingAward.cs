...
{
    public class FCSVArenaRankingAward
    {
    ...
    public class FCSVArenaRankingAwardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVArenaRankingAward);
            }
        }
        ...
        public class Adapter : FCSVArenaRankingAward, CrossBindingAdaptorType
        {

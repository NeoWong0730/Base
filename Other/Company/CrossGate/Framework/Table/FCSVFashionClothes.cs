...
{
    public class FCSVFashionClothes
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint FashionName { get; private set; }
			public uint FashionDescribe { get; private set; }
			public uint FashionQuality { get; private set; }
			public readonly List<uint> FashionItem;
			public readonly List<List<uint>> Colour;
			public readonly List<List<uint>> itemNeed;
			public uint ColorSwitch { get; private set; }
    ...
    public class FCSVFashionClothesAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFashionClothes);
            }
        }
        ...
        public class Adapter : FCSVFashionClothes, CrossBindingAdaptorType
        {

...
{
    public class FCSVTutorialSecondHeading
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint secondHeadingName { get; private set; }
			public uint secondHeadingSrot { get; private set; }
    ...
    public class FCSVTutorialSecondHeadingAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVTutorialSecondHeading);
            }
        }
        ...
        public class Adapter : FCSVTutorialSecondHeading, CrossBindingAdaptorType
        {

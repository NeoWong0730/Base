...
{
    public class FCSVFamilyAuction
    {
	    sealed public class Data
	    {
			...
			public uint GroupNum { get; private set; }
			public uint AuctionCurrency { get; private set; }
			public uint InitialCurrency { get; private set; }
			public uint InitialSingleStep { get; private set; }
			public uint InitialIsBind { get; private set; }
			public uint InitialParameter { get; private set; }
			public uint FixedCurrencyType { get; private set; }
			public uint FixedCurrency { get; private set; }
			public uint FixedIsBind { get; private set; }
			public uint FixedParameter { get; private set; }
    ...
    public class FCSVFamilyAuctionAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyAuction);
            }
        }
        ...
        public class Adapter : FCSVFamilyAuction, CrossBindingAdaptorType
        {

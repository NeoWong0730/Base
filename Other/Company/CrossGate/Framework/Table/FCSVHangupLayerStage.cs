...
{
    public class FCSVHangupLayerStage
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint Hangupid { get; private set; }
			public byte LayerStage { get; private set; }
			public byte ActivateType { get; private set; }
			public readonly List<uint> ActivatePara;
			public uint Name { get; private set; }
			public readonly List<byte> RecommendLv;
			public byte MonseterLv { get; private set; }
			public uint Mapid { get; private set; }
			public uint EnemyGroupid { get; private set; }
			public uint TelNpcid { get; private set; }
			public readonly List<uint> MonseterIcon;
			public uint Dropid { get; private set; }
    ...
    public class FCSVHangupLayerStageAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVHangupLayerStage);
            }
        }
        ...
        public class Adapter : FCSVHangupLayerStage, CrossBindingAdaptorType
        {

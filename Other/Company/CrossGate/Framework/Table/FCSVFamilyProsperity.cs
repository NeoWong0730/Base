...
{
    public class FCSVFamilyProsperity
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint agriculture_exp { get; private set; }
			public uint business_exp { get; private set; }
			public uint security_exp { get; private set; }
			public uint religion_exp { get; private set; }
			public uint technology_exp { get; private set; }
    ...
    public class FCSVFamilyProsperityAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyProsperity);
            }
        }
        ...
        public class Adapter : FCSVFamilyProsperity, CrossBindingAdaptorType
        {

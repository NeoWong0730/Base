...
{
    public class FCSVCommodityList
    {
	    sealed public class Data
	    {
			...
			public uint sublist { get; private set; }
			public uint belong_list { get; private set; }
			public uint trade_ID { get; private set; }
    ...
    public class FCSVCommodityListAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVCommodityList);
            }
        }
        ...
        public class Adapter : FCSVCommodityList, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVSEStateAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVSEState);
            }
        }
        ...
        public class Adapter : FCSVSEState, CrossBindingAdaptorType
        {

...
{
    public class FCSVPetMount
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<List<uint>> mount_skills;
			public uint skill_grid { get; private set; }
    ...
    public class FCSVPetMountAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetMount);
            }
        }
        ...
        public class Adapter : FCSVPetMount, CrossBindingAdaptorType
        {

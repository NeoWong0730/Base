...
{
    public class FCSVOrnamentsType
    {
    ...
    public class FCSVOrnamentsTypeAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVOrnamentsType);
            }
        }
        ...
        public class Adapter : FCSVOrnamentsType, CrossBindingAdaptorType
        {

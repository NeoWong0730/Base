...
{
    public class FCSVFamilyPetFood
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint food_Type { get; private set; }
			public uint isDrugs { get; private set; }
			public uint stack { get; private set; }
			public uint num { get; private set; }
			public uint addGrowthValue { get; private set; }
			public uint addMoodValue { get; private set; }
			public uint addHealthValue { get; private set; }
			public uint feedReward { get; private set; }
			public readonly List<List<uint>> feedRewardEXP;
			public uint feedRewardCapital { get; private set; }
    ...
    public class FCSVFamilyPetFoodAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyPetFood);
            }
        }
        ...
        public class Adapter : FCSVFamilyPetFood, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    public class FCSVPetNewLoveUp
    {
	    sealed public class Data
	    {
			...
			public uint RaceType { get; private set; }
			public readonly List<List<uint>> RaceEffec;
			public uint OneselfScore { get; private set; }
			public uint txt { get; private set; }
			public uint contests { get; private set; }
			public uint strengthen_lv { get; private set; }
			...
			public uint RaceScore { get; private set; }
    ...
    public class FCSVPetNewLoveUpAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewLoveUp);
            }
        }
        ...
        public class Adapter : FCSVPetNewLoveUp, CrossBindingAdaptorType
        {

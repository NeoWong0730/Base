...
{
    public class FCSVFriendSearch
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint FriendSearchClass { get; private set; }
    ...
    public class FCSVFriendSearchAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFriendSearch);
            }
        }
        ...
        public class Adapter : FCSVFriendSearch, CrossBindingAdaptorType
        {

...
{
    public class FCSVGuideTip
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint tip_type { get; private set; }
			...
			public uint image_name { get; private set; }
			public uint tip_scale { get; private set; }
			public float tip_time { get; private set; }
			public readonly List<float> tip_size;
			public readonly List<float> tip_pos;
			public uint tip_content { get; private set; }
    ...
    public class FCSVGuideTipAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVGuideTip);
            }
        }
        ...
        public class Adapter : FCSVGuideTip, CrossBindingAdaptorType
        {

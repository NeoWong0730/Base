...
{
    public class FCSVQuestionnaire
    {
	    sealed public class Data
	    {
			...
			public uint MailId { get; private set; }
    ...
    public class FCSVQuestionnaireAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVQuestionnaire);
            }
        }
        ...
        public class Adapter : FCSVQuestionnaire, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    ...
    public class FCSVRobotNameAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVRobotName);
            }
        }
        ...
        public class Adapter : FCSVRobotName, CrossBindingAdaptorType
        {

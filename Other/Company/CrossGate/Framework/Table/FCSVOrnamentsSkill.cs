...
{
    public class FCSVOrnamentsSkill
    {
	    sealed public class Data
	    {
			...
			public uint min_level { get; private set; }
    ...
    public class FCSVOrnamentsSkillAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVOrnamentsSkill);
            }
        }
        ...
        public class Adapter : FCSVOrnamentsSkill, CrossBindingAdaptorType
        {

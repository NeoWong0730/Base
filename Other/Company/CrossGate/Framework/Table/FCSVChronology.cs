...
namespace Framework.Table
{
    public class FCSVChronology
    {
	    sealed public class Data
	    {
			...
			public uint event_titel { get; private set; }
			public readonly string show_image;
			public uint event_text { get; private set; }
    ...
    public class FCSVChronologyAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVChronology);
            }
        }
        ...
        public class Adapter : FCSVChronology, CrossBindingAdaptorType
        {

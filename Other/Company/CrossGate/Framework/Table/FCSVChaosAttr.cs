...
namespace Framework.Table
{
    ...
    public class FCSVChaosAttrAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVChaosAttr);
            }
        }
        ...
        public class Adapter : FCSVChaosAttr, CrossBindingAdaptorType
        {

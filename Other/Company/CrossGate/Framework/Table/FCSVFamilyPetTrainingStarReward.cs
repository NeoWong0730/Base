...
{
    public class FCSVFamilyPetTrainingStarReward
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint stage_id { get; private set; }
			public uint trainingStar { get; private set; }
    ...
    public class FCSVFamilyPetTrainingStarRewardAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFamilyPetTrainingStarReward);
            }
        }
        ...
        public class Adapter : FCSVFamilyPetTrainingStarReward, CrossBindingAdaptorType
        {

...
{
    public class FCSVPetNewlv
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public uint lv_attr_id { get; private set; }
    ...
    public class FCSVPetNewlvAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVPetNewlv);
            }
        }
        ...
        public class Adapter : FCSVPetNewlv, CrossBindingAdaptorType
        {

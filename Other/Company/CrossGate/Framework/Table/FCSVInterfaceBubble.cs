...
{
    public class FCSVInterfaceBubble
    {
	    sealed public class Data
	    {
			public uint id { get; private set; }
			public readonly List<List<uint>> ModleId;
			public uint loop { get; private set; }
    ...
    public class FCSVInterfaceBubbleAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVInterfaceBubble);
            }
        }
        ...
        public class Adapter : FCSVInterfaceBubble, CrossBindingAdaptorType
        {

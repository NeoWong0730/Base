...
{
    public class FCSVLossTipsBanList
    {
    ...
    public class FCSVLossTipsBanListAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVLossTipsBanList);
            }
        }
        ...
        public class Adapter : FCSVLossTipsBanList, CrossBindingAdaptorType
        {

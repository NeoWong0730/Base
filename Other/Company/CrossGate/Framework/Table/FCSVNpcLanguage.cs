...
namespace Framework.Table
{
    ...
    public class FCSVNpcLanguageAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVNpcLanguage);
            }
        }
        ...
        public class Adapter : FCSVNpcLanguage, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    public class FCSVFashionDraw
    {
	    sealed public class Data
	    {
			...
			public uint isBroadCast { get; private set; }
    ...
    public class FCSVFashionDrawAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVFashionDraw);
            }
        }
        ...
        public class Adapter : FCSVFashionDraw, CrossBindingAdaptorType
        {

...
namespace Framework.Table
{
    public class FCSVAssessScore
    {
	    sealed public class Data
	    {
			...
			public uint Perfect { get; private set; }
    ...
    public class FCSVAssessScoreAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(FCSVAssessScore);
            }
        }
        ...
        public class Adapter : FCSVAssessScore, CrossBindingAdaptorType
        {

...
namespace GME
{
    ...
    public class QAVContext : ITMGContext
    {
        ...
        public static string ENGINE_VERSION = QAVError.GMESDK_VERSION_2_9_0_756c12ea;
        #region Interface
    ...
    public class QAVPTT : ITMGPTT
    {
        ...
        private static void s_OnSpeechToTextComplete(int code, string fileid, string result, string auditResult)
        {

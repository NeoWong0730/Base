...
namespace GME
{
	public class QAVNative
	{
        ...
        public static string NATIVE_VERSION = QAVError.GMESDK_VERSION_2_9_0_756c12ea;
        static QAVNative ()
        {
		...
		[DllImport(MyLibName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int QAVSDK_PTT_SpeechToText([MarshalAs(UnmanagedType.LPStr)] string fileID, [MarshalAs(UnmanagedType.LPStr)] string speechLanguage, [MarshalAs(UnmanagedType.LPStr)] string translateLanguage, QAVSpeechToTextWithAuditCallback callback);
		[DllImport(MyLibName, CallingConvention = CallingConvention.Cdecl)]

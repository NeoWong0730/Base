    ...
    public class DownloadAssetsInfo
    {
        ...
        private void VertifyConfigAssetMD5(string url)
        {
            ...
            else
            {
                ...
                hashtable.Add("file_url", url);
                hashtable.Add("file_md5_correct", assetInfo.AssetMD5);
                hashtable.Add("file_md5_error", md5);
                HitPointManager.HitPoint("game_update_md5error", hashtable);
        ...
        private void AsyncOperation_Complete(AsyncOperation obj)
        {
            ...
            if (webReq != null && !UnityWebRequestUtilities.RequestHasErrors(webReq, out uwrResult))
            {
                ...
                if (m_MD5 != loadedMD5)
                {
                    ...
                    Hashtable hashtable = new Hashtable();
                    hashtable.Add("file_url", url);
                    hashtable.Add("file_md5_correct", m_MD5);
                    hashtable.Add("file_md5_error", loadedMD5);
                    HitPointManager.HitPoint("game_update_md5error", hashtable);

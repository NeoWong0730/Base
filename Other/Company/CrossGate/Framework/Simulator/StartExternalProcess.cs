...
public static class StartExternalProcess
{
    ...
    public static uint StartProcess(string path, string dir, bool hidden = false)
    {
        ...
        if (!CreateProcessW(null, dir, IntPtr.Zero, IntPtr.Zero, false, flags, IntPtr.Zero, path, ref startupinfo, ref processinfo))
        {

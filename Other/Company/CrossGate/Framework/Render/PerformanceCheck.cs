...
public class PerformanceCheck
{
    ...
    public void Start()
    {
        ...
        go = Resources.Load<GameObject>("PerformanTest");
    ...
    private void RenderPipelineManager_beginCameraRendering(UnityEngine.Rendering.ScriptableRenderContext context, Camera camera)
    {
        if (bFinished)
            return;

...
namespace Logic
{
    ...
    {
        public static Vector2 GetRelativeTransformedPosition(this Vector2 relativePosition, Vector3 relativeForward)
        {
        ...
        public static bool CloseEnough(this Quaternion angle, Quaternion otherAngle, float clostEnough = 1f)
        {
            return ((angle.eulerAngles - otherAngle.eulerAngles).sqrMagnitude <= (clostEnough * clostEnough));
        }

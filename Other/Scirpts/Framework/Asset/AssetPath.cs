...
public static readonly string sStreamPrefix = "";
        ...
        //Todo
        public static readonly string sSplitPackName = "SO";
        ...
        public static string GetSreamingFullPathHasPrefix(string relativePath)
        {
        ...
        public static string GetConfigFullPathHasPrefix(string relativePath)
        {
            ...
            if (VersionHelper.eHotFixMode != EHotFixMode.Close)
            {
                ...
                if (!File.Exists(path))
                {
                    path = AssetPath.GetSreamingFullPathHasPrefix(relativePath);
                }
                else
                {
